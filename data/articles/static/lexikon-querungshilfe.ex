defmodule Data.Article.Static.LexikonQuerungshilfe do
  ...
  def text(assigns) do
    ...
    <h4>Zebrastreifen</h4>
    <p>Wer zu Fuß <.v bounds="10.066995,53.580885,10.072788,53.583348" lon={10.06957} lat={53.581473} dir="forward" ref={Radroute6}>einen Zebrastreifen</.v> quert, hat Vorrang. Das gilt auch, wenn man sein Fahrrad über den Zebrastreifen schiebt. Rad- und Autoverkehr müssen entsprechend warten.</p>
    ...
    <p>An <.v bounds="10.15681,53.644291,10.161496,53.648419" lon={10.158004} lat={53.645749} dir="forward" ref={Radroute6}>vielen Kreisverkehren</.v> verläuft eine Radfurt neben einem Zebrastreifen über die Seitenarme. Der Zebrastreifen ist für den Radverkehr daher gar nicht relevant, sondern andere Regeln:</p>
    <ul>
    ...
    <h4>Mittelinseln</h4>
    <p><.v bounds="10.072346,53.585299,10.075701,53.586884" lon={10.07383} lat={53.586069} dir="forward" ref={Radroute6}>Mittelinseln oder Sprunginseln</.v> befinden sich meistens in der Straßenmitte, zwischen den Fahrspuren. Wenn die Mittelinsel sonst keine Schilder oder Markierungen hat, hat der Verkehr auf der <.ref>Fahrbahn</.ref> Vorfahrt.</p>
