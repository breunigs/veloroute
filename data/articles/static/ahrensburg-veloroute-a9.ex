defmodule Data.Article.Static.AhrensburgA9 do
  ...
  def tracks(),
    do: [
      %Video.Track{
        ...
        historic: %{"6b4f9f55793a34951dc5dcc3d42ecadd" => ~d[2022-10]},
        videos: [
      ...
      %Video.Track{
        ...
        historic: %{"fbbacb61e54623e0310161a516ff37bc" => ~d[2022-10]},
        videos: [
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643535"},
