defmodule Data.Article.Static.NorderstedtVeloroute1 do
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643622"}
    ]
  end
  ...
  def text(assigns) do
    ...
    <p>Die Veloroute 1 verläuft in Nord-Süd Richtung und orientiert sich an den Bahnstrecken der U-Bahn und des AKN. Start ist der <.v bounds="9.997648,53.679996,10.004217,53.68503" lon={9.999337} lat={53.681612} dir="forward" ref={NorderstedtVeloroute1}>Schmuggelstieg</.v>, wo Anschluss an <.a ref={Alltagsroute4}>Hamburgs Alltagsroute 4</.a> besteht. Über verschiedene <.v bounds="9.983344,53.680517,10.004847,53.689524" lon={9.992534} lat={53.685062} dir="forward" ref={NorderstedtVeloroute1}>verschiedene Nebenstraßen</.v> erreicht man die Bahnschienen und folgt ihnen <.v bounds="9.990255,53.717033,9.993064,53.720824" lon={9.991487} lat={53.719901} dir="forward" ref={NorderstedtVeloroute1}>mehr</.v> oder <.v bounds="9.985279,53.724679,9.997136,53.731463" lon={9.99254} lat={53.727977} dir="forward" ref={NorderstedtVeloroute1}>weniger</.v> direkt bis nach <.v bounds="9.973136,53.748855,9.988609,53.75762" lon={9.979173} lat={53.753531} dir="forward" ref={NorderstedtVeloroute1}>Meeschensee</.v>.</p>
    ...
    <h4>Befahrbarkeit</h4>
    <p>Die Qualität der Wege schwankt. Die Oberflächen sind größtenteils laufruhig, mit Ausnahme des <.v bounds="9.981995,53.743732,9.990764,53.751645" lon={9.985989} lat={53.745192} dir="forward" ref={NorderstedtVeloroute1}>Waldstücks ab Haslohfurt</.v>. An vielen Stellen teilen sich Rad- und Fußverkehr schmale Wege, was zügiges Vorankommen verhindert.</p>
    ...
    <ul>
      <li><.v bounds="9.997329,53.68158,10.00071,53.683314" lon={9.99886} lat={53.682236} dir="forward" ref={NorderstedtVeloroute1}>fehlende, legale Fahrtmöglichkeit Schmuggelstieg</.v></li>
      <li><.v bounds="9.990823,53.706587,9.994787,53.708676" lon={9.992109} lat={53.707062} dir="forward" ref={NorderstedtVeloroute1}>schlechte Ampelschaltung Norderstedt-Mitte</.v></li>
      <li><.v bounds="9.989328,53.684478,9.992112,53.685953" lon={9.990251} lat={53.685077} dir="backward" ref={NorderstedtVeloroute1}>Schikane beim Linksabbiegen Lütjenmoor</.v> (Richtung Süden)</li>
    </ul>
