defmodule Data.Article.Static.Radroute1 do
  ...
  def text(assigns) do
    ...
    <p>Die Route soll bis Ende 2025 von etwa <.v bounds="9.789294,53.552567,9.840135,53.565533" lon={9.817201} lat={53.561758} dir="forward" ref={@ref}>Blankenese</.v> bis zur <.v bounds="9.986915,53.542322,10.027925,53.562909" lon={9.99286} lat={53.549914} dir="forward" ref={@ref}>Altstadt</.v> beschildert werden. Weiter außerhalb benötigt man Ortskenntnis oder ein Navi.</p>
