defmodule Data.Article.Static.Radroute1 do
  ...
  def tracks(),
    do: [
      %Video.Track{
        ...
        historic: %{
          "a8653d7d25b5a51157dd3d78344e7adf" => ~d[2025-06],
      ...
      %Video.Track{
        ...
        historic: %{
          "f16418e88086db100b091156835d382d" => ~d[2025-12],
          "43b6649297753ea7c85c54bde3bf9e37" => ~d[2025-06],
        ...
        videos: [
          ...
          {"2025-02-09-innenstadt/GX017974", "00:00:02.420", "00:00:23.924",
           vf: "curves=lighter"},
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643422"}
    ]
  end
  ...
  def text(assigns) do
    ...
    <.roaddiagram src="radroute-01-wegweiser" width={115} alt="Zwischenwegweiser für Radroute 01" class="right"/>
    <h4>Auffindbarkeit</h4>
    <p>Die Route soll bis Ende 2025 von etwa <.v bounds="9.789294,53.552567,9.840135,53.565533" lon={9.817201} lat={53.561758} dir="forward" ref={@ref}>Blankenese</.v> bis zur <.v bounds="9.986915,53.542322,10.027925,53.562909" lon={9.99286} lat={53.549914} dir="forward" ref={@ref}>Altstadt</.v> beschildert werden (<.a href="https://veloroute.hamburg/crowdsourcing/upload" rel="nofollow">Wo genau? Hilf mit!</.a>). Weiter außerhalb benötigt man Ortskenntnis oder ein Navi.</p>
