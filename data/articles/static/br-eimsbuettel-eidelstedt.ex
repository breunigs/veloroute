defmodule Data.Article.Static.BrEimsbuettelEidelstedt do
  ...
  def text(assigns) do
    ...
    <p>Die Bezirksroute „Eidelstedt“ verbindet den Stadtteil mit dem <.v bounds="9.911016,53.601417,9.959618,53.625074" lon={9.930162} lat={53.613314} dir="forward" ref={@ref}>Niendorfer Gehege</.v>. Über die Radroute <.icon>radroute-18</.icon> und die <.a ref={BrEimsbuettelNordSued}>Bezirksroute Nord-Süd</.a> besteht Anschluss an den Rest der Stadt.</p>
