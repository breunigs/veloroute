defmodule Data.Article.Static.RSWLuebeck do
  ...
  def text(assigns) do
    ...
    <h4>Lübeck – Nord</h4>
    <p>Der Zweirichtungsradweg aus Bad Schwartau setzt sich fort und soll bis zur Nebenfahrbahn <.v bounds="10.684908,53.89035,10.692069,53.896038" lon={10.687947} lat={53.892586} dir="forward" ref="rsw-luebeck">Schwartauer Landstraße</.v> verlängert werden. Die Nebenfahrbahn würde bevorzugt zur Fahrradstraße umgestaltet und das KFZ-Parken beidseitig verboten. KFZ sind aber weiterhin erlaubt: Anlieger frei bzw. KFZ frei, je nach Abschnitt. Am <.v bounds="10.681947,53.885997,10.68687,53.887971" lon={10.684516} lat={53.886931} dir="forward" ref="rsw-luebeck">Südende</.v> soll die KFZ-Einfahrt nach Norden verschoben werden, um die aktuell unübersichtliche Situation an der Kreuzung zu entschärfen.</p>

    <p>In der Vorzugsvariante wird der Zweirichtungsradweg bis zum ehemaligen <.v bounds="10.676081,53.879852,10.681228,53.882545" lon={10.678371} lat={53.881375} dir="forward" ref="rsw-luebeck">„Sankt-Lorenz“ Bahngleis</.v> fortgeführt und dort auf die Bahntrasse abgeleitet. Über das alte Bahngleis erreicht man die <.v bounds="10.678646,53.878419,10.683756,53.880581" lon={10.680661} lat={53.879421} dir="forward" ref="rsw-luebeck">Karlstraße</.v>, wo der Zweirichtungsradweg auf der Nordseite verlaufen würde. An ähnlicher Stelle wie heute erreicht man die <.v bounds="10.679468,53.875913,10.684187,53.880121" lon={10.681846} lat={53.878905} dir="forward" ref="rsw-luebeck">Katharinenstraße</.v> bzw. den Radweg auf deren Ostseite. Der Anschluss an die <.v bounds="10.674234,53.870197,10.681226,53.875798" lon={10.67758} lat={53.870945} dir="forward" ref="rsw-luebeck">Willy-Brandt-Allee</.v> erfolgt im Wesentlichen wie heute über die <.v bounds="10.674234,53.870197,10.681226,53.875798" lon={10.678956} lat={53.874573} dir="forward" ref="rsw-luebeck">Roddenkoppel</.v>. Die Wege sollen aber verbreitert werden. Das erfordert möglicherweise neue Brücken.</p>

    <h4>Lübeck – Mitte</h4>
    <p>In der Willy-Brandt-Allee soll der Radschnellweg auf der Westseite der Straße geführt werden. Nach der <.v bounds="10.670974,53.867353,10.681142,53.870535" lon={10.67736} lat={53.868652} dir="forward" ref="rsw-luebeck">Musik- und Kongresshalle</.v> wird ein Kreisverkehr vorgeschlagen, der den Radschnellweg direkt mit <.m bounds="10.665459,53.865881,10.674614,53.86948">Hauptbahnhof</.m> und <.m bounds="10.679995,53.865752,10.690779,53.871916">Altstadt</.m> verbindet.</p>
    ...
    <p>Im <.v bounds="10.676981,53.86111,10.679516,53.868574" lon={10.677425} lat={53.865508} dir="forward" ref="rsw-luebeck">weiteren Verlauf</.v> des Radschnellwegs Richtung Süden werden weiter beidseitige Einrichtungsradwege vorgeschlagen.</p>
    ...
    <ul>
      <li><strong><.v bounds="10.678003,53.852718,10.699584,53.862308" lon={10.689558} lat={53.859395} dir="forward" ref="rsw-luebeck">Wallstraße</.v>:</strong> Führung über einen Zweirichtungsradweg südlich der Wallstraße. Neue Mühlentorbrücke. Umgestaltung Mühlentorplatz, ggf. als Ampel-Kreuzung. Danach wieder beidseitige Einrichtungsradwege.</li>
      ...
      <li><strong><.v bounds="10.678241,53.85204,10.701775,53.861811" lon={10.699056} lat={53.853823} dir="forward" ref="rsw-luebeck">Mönkhofer Weg</.v>:</strong> Führung entlang der Possehlstraße, Ableitung über <.v bounds="10.678241,53.85204,10.701775,53.861811" lon={10.680775} lat={53.854936} dir="forward" ref="rsw-luebeck">vorhandene Rampe</.v>. Dann Charlottenstraße, Uhlandstraße, Bernt-Notke-Straße und schließlich Mönkhofer Weg. Umgestaltungen der Straßen je nach Situation. Eine bessere Querungsmöglichkeit der Kronsforder Allee wird angestrebt.</li>
