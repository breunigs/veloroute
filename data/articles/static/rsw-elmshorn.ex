defmodule Data.Article.Static.RSWElmshorn do
  ...
  def text(assigns) do
    ...
    <p>Der Radschnellweg beginnt in Hamburg an zwei unterschiedlichen Stellen und vereint sich erst in der <.v bounds="9.88323,53.598201,9.895067,53.606363" lon={9.890008} lat={53.601812} dir="forward" ref={@ref}>Elbgaustraße</.v>. Für den westlichen Arm über Fernbahnhof Diebsteich, siehe <.a ref={RadrouteConceptC}>den Artikel zur noch nicht nummerierten Radroute</.a>. Dort wo neue Brücken und Wege erst noch gebaut werden sollen weichen die Videos von der Trasse ab. Die in der Karte eingezeichnete Strecke ist die Vorzugsvariante. Sollte diesen in Teilen nicht umgesetzt werden können, wurden in der Planung auch Alternativen ausgearbeitet.</p>

    <h4>Hamburg</h4>
    <p>Von der <.a ref={Alltagsroute2}>Alltagsroute 2</.a> fährt man weiter gerade aus um die <.v bounds="9.929076,53.582676,9.934327,53.585482" lon={9.933267} lat={53.58345} dir="forward" ref={@ref}>Warnstedtstraße</.v> zu erreichen. In diesen Abschnitten sind schmale <.ref>Hochbordradwege</.ref>, <.ref>Kopenhagener Lösung</.ref> o.ä. vorgesehen. Die <.v bounds="9.917948,53.584467,9.930435,53.590734" lon={9.92911} lat={53.585196} dir="forward" ref={@ref}>Randstraße</.v> soll zu einer Fahrradstraße werden, wobei das <.v bounds="9.925391,53.58569,9.927657,53.586772" lon={9.926503} lat={53.586185} dir="forward" ref={@ref}>KFZ-freie Stück</.v> erhalten bleiben soll. Kurz vor der Einmündung des <.v lon={9.920557} lat={53.589599} dir="forward" bounds="9.918529,53.588798,9.923046,53.590503" ref={@ref}>Försterweg</.v> wird der Schnellweg auf einen Zweirichtungsradweg umgelenkt, der auf der Seite der S-Bahn Station verlaufen soll. Die Detailplanung soll mit dem Bau der U-Bahn Station für die U5 erfolgen.</p>
    ...
    <p>Die <.v bounds="9.88796,53.600075,9.89172,53.602775" lon={9.889988} lat={53.60173} dir="forward" ref={@ref}>Elbgaustraße</.v> wird zur Zeit umgeplant (<.a ref={Elbgaustrasse}>Details</.a>). Momentan ist vorgesehen die beiden Äste des Radschnellwegs durch einen schmalen Zweirichtungsradweg auf der Ostseite anzubinden. Zur Querung ist eine breite Mittelinsel kurz vor der Bahnunterführung vorgesehen, sodass je nur eine KFZ-Spur beachtet werden muss. Der <.v bounds="9.887119,53.60167,9.891475,53.603607" lon={9.889635} lat={53.602347} dir="forward" ref={@ref}>Verbindungsweg</.v> zum Friedrichshulder Weg soll ausgebaut werden. Ab dann sind bis zur Landesgrenze Fahrradstraßen angedacht.</p>

    <h4>Halstenbek</h4>
    <p>Auf <.v bounds="9.825848,53.60916,9.86852,53.638697" lon={9.847346} lat={53.624091} dir="forward" ref={@ref}>Halstenbeker Gebiet</.v> sind fast ausschließlich Fahrradstraßen vorgesehen. Die Fahrt entlang des Radschnellwegs soll jeweils Vorfahrt haben, was auch für die Anschlüsse nach Hamburg gilt. An der <.v bounds="9.833861,53.628203,9.837038,53.629952" lon={9.835752} lat={53.628532} dir="forward" ref={@ref}>Dockenhudener Chaussee</.v> würde der Radverkehr anders als der KFZ-Verkehr geradlinig weiterfahren können. Statt einer Ampel sollen Mittelinseln die Querung ermöglichen. Als teurere Alternative erwägt man eine neue <.m bounds="9.836322,53.63064,9.838066,53.631862">Brücke an der Bahnstrecke</.m>. So könnten die vorhandenen Wege erweitert werden und der Schnellweg über den <.m bounds="9.836322,53.625551,9.843823,53.631862">Hagenwisch</.m> geführt werden.</p>

    <p>In Richtung Norden sieht die Vorzugsvariante einen neuen Radweg entlang des <.v bounds="9.812636,53.632378,9.828355,53.640425" lon={9.825385} lat={53.637228} dir="forward" ref={@ref}>Naturschutzgebiets „Düpenau und Mühlenau“</.v> vor. Man hält eine Genehmigung für unwahrscheinlich, da eine Alternative <.v bounds="9.819673,53.629479,9.832833,53.641509" lon={9.829817} lat={53.629967} dir="forward" ref={@ref}>östlich der Bahn</.v> möglich wäre. Diese wäre rund 500m länger und bestünde aus Fahrradstraßen und eigenen Radwegen.</p>

    <h4>Pinneberg</h4>
    <p>Von Halstenbek kommend schließt sich eine Fahrradstraße an, die sich bis zum <.v bounds="9.808089,53.643774,9.814633,53.64639" lon={9.813369} lat={53.644318} dir="forward" ref={@ref}>Thesdorfer Weg</.v> fortsetzt. Dort soll eine weitere Unterquerung gebaut werden, um dann über den Parkplatz auf der Nordseite zum <.v bounds="9.808093,53.644853,9.812719,53.647519" lon={9.809365} lat={53.645455} dir="forward" ref={@ref}>Kleinen Reitweg</.v> zu kommen. Dort würde der vorhandene Fußweg bzw. die Nebenstraße ausgebaut und wie bisher auf den Weg entlang der Bahn leiten. Auch dieser soll verbreitert werden.</p>

    <p>Um den <.v bounds="9.792388,53.652505,9.803128,53.657647" lon={9.80029} lat={53.653122} dir="forward" ref={@ref}>Bahnhof Pinneberg</.v> soll der Radschnellweg idealerweise vor der Mühlenau auf die Osterholder Allee geleitet werden, um nicht mit dem Fußverkehr entlang der Unterführung in Konflikt zu geraten. Ab dort sollen Fahrradstraßen, Tempo-20-Zonen (Bahnhof) bzw. Mischverkehr (Neubaugebiet „ILO-Park“) den Radverkehr aufnehmen. Ab der <.v bounds="9.787372,53.658899,9.792929,53.660994" lon={9.789639} lat={53.660318} dir="forward" ref={@ref}>Mühlenstraße</.v> wird wegen des hohen LKW-Aufkommens dagegen ein Zweirichtungsradweg auf der Bahnseite angestrebt.</p>

    <h4>Prisdorf</h4>
    <p>Die Wege sollen ausgebaut werden, wo dies unter Beachtung des Naturschutz möglich ist. Wo heute KFZ erlaubt sind, sollen es Fahrradstraßen werden, sonst eigenständige Rad- und Fußwege. Von <.v bounds="9.759825,53.672412,9.765766,53.67574" lon={9.765209} lat={53.672873} dir="forward" ref={@ref}>Rehmen bis zum Bahnhof</.v> hofft man einen neuen, direkten Weg bauen zu können. Ab dem <.v bounds="9.755248,53.674989,9.759273,53.680105" lon={9.75892} lat={53.675702} dir="forward" ref={@ref}>Hudenfeld</.v> sind wieder Fahrradstraßen vorgesehen.</p>

    <p>Entlang der <.v bounds="9.744906,53.678383,9.758333,53.683394" lon={9.749372} lat={53.681932} dir="forward" ref={@ref}>Hauptstraße</.v> soll ein Zweirichtungsradweg auf der Südseite entstehen. Je nach Platzangebot würde hier kein Radschnellwegstandard erreicht, oder man müsste Baumfällungen in Erwägung ziehen. Für die <.v bounds="9.75603,53.678685,9.757973,53.680512" lon={9.756958} lat={53.679567} dir="forward" ref={@ref}>Engstelle Hudenbarg bis Bilsbek-Brücke</.v> wird für KFZ eine Reduktion auf eine Fahrspur mit ampelgesteuertem Wechselverkehr vorgeschlagen. Die <.v bounds="9.745033,53.68186,9.746995,53.682771" lon={9.746676} lat={53.682227} dir="forward" ref={@ref}>Querung der Hauptstraße</.v> wird durch eine Mittelinsel vereinfacht.</p>

    <h4>Tornesch</h4>
    <p>Auf <.v bounds="9.724995,53.681067,9.75067,53.690846" lon={9.743011} lat={53.684239} dir="forward" ref={@ref}>Tornscher Gebiet</.v> schließen sich Fahrradstraßen mit landwirtschaftlichem Verkehr oder neue eigenenständige Radwege an. Die genaue Führung orientiert sich an der Untersuchung der Deutschen Bahn die Strecke viergleisig auszubauen. Die ebenfalls in <.v bounds="9.72599,53.686526,9.732181,53.691305" lon={9.729249} lat={53.689198} dir="forward" ref={@ref}>diesem Bereich</.v> geplante K22 würde durch eine neue Brücke gequert werden. Mit dem Bau entfielen auch die Bahnübergänge Denkmalstraße und Bockhorn als mögliche Wartestellen. Der Bau der K22 ist noch umstritten.</p>
    <p>Im <.v bounds="9.70285,53.690487,9.734942,53.715841" lon={9.7131} lat={53.706958} dir="forward" ref={@ref}>Stadtgebiet von Tornesch</.v> würde eine Fahrradstraße mit Vorfahrt entlang des Radschnellwegs eingerichtet. Als Besonderheit soll dieser einen baulichen Mittelstreifen erhalten, etwa ein paar Reihen Kopfsteinpflaster. Eine Untersuchung in den Niederlanden zeigte, das dies ausreichte damit Autofahrende seltener und mit mehr Abstand überholen. Zum Queren der <.v bounds="9.716724,53.697338,9.719272,53.699012" lon={9.717911} lat={53.697926} dir="forward" ref={@ref}>Ahrenloher Straße</.v> würde der Radverkehr zunächst die Straße geradlinig queren, um dann auf der Nordseite links in die Wilhelmstraße abzubiegen. So möchte man unübersichtliche Situationen im Kreuzungsbereich vermeiden.</p>
    <p>Langfristig könnte die Trasse auch weiter entlang der Bahn führen.</p>

    <h4>Elmshorn</h4>
    <p>Die aus Tornesch kommende Fahrradstraßen würden sich bis zum <.v bounds="9.66994,53.733145,9.674969,53.73603" lon={9.671521} lat={53.734707} dir="forward" ref={@ref}>Hainholter Ohr</.v> fortsetzen. Mit Vorrang, aber ohne die baulichen Mittelstreifen. Um den geplanten Bahnhof „Elmshorn Süd“ soll der Radverkehr auf einen Zweirichtungsradweg geleitet werden, da hier zu viele Autos fahren. Ab dem <.v bounds="9.668209,53.736982,9.671291,53.738939" lon={9.670138} lat={53.737868} dir="forward" ref={@ref}>Hainholz</.v> soll es wieder eine bevorrechtigte Fahrradstraße werden. An der <.v bounds="9.663164,53.741324,9.666438,53.742946" lon={9.66474} lat={53.741958} dir="forward" ref={@ref}>Wasserstraße</.v> endet der Schnellweg vorerst.</p>
