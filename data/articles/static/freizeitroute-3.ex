defmodule Data.Article.Static.Freizeitroute3 do
  ...
  def text(assigns) do
    ...
    <h4>Befahrbarkeit</h4>
    <p>Bis Höhe des <.m bounds="10.05126,53.573927,10.065831,53.579676" lat={53.57573} lon={10.05674} dir="forward">S-Bahnhof Friedrichsberg</.m> folgt man grob der <.a name="alltagsroute-6">Alltagsroute <.icon link={false}>6</.icon></.a>, welche mit Radwegpflaster und Asphalt ausgebaut ist. Hier dürfte es am ehesten Winterdienst geben.</p>
