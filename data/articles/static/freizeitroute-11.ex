defmodule Data.Article.Static.Freizeitroute11 do
  ...
  def text(%{lang: "en"} = assigns) do
    ...
    <p lang="en">Clockwise starting from <.v bounds="9.851468,53.539706,9.870508,53.553705" lon={9.863568} lat={53.547208} dir="forward" ref={@ref}>Teufelsbrück</.v> (→ connects to <.a ref={Freizeitroute8}>leisure route FR8</.a>) you cycle through <.v bounds="9.854671,53.548388,9.865148,53.557919" lon={9.859542} lat={53.550814} dir="forward" ref={@ref}>Wesselhoeftpark</.v>, <.v bounds="9.854671,53.548388,9.865148,53.557919" lon={9.861281} lat={53.5556} dir="forward" ref={@ref}>Westerpark</.v>, pass by <.v bounds="9.853567,53.55741,9.86569,53.566104" lon={9.857711} lat={53.560788} dir="forward" ref={@ref}>Loki-Schmidt-Garten</.v>, to reach <.v bounds="9.866235,53.574012,9.881239,53.582162" lon={9.872404} lat={53.577378} dir="forward" ref={@ref}>Lise-Meitner-Park</.v> through various green areas and, after a road crossing, <.v bounds="9.883239,53.5703,9.91343,53.586437" lon={9.892362} lat={53.582245} dir="forward" ref={@ref}>Altonaer Volkspark</.v> (→ <.a ref={Freizeitroute9}>FR 9</.a>).</p>
    <p lang="en">From Volkspark you pass under the <.v bounds="9.91073,53.587385,9.925203,53.594185" lon={9.916667} lat={53.589595} dir="forward" ref={@ref}>motorway and rails</.v>, then through garden plots into the <.v bounds="9.919061,53.602563,9.956312,53.618992" lon={9.933204} lat={53.613957} dir="forward" ref={@ref}>Niendorfer Gehege</.v> (→ <.a ref={Freizeitroute10}>FR 10</.a>). Via <.v bounds="9.955991,53.608678,10.00089,53.621816" lon={9.975431} lat={53.618639} dir="forward" ref={@ref}>garden plots</.v> next to the airport (→ <.a ref={Freizeitroute12}>FR 12</.a>) you reach the <.v bounds="9.988016,53.605423,10.03233,53.622647" lon={10.004034} lat={53.612817} dir="forward" ref={@ref}>Alster</.v> (→ <.a ref={Freizeitroute1}>FR 1</.a>) and cross it to arrive at <.v bounds="10.02749,53.611334,10.088789,53.633001" lon={10.037264} lat={53.619833} dir="forward" ref={@ref} lang="en">Ohlsdorf cemetary</.v>.</p>

    <p lang="en">Passing by <.v bounds="10.041797,53.609313,10.072183,53.620469" lon={10.068135} lat={53.618523} dir="forward" ref={@ref}>Steilshoop</.v> through green areas you get to the <.v bounds="10.090684,53.596093,10.103055,53.607322" lon={10.09632} lat={53.604114} dir="forward" ref={@ref}>Osterbek</.v> (→ <.a ref={Freizeitroute2}>FR 2</.a>) and in <span lang="de" translate="no">Tonndorf</span> the <.v bounds="10.098075,53.580045,10.117876,53.590363" lon={10.109535} lat={53.585979} dir="forward" ref={@ref}>Wandse</.v> (→ <.a ref={Freizeitroute3}>FR 3</.a>). After weaving through <.v bounds="10.106034,53.570443,10.143152,53.584543" lon={10.125261} lat={53.577663} dir="forward" ref={@ref}>Jenfeld</.v>, you'll find spacious green in <.v bounds="10.131008,53.546987,10.156868,53.56712" lon={10.144001} lat={53.562685} dir="forward" ref={@ref}>Öjendorfer Park</.v>. Alongside the <span lang="de" translate="no">Schleemer Bach</span> you'll reach the <.v bounds="10.098589,53.531245,10.126185,53.544762" lon={10.112726} lat={53.533625} dir="forward" ref={@ref}>Bille</.v> (→ <.a ref={Freizeitroute4}>FR 4</.a>). The next target is the <.v bounds="10.102072,53.486168,10.182988,53.526137" lon={10.140335} lat={53.511157} dir="forward" ref={@ref}>Boberger Niederung</.v>, and from there almost in a straight line towards the <.v bounds="10.082945,53.479021,10.132834,53.490622" lon={10.102589} lat={53.483961} dir="forward" ref={@ref}>Dove Elbe</.v> (→ <.a ref={Freizeitroute5}>FR 5</.a>).</p>
    <p lang="en">The tour now makes a turn, following the <span lang="de" translate="no">Elbe</span> downriver <.v bounds="10.02178,53.528625,10.034956,53.536789" lon={10.025892} lat={53.53218} dir="forward" ref={@ref} lang="en">to cross it</.v> near the city center. It takes you across <.v bounds="10.007671,53.521237,10.034862,53.533568" lon={10.02122} lat={53.527237} dir="forward" ref={@ref}>Veddel</.v> and <.v bounds="9.974523,53.468133,10.060155,53.524281" lon={10.042857} lat={53.494946} dir="forward" ref={@ref}>Wilhelmsburg</.v> (→ <.a ref={Freizeitroute6}>FR 6</.a>), passing the <.v bounds="9.991622,53.439671,10.050979,53.472508" lon={10.012905} lat={53.458} dir="forward" ref={@ref}>Neuländer See</.v> towards <.v bounds="9.965153,53.435419,9.987681,53.452427" lon={9.979077} lat={53.450359} dir="forward" ref={@ref}>Harburger Stadtpark</.v>.</p>
    <p lang="en">Passing through <span lang="de" translate="no">Eißendorf</span> and the <.v bounds="9.924443,53.453719,9.95028,53.471033" lon={9.941844} lat={53.461819} dir="forward" ref={@ref}>Heimfelder Holz</.v> (→ <.a ref={Freizeitroute7}>FR 7</.a>) you'll reach <.v bounds="9.836318,53.476357,9.90998,53.521681" lon={9.903525} lat={53.484055} dir="forward" ref={@ref}>Dritte Meile</.v> in the area of <span lang="de" translate="no">Altes Land</span> (→ <.a ref={Freizeitroute14}>FR 14</.a>). Near the end you'll pass through <.v bounds="9.844071,53.524436,9.889127,53.546172" lon={9.877899} lat={53.528461} dir="forward" ref={@ref}>Finkenwerder</.v> (→ <.a ref={Freizeitroute13}>FR 13</.a>) and finally to <.v bounds="9.857705,53.53993,9.866148,53.543285" lon={9.863281} lat={53.541299} dir="forward" ref={@ref} lang="en">ferry dock <span lang="de" translate="no">Rüschpark</span></.v>.</p>
  ...
  def text(assigns) do
    ...
    <p>Im Uhrzeigersinn ab <.v bounds="9.851468,53.539706,9.870508,53.553705" lon={9.863568} lat={53.547208} dir="forward" ref={@ref}>Teufelsbrück</.v> (→ Anschluss an <.a ref={Freizeitroute8}>Freizeitroute 8</.a>) durchquert man den <.v bounds="9.854671,53.548388,9.865148,53.557919" lon={9.859542} lat={53.550814} dir="forward" ref={@ref}>Wesselhoeftpark</.v>, den <.v bounds="9.854671,53.548388,9.865148,53.557919" lon={9.861281} lat={53.5556} dir="forward" ref={@ref}>Westerpark</.v>, fährt am <.v bounds="9.853567,53.55741,9.86569,53.566104" lon={9.857711} lat={53.560788} dir="forward" ref={@ref}>Loki-Schmidt-Garten</.v> vorbei, erreicht über verschiedene Grünflächen den <.v bounds="9.866235,53.574012,9.881239,53.582162" lon={9.872404} lat={53.577378} dir="forward" ref={@ref}>Lise-Meitner-Park</.v> und nach einer Straßenquerung den <.v bounds="9.883239,53.5703,9.91343,53.586437" lon={9.892362} lat={53.582245} dir="forward" ref={@ref}>Altonaer Volkspark</.v> (→ <.a ref={Freizeitroute9}>FR 9</.a>).</p>
    <p>Vom Volkspark geht es zunächst unter der <.v bounds="9.91073,53.587385,9.925203,53.594185" lon={9.916667} lat={53.589595} dir="forward" ref={@ref}>Autobahn und Bahnstrecke</.v> über Kleingärten ins <.v bounds="9.919061,53.602563,9.956312,53.618992" lon={9.933204} lat={53.613957} dir="forward" ref={@ref}>Niendorfer Gehege</.v> (→ <.a ref={Freizeitroute10}>FR 10</.a>). Durch am Flughafen gelegene <.v bounds="9.955991,53.608678,10.00089,53.621816" lon={9.975431} lat={53.618639} dir="forward" ref={@ref}>Kleingärten</.v> (→ <.a ref={Freizeitroute12}>FR 12</.a>) erreicht man die <.v bounds="9.988016,53.605423,10.03233,53.622647" lon={10.004034} lat={53.612817} dir="forward" ref={@ref}>Alster</.v> (→ <.a ref={Freizeitroute1}>FR 1</.a>) und quert sie um zum <.v bounds="10.02749,53.611334,10.088789,53.633001" lon={10.037264} lat={53.619833} dir="forward" ref={@ref}>Friedhof Ohlsdorf</.v> zu gelangen.</p>
    <p>An <.v bounds="10.041797,53.609313,10.072183,53.620469" lon={10.068135} lat={53.618523} dir="forward" ref={@ref}>Steilshoop</.v> vorbei durch verschiedene Grünanlagen erreicht man die <.v bounds="10.090684,53.596093,10.103055,53.607322" lon={10.09632} lat={53.604114} dir="forward" ref={@ref}>Osterbek</.v> (→ <.a ref={Freizeitroute2}>FR 2</.a>) und in Tonndorf die <.v bounds="10.098075,53.580045,10.117876,53.590363" lon={10.109535} lat={53.585979} dir="forward" ref={@ref}>Wandse</.v> (→ <.a ref={Freizeitroute3}>FR 3</.a>). Nachdem man sich durch <.v bounds="10.106034,53.570443,10.143152,53.584543" lon={10.125261} lat={53.577663} dir="forward" ref={@ref}>Jenfeld</.v> geschlängelt hat, findet man im <.v bounds="10.131008,53.546987,10.156868,53.56712" lon={10.144001} lat={53.562685} dir="forward" ref={@ref}>Öjendorfer Park</.v> ein weitläufiges Grün. Entlang des Schleemer Bach erreicht man die <.v bounds="10.098589,53.531245,10.126185,53.544762" lon={10.112726} lat={53.533625} dir="forward" ref={@ref}>Bille</.v> (→ <.a ref={Freizeitroute4}>FR 4</.a>). Das nächste Etappenziel ist die <.v bounds="10.102072,53.486168,10.182988,53.526137" lon={10.140335} lat={53.511157} dir="forward" ref={@ref}>Boberger Niederung</.v>, und von dort geht es fast kerzengerade bis zur <.v bounds="10.082945,53.479021,10.132834,53.490622" lon={10.102589} lat={53.483961} dir="forward" ref={@ref}>Dove Elbe</.v> (→ <.a ref={Freizeitroute5}>FR 5</.a>).</p>
    <p>Die Tour macht nun einen Knick flussabwärts um zentrumsnah die <.v bounds="10.02178,53.528625,10.034956,53.536789" lon={10.025892} lat={53.53218} dir="forward" ref={@ref}>Elbe zu queren</.v>. Über die <.v bounds="10.007671,53.521237,10.034862,53.533568" lon={10.02122} lat={53.527237} dir="forward" ref={@ref}>Veddel</.v> und <.v bounds="9.974523,53.468133,10.060155,53.524281" lon={10.042857} lat={53.494946} dir="forward" ref={@ref}>Wilhelmsburg</.v> (→ <.a ref={Freizeitroute6}>FR 6</.a>), geht's am <.v bounds="9.991622,53.439671,10.050979,53.472508" lon={10.012905} lat={53.458} dir="forward" ref={@ref}>Neuländer See</.v> vorbei Richtung <.v bounds="9.965153,53.435419,9.987681,53.452427" lon={9.979077} lat={53.450359} dir="forward" ref={@ref}>Harburger Stadtpark</.v>.</p>
    <p>Durch Eißendorf und das <.v bounds="9.924443,53.453719,9.95028,53.471033" lon={9.941844} lat={53.461819} dir="forward" ref={@ref}>Heimfelder Holz</.v> (→ <.a ref={Freizeitroute7}>FR 7</.a>) erreicht man die <.v bounds="9.836318,53.476357,9.90998,53.521681" lon={9.903525} lat={53.484055} dir="forward" ref={@ref}>Dritte Meile</.v> im Alten Land (→ <.a ref={Freizeitroute14}>FR 14</.a>). Kurz vorm Ziel kommt man durch <.v bounds="9.844071,53.524436,9.889127,53.546172" lon={9.877899} lat={53.528461} dir="forward" ref={@ref}>Finkenwerder</.v> (→ <.a ref={Freizeitroute13}>FR 13</.a>) und den schließlich zum <.v bounds="9.857705,53.53993,9.866148,53.543285" lon={9.863281} lat={53.541299} dir="forward" ref={@ref}>Fähranleger Rüschpark</.v>.</p>
