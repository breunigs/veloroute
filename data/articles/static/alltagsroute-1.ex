defmodule Data.Article.Static.Alltagsroute1 do
  ...
  def links(assigns) do
    [
      {"Detailseite der Stadt",
       "https://web.archive.org/web/20240117064959/https://www.hamburg.de/verkehr/fahrradfahren-in-hamburg/418898/veloroute-1/"},
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643537"},
  ...
  def text(assigns) do
    ...
    <p>Anfang 2025 hat Hamburg sein Radnetz neu aufgestellt. Die „Velorouten“ heißen jetzt „Radrouten“ und wurden neu nummeriert. Du schaust Dir gerade die <em>alte</em> Seite an. Magst Du lieber auf die neuere <.a ref={Radroute1}>Radroute 1 (Rissen)</.a> bzw. <.a ref={Radroute7}>Radroute 7 (Osdorfer Born)</.a> wechseln?</p>
    ...
    <table class="routing">
      ...
      <tr>
        <td></td>
        <td><.v bounds="9.988972,53.547905,10.001451,53.552928" lon={9.993714} lat={53.551028} dir="forward" ref={Alltagsroute1} highlight="Rathausmarkt">Rathaus</.v></td>
      </tr>
      <tr>
        <td>
          <.icon>11</.icon>
        ...
        <td><.v bounds="9.983395,53.547382,9.990571,53.551659" lon={9.987737} lat={53.548638} dir="forward" ref={Alltagsroute1}>Rödingsmarkt</.v></td>
      </tr>
      <tr>
        <td></td>
        <td><.v bounds="9.961206,53.550831,9.97826,53.559197" lon={9.9736} lat={53.556844} dir="forward" ref={Alltagsroute1}>Heiligengeistfeld</.v></td>
      </tr>
      <tr>
        <td><.icon>2</.icon></td>
        <td><.v bounds="9.94718,53.552172,9.976797,53.560891" lon={9.963071} lat={53.556828} dir="forward" ref={Alltagsroute1}>St. Pauli</.v></td>
      </tr>
      <tr>
        <td></td>
        <td><.v bounds="9.93142,53.548879,9.961036,53.557599" lon={9.947007} lat={53.555567} dir="forward" ref={Alltagsroute1}>Altona-Altstadt</.v></td>
      </tr>
      <tr>
        <td></td>
        <td><.v bounds="9.910939,53.546744,9.940556,53.555464" lon={9.93064} lat={53.5505} dir="forward" ref={Alltagsroute1}>Ottensen</.v></td>
      </tr>
      <tr>
        <td>
          <.icon>14</.icon>
        </td>
        <td><.v bounds="9.867349,53.547993,9.918397,53.563768" lon={9.888057} lat={53.557353} dir="forward" ref={Alltagsroute1}>Othmarschen</.v></td>
      </tr>
      <tr>
        <td><.icon>FR11</.icon> <.v bounds="9.860821,53.559502,9.895486,53.573619" lon={9.878153} lat={53.564649} dir="forward" ref={Alltagsroute1}>Groß Flottbek</.v></td>
        <td><.v bounds="9.852981,53.548917,9.883378,53.563805" lon={9.863942} lat={53.557208} dir="forward" ref={Alltagsroute1}>Klein Flottbek</.v> <.icon>FR11</.icon></td>
      </tr>
      <tr>
        <td>
          <.icon>14</.icon> <.v bounds="9.845905,53.568566,9.883463,53.584532" lon={9.868849} lat={53.577374} dir="forward" ref={Alltagsroute1}>Osdorf</.v>
        </td>
        <td><.v bounds="9.824293,53.547423,9.870253,53.567174" lon={9.849254} lat={53.556615} dir="forward" ref={Alltagsroute1}>Nienstedten</.v></td>
      </tr>
      <tr>
        <td><.v bounds="9.840864,53.577504,9.870968,53.597109" lon={9.85197} lat={53.585443} dir="forward" ref={Alltagsroute1}>Osdorfer Born</.v></td>
        <td><.v bounds="9.789294,53.552567,9.840135,53.565533" lon={9.817201} lat={53.561758} dir="forward" ref={Alltagsroute1}>Blankenese</.v></td>
      </tr>
      <tr>
        <td class="dir"><.m bounds="9.7897061,53.5841903,9.8681548,53.6156231">(Schenefeld)</.m></td>
        <td><.v bounds="9.776786,53.568237,9.818757,53.586265" lon={9.793236} lat={53.578416} dir="forward" ref={Alltagsroute1}>Sülldorf</.v></td>
      </tr>
      <tr>
        <td></td>
        <td><.v bounds="9.733138,53.574751,9.780336,53.593962" lon={9.758658} lat={53.583422} dir="forward" ref={Alltagsroute1}>Rissen</.v></td>
      </tr>
      <tr>
        <td></td>
    ...
    <ul>
      <li><.icon_only>1</.icon_only> führt <.v bounds="9.737287,53.548968,9.885129,53.588181" lon={9.880805} lat={53.558266} dir="forward" ref={Alltagsroute1}>weiter nach Westen</.v> und endet in Rissen</li>
      <li><.icon_only ref={Alltagsroute1}>1a</.icon_only> knickt <.v bounds="9.847553,53.552424,9.904828,53.595271" lon={9.882076} lat={53.558455} dir="forward" ref={Alltagsroute1}>nach Norden</.v> ab und endet im Osdorfer Born</li>
    </ul>
    ...
    <h4>Befahrbarkeit</h4>
    <p>Die meisten Wege sind befestigt und allwettertauglich. Ausnahmen sind die noch nicht modernisierten Abschnitte in der <.v bounds="9.908084,53.547156,9.922823,53.55432" lon={9.917299} lat={53.551185} dir="forward" ref={Alltagsroute1}>Bleickenallee</.v> und durch den <.v bounds="9.866394,53.573567,9.876673,53.578734" lon={9.874045} lat={53.575509} dir="forward" ref={Alltagsroute1}>Lise-Meitner-Park</.v>. Bei letzterem gibt es auch keine ortsnahen Ausweichmöglichkeiten. Am <.v bounds="9.796555,53.567615,9.811059,53.575976" lon={9.80117} lat={53.573144} dir="forward" ref={Alltagsroute1}>Friedhof Blankenese</.v> ist eine Durchfahrt mit Lastenrädern nicht möglich.</p>

    <h4>Meinung</h4>
    <p>Manche der modernisierten Abschnitte sind gelungen, wie z.B. die <.v bounds="9.950381,53.555088,9.963928,53.558455" lon={9.960408} lat={53.556644} dir="forward" ref={Alltagsroute1}>Thadenstraße</.v>. Bei anderen hat sich im Vergleich zu vorher dagegen nichts verbessert, wie z.B. in der <.v bounds="9.92211,53.548454,9.935175,53.552139" lon={9.931826} lat={53.550367} dir="forward" ref={Alltagsroute1}>Klausstraße</.v>. Die noch nicht umgebauten Abschnitte lassen wenig überraschend ebenfalls zu wünschen übrig.</p>
