defmodule Data.Article.Static.Alltagsroute1 do
  ...
  def text(assigns) do
    ...
    <ul>
      <li><.icon link={false}>1</.icon> führt <.m bounds="9.737287,53.548968,9.885129,53.588181" lon={9.880805} lat={53.558266} dir="forward" ref="1">weiter nach Westen</.m> und endet in Rissen</li>
      <li><.icon name="1" link={false}>1a</.icon> knickt <.m bounds="9.847553,53.552424,9.904828,53.595271" lon={9.882076} lat={53.558455} dir="forward" ref="1">nach Norden</.m> ab und endet im Osdorfer Born</li>
    </ul>
