defmodule Data.Article.Static.BrNordN2 do
  ...
  def text(assigns) do
    ...
    <p>Die zwei südlichen Äste starten an der <.v bounds="9.965009,53.575781,10.001209,53.591971" lon={9.976231} lat={53.578959} dir="forward" ref={BrNordN2}>Hoheluftbrücke</.v> bzw. <.v bounds="9.965009,53.575781,10.001209,53.591971" lon={9.994171} lat={53.584747} dir="forward" ref={BrEimsbuettelRotherbaum}>Heilwigbrücke</.v> um kommen kurz vorm <.v bounds="9.97007,53.585677,10.000833,53.601976" lon={9.988103} lat={53.591379} dir="forward" ref={BrNordN2}>Eppendorfer Marktplatz</.v> zusammen. Über die <.v bounds="9.945288,53.591356,10.005616,53.627726" lon={9.97789} lat={53.607729} dir="forward" ref={BrNordN2}>Borsteler Chaussee</.v> führt die Route dann Richtung Flughafen, bzw. an die Kleingärten davor.</p>

    <h4>Speziell für diese Route</h4>
    <p>Für den Ast ab <.v bounds="9.965009,53.575781,10.001209,53.591971" lon={9.994171} lat={53.584747} dir="forward" ref={BrEimsbuettelRotherbaum}>Heilwigbrücke</.v> werden Fahrradstraßen vorgeschlagen. Das bereits umgebaute Stück am <.v bounds="9.988831,53.586888,9.99326,53.589877" lon={9.991631} lat={53.5887} dir="forward" ref={BrNordN2}>Loogeplatz</.v> bliebe unverändert. Für den anderen Ast ab <.v bounds="9.965009,53.575781,10.001209,53.591971" lon={9.976231} lat={53.578959} dir="forward" ref={BrNordN2}>Hoheluftbrücke</.v> bis <.v bounds="9.97007,53.585677,10.000833,53.601976" lon={9.988103} lat={53.591379} dir="forward" ref={BrNordN2}>Eppendorfer Marktplatz</.v> sind <.ref>Radfahrstreifen</.ref> oder <.ref>Schutzstreifen</.ref> vorgesehen.</p>

    <p>Für den <.v bounds="9.97007,53.585677,10.000833,53.601976" lon={9.988103} lat={53.591379} dir="forward" ref={BrNordN2}>Eppendorfer Marktplatz</.v> gibt es <.a ref={EppendorferMarktplatz}>bereits detaillierte Pläne</.a>.</p>

    <p>Bis zur <.v bounds="9.982127,53.60011,9.990808,53.606446" lon={9.987479} lat={53.602784} dir="forward" ref={BrNordN2} highlight="Rosenbrook,Alsterkrugchaussee">B5</.v> sind Fahrradstraßen geplant. Die Kreuzung selbst soll natürlich auch überarbeitet werden, damit sie leichter gequert werden kann. Für die <.v bounds="9.945288,53.591356,10.005616,53.627726" lon={9.97789} lat={53.607729} dir="forward" ref={BrNordN2}>Borsteler Chaussee</.v> werden vom KFZ-Verkehr getrennte Wege vorgeschlagen, also etwa <.ref>Protected-Bike-Lanes</.ref> oder <.ref>Hochbordradwege</.ref>.</p>
