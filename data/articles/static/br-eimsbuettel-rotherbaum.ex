defmodule Data.Article.Static.BrEimsbuettelRotherbaum do
  ...
  def tracks(),
    do: [
      %Video.Track{
        ...
        historic: %{"08854bdfb57c16dd257c0db1e051e817" => ~d[2023-02]},
        videos: [
      ...
      %Video.Track{
        ...
        historic: %{"7dce534a8a5dd0e3662f1e3daa9947bc" => ~d[2023-02]},
        videos: [
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643563"},
  ...
  def text(assigns) do
    ...
    <p>Die Bezirksroute „Rotherbaum“ in Eimsbüttel verläuft vom <.v bounds="9.984348,53.558459,9.998315,53.565785" lon={9.990748} lat={53.560337} dir="forward" ref={BrEimsbuettelRotherbaum}>Dammtor</.v> in Nord-Süd-Richtung entlang des <.v bounds="9.984562,53.559162,10.003159,53.579949" lon={9.994316} lat={53.572317} dir="forward" ref={BrEimsbuettelRotherbaum}>Mittelweg</.v> und endet auf der <.v bounds="9.990061,53.579781,10.00024,53.587175" lon={9.993936} lat={53.584425} dir="forward" ref={BrEimsbuettelRotherbaum}>Heilwigbrücke</.v>. Dort schließt sie an einen Ast der Bezirksroute HH-Nord <.a ref={BrNordN2}>N2: Alster ↔ Airport</.a> an. Auf einem Teilstück teilt sie sich den Weg mit der <.a ref={BrEimsbuettelIsebek}>Bezirksroute Isebek</.a>.</p>

    <h4>Speziell für diese Route</h4>
    <p>Wo heute noch keine <.ref>Radfahrstreifen</.ref> sind, sollen sie eingerichtet werden. Wo zu wenig Platz für normalbreite Radfahrstreifen ist, werden als Alternative <.ref>Schutzstreifen</.ref> vorgeschlagen. Das wäre von <.v bounds="9.993365,53.566095,9.998871,53.570937" lon={9.995976} lat={53.566645} dir="forward" ref={BrEimsbuettelRotherbaum}>Johnsallee</.v> bis <.v bounds="9.993365,53.566095,9.998871,53.570937" lon={9.995238} lat={53.570308} dir="forward" ref={BrEimsbuettelRotherbaum}>Milchstraße</.v> der Fall.</p>

    <p>Für die anderen Stellen werden Detailverbesserungen vorschlagen, wie etwa bessere Abgrenzung zu fahrenden und parkenden KFZ. Der <.v bounds="9.990474,53.580743,9.998193,53.586719" lon={9.993804} lat={53.583731} dir="forward" ref={BrEimsbuettelRotherbaum}>letzte Abschnitt vor der Heilwigbrücke</.v> wird in der Planung nicht betrachtet.</p>
