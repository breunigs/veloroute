defmodule Data.Article.Static.NorderstedtVeloroute2 do
  ...
  def text(assigns) do
    ...
    <p>Die Strecke beginnt am <.v bounds="9.997648,53.679996,10.004217,53.68503" lon={9.999337} lat={53.681612} dir="forward" ref={NorderstedtVeloroute2}>Schmuggelstieg</.v> und führt zunächst nach Norden. Am <.v bounds="9.990894,53.693671,10.005301,53.698556" lon={9.994532} lat={53.69527} dir="forward" ref={NorderstedtVeloroute2}>Forstweg</.v> knickt sie etwas nach Osten ab um eine direkte Verbindung zum <.v bounds="10.001945,53.701307,10.01449,53.709814" lon={10.007494} lat={53.704041} dir="forward" ref={NorderstedtVeloroute2}>Harksheider Markt</.v> herzustellen.</p>
    ...
    <h4>Befahrbarkeit</h4>
    <p>Die Wegoberflächen sind durchgängig befestigt. Nicht überall stehen dem Radverkehr eigene Wege zur Verfügung. Besonders an <.v bounds="9.996595,53.687242,9.999018,53.688485" lon={9.997575} lat={53.687542} dir="forward" ref={NorderstedtVeloroute2}>Bushaltestellen</.v> wird es eng.</p>
    ...
    <ul>
      <li><.v bounds="9.997329,53.68158,10.00071,53.683314" lon={9.99886} lat={53.682236} dir="forward" ref={NorderstedtVeloroute2}>fehlende, legale Fahrtmöglichkeit Schmuggelstieg</.v></li>
      <li><.v bounds="9.996436,53.68307,9.999815,53.685551" lon={9.998} lat={53.683928} dir="forward" ref={NorderstedtVeloroute2}>Seitenwechsel ab Breslauer Straße</.v> (entfiele mit besserer Querungsmöglichkeit beim Schmuggelstieg)</li>
      <li><.v bounds="10.004786,53.702579,10.010087,53.706123" lon={10.006643} lat={53.703042} dir="forward" ref={NorderstedtVeloroute2}>Einmündung Am Exerzierplatz</.v></li>
    </ul>
