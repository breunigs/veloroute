defmodule Data.Article.Static.PinnebergVeloroute4 do
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643633"},
  ...
  def text(assigns) do
    ...
    <p>Los geht's am <.v bounds="9.788303,53.659153,9.796227,53.661387" lon={9.795319} lat={53.661077} dir="backward" ref={PinnebergVeloroute4}>Rübekamp</.v> und mit der <.v bounds="9.78829,53.659137,9.792636,53.661052" lon={9.789596} lat={53.660131} dir="backward" ref={PinnebergVeloroute4}>Bahnunterführung</.v> Richtung Westen. Über den <.v bounds="9.774689,53.650542,9.792636,53.661052" lon={9.783673} lat={53.655112} dir="backward" ref={PinnebergVeloroute4}>Kirchhofsweg</.v> und die <.v bounds="9.768361,53.649378,9.776908,53.652094" lon={9.772907} lat={53.65093} dir="backward" ref={PinnebergVeloroute4}>Lange Twiete</.v> erreicht man einen <.v bounds="9.752139,53.650283,9.770798,53.659509" lon={9.767815} lat={53.6519} dir="backward" ref={PinnebergVeloroute4}>gemeinsamen Fuß- und Radweg der nach Appen</.v> führt.</p>
    ...
    <h4>Meinung</h4>
    <p>Eine gute Strecke, die nur stellenweise Verbesserungen benötigt. Neben den bereits erwähnten Engstellen ist dies vor allem die Kreuzung  <.v bounds="9.774379,53.649711,9.777099,53.650951" lon={9.775567} lat={53.650511} dir="backward" ref={PinnebergVeloroute4}>Lange Twiete / Wedeler Weg</.v>, wo die Führung für den Radverkehr unklar ist.</p>
