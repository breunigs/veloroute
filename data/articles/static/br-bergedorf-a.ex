defmodule Data.Article.Static.BrBergedorfA do
  ...
  def text(assigns) do
    ...
    <ul>
      <li>Richtung Innenstadt Hamburg via <.m bounds="10.071894,53.481163,10.119867,53.502256">Moorfleeter Deich</.m> und <.a ref={Radroute22}>Radroute 22</.a></li>
      <li>Richtung <.m bounds="10.231473,53.415824,10.420866,53.49126">Geesthacht</.m> mit der <.a ref={RSWGeesthacht}>gleichnamigen Radroute Plus</.a></li>
    </ul>

    <p>In Bergedorfs Zentrum soll die Route über den Straßenzug <.v bounds="10.199482,53.482528,10.218799,53.489793" lon={10.20802} lat={53.486345} dir="forward" ref={@ref}>Weidenbaumsweg / Stuhlrohrstraße / Dietrich-Schreyge-Straße / Rektor-Ritter-Straße</.v> führen. Sie ist damit eine Alternative zur etwas südlicheren Radroute Plus Geesthacht, die einmal am <.v bounds="10.197668,53.474669,10.235061,53.489934" lon={10.206024} lat={53.484876} dir="forward" ref={RSWGeesthacht}>Sander Damm</.v> bis <.v bounds="10.197668,53.474669,10.235061,53.489934" lon={10.227513} lat={53.478811} dir="forward" ref={RSWGeesthacht}>Schwarzer Weg</.v> verlaufen soll.</p>
    ...
    <p>Ab hier teilt sich die Bezirksroute den Weg mit der <.a ref={RSWGeesthacht}>Radroute Plus Geesthacht</.a>. Dazu sind <.v bounds="10.187321,53.483926,10.203669,53.487841" lon={10.195302} lat={53.484925} dir="forward" ref={@ref}>zwei Lückenschlüsse</.v> notwendig, die als eigener Radweg ohne KFZ-Verkehr gedacht sind.</p>
