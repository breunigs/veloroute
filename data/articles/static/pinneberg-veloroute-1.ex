defmodule Data.Article.Static.PinnebergVeloroute1 do
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643629"},
      ...
      {"Stadt Pinneberg zur Ausschilderung",
       "https://web.archive.org/web/20251212072336/https://www.pinneberg.de/leben-in-pinneberg?chash=6c835baef9601f60fe5950927b65f235&tx_news_pi1%5Baction%5D=detail&tx_news_pi1%5Bcontroller%5D=news&tx_news_pi1%5Bnews%5D=396&cHash=3a6be95e43c0e780cd932b199730ad9c"},
      {
        "ADFC zur Ausschilderung der Route",
        "https://adfc-pinneberg.de/verkehrspolitik/veloroute-1-endlich-ausgeschildert"
      }
    ]
  end
  ...
  def text(assigns) do
    ...
    <p>Los geht's an der <.v bounds="9.787339,53.661065,9.793126,53.663629" lon={9.793021} lat={53.661852} dir="forward" ref={@ref}>Koppelstraße</.v>. Über den Park und die <.v bounds="9.784209,53.661061,9.789957,53.668786" lon={9.787434} lat={53.665526} dir="forward" ref={@ref}>Ottostraße</.v> umgeht man die KFZ-lastigen Straßen zunächst, landet schließlich aber doch auf der <.v bounds="9.773898,53.668445,9.783845,53.672677" lon={9.781066} lat={53.669846} dir="forward" ref={@ref}>Prisdorfer Straße</.v>.</p>
    ...
    <ul>
      <li>Die <.v bounds="9.78763,53.661952,9.788155,53.662302" lon={9.787926} lat={53.662078} dir="forward" ref={@ref}>defekte Brücke</.v> über die Pinnau</li>
      <li>Richtung Zentrum wird die <.v bounds="9.791938,53.661524,9.793746,53.662052" lon={9.792175} lat={53.66182} dir="backward" ref={@ref}>Koppelstraße</.v> für wenige Meter Einbahnstraße</li>
    </ul>

    <h4>Meinung</h4>
    <p>Die Veloroute ist eine Katastrophe. Am Anfang eiert man auf <.v bounds="9.787368,53.662119,9.788953,53.66322" lon={9.78787} lat={53.662578} dir="forward" ref={@ref}>ungeeigneten Wegen</.v> durch den Park.</p>

    <p>Entlang der Prisdorfer Straße sind die gemeinsamen Fuß/Radwege so schmal, das selbst Begegnungsverkehr Rad/Rad oder Rad/Fuß <.v bounds="9.782492,53.668366,9.784718,53.669419" lon={9.783854} lat={53.668946} dir="forward" ref={@ref}>ein Problem darstellt</.v>. Lastenräder kommen hier nicht aneinander vorbei. Zudem verläuft der Radweg hier durch die <.ref>Dooring</.ref>-Zone, was eine ernste Unfallgefahr darstellt.</p>
