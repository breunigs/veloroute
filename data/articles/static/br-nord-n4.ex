defmodule Data.Article.Static.BrNordN4 do
  ...
  def links(assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643572"},
  ...
  def text(assigns) do
    ...
    <p>Die Route beginnt an der Alster in der <.v bounds="10.004719,53.57132,10.02621,53.580897" lon={10.008506} lat={53.574176} dir="forward" ref={BrNordN4}>Karlstraße</.v>. Von dort führt sie nach Osten über die <.v bounds="10.024569,53.5723,10.057776,53.585185" lon={10.040541} lat={53.579915} dir="forward" ref={BrNordN4}>Dehnhaide</.v> zur <.v bounds="10.055478,53.57709,10.075949,53.585224" lon={10.064085} lat={53.581645} dir="forward" ref={BrNordN4}>Straßburger Straße</.v>. Sie endet an der <.a ref={Alltagsroute6}>Radroute 6</.a>.</p>

    <h4>Speziell zu dieser Route</h4>
    <p>Im Westen soll sie zu Fahrradstraßen umgebaut werden. Die Kreuzung mit dem <.v bounds="10.011632,53.572569,10.024012,53.578254" lon={10.015243} lat={53.57477} dir="backward" ref={BrNordN4}>Hofweg</.v> soll sicherer querbar werden. Ab Höhe <.v bounds="10.0236,53.574926,10.04173,53.582405" lon={10.028109} lat={53.577797} dir="forward" ref={BrNordN4}>Bartholomäusstraße</.v> setzt man auf getrennte Führungen – meist <.ref>Protected-Bike-Lanes</.ref>. Auf <.v bounds="10.047549,53.576034,10.060554,53.58198" lon={10.050922} lat={53.578719} dir="forward" ref={BrNordN4}>Höhe des Krankenhauses</.v> sollen die <.ref>Hochbordradwege</.ref> ausgebaut werden und in der <.v bounds="10.056654,53.578302,10.073318,53.585261" lon={10.064} lat={53.581654} dir="forward" ref={BrNordN4}>Straßburger Straße</.v> sollen die <.ref>Radfahrstreifen</.ref> im Wesentlichen so bleiben.</p>
