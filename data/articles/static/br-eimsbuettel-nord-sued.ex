defmodule Data.Article.Static.BrEimsbuettelNordSued do
  ...
  def tracks(),
    do: [
      %Video.Track{
        ...
        historic: %{"444c43d53c8b4795623dc631d7fda25c" => ~d[2023-02]},
        videos: [
      ...
      %Video.Track{
        ...
        historic: %{"e5043b170e2f9d38c2ce36294b37877f" => ~d[2023-02]},
        videos: [
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643561"},
  ...
  def text(assigns) do
    ...
    <ul>
      <li><.v bounds="9.946644,53.568542,9.954033,53.574193" lon={9.949549} lat={53.570213} dir="forward" ref={@ref}>Sandweg</.v>: Fahrradstraße; mit Anschluss an <.a ref={BrEimsbuettelSued}>Bezirksroute Süd</.a></li>
      ...
      <li><.v bounds="9.945008,53.579196,9.949777,53.584459" lon={9.947738} lat={53.581844} dir="forward" ref={@ref}>Methfesselstraße</.v>: <.ref>Radfahrstreifen</.ref>, bereits <.a ref={Methfesselstrasse}>im Umbau</.a></li>
      ...
      <li><.v bounds="9.936012,53.598804,9.944081,53.60759" lon={9.940668} lat={53.602803} dir="forward" ref={@ref}>Deelwisch</.v>: Fahrradstraße; <.v bounds="9.93789,53.604258,9.943205,53.607465" lon={9.939091} lat={53.606236} dir="forward" ref={BrEimsbuettelNordSued}>Sackgassenstück</.v> bleibt so, ggf. nicht mehr als Spielstraße</li>
