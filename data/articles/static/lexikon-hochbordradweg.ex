defmodule Data.Article.Static.LexikonHochbordradweg do
  ...
  def text(assigns) do
    ...
    <p><.v bounds="9.986569,53.561244,9.991119,53.564687" lon={9.989368} lat={53.56359} dir="backward" ref="3">Videobeispiel Rothenbaumchaussee</.v>.</p>
