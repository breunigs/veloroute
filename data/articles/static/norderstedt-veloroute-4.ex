defmodule Data.Article.Static.NorderstedtVeloroute4 do
  ...
  def summary(),
    do: "Norderstedts Veloroute 4 führt von Garstedt nach Glashütte"
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643628"}
    ]
  end
  ...
  def text(assigns) do
    ...
    <p>Die Veloroute führt von <.v bounds="9.977046,53.679559,9.988665,53.684982" lon={9.980631} lat={53.682232} dir="forward" ref={NorderstedtVeloroute4}>Garstedt</.v> entlang der <.v bounds="9.985277,53.679645,9.999215,53.682982" lon={9.991317} lat={53.681592} dir="forward" ref={NorderstedtVeloroute4}>Ochsenzoller Straße</.v> und der <.v bounds="10.007605,53.681698,10.037713,53.689052" lon={10.014211} lat={53.683523} dir="forward" ref={NorderstedtVeloroute4}>Segeberger Chaussee</.v> nach <.v bounds="10.024115,53.685393,10.045516,53.695013" lon={10.035206} lat={53.687964} dir="forward" ref={NorderstedtVeloroute4}>Glashütte</.v>.</p>
    ...
    <h4>Befahrbarkeit</h4>
    <p>Die Route ist durchgehend befestigt, meist mit in die Jahre gekommenen Pflaster. Häufig stehen eigene Radwege zur Verfügung, teilweise müssen sich Fuß- und Radverkehr auf <.v bounds="10.02388,53.684615,10.031099,53.687483" lon={10.025608} lat={53.685847} dir="forward" ref={NorderstedtVeloroute4}>schmalen Abschnitten</.v> jedoch den Platz teilen.</p>

    <h4>Meinung</h4>
    <p>Durch ihre Führung an einer lauten KFZ-Straße ist die Veloroute nur bedingt attraktiv. Dafür kommt man schnell voran, auch wenn die Wartezeiten an der Kreuzung mit der  <.v bounds="10.024017,53.683007,10.04304,53.693039" lon={10.029904} lat={53.686541} dir="forward" ref={NorderstedtVeloroute4}>Poppenbütteler Straße</.v> teils lang sind. In der aktuellen Führung würde ein durchgängiger Ausbau der Radwege aus Asphalt den Komfort erhöhen, selbst wenn weiterhin Engstellen verbleiben.</p>
