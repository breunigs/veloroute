defmodule Data.Article.Static.RSWLueneburg do
  ...
  def text(assigns) do
    ...
    <h4>Hamburg</h4>
    <p>Los geht's an der <.v bounds="10.019518,53.530693,10.022218,53.532618" lon={10.020984} lat={53.531908} dir="forward" ref={@ref}>Freihafenelbbrücke</.v> auf die Veddel. Dort soll ein neuer Radweg zwischen Straße und Bahnschienen gebaut werden. Dieser schließt über die <.v bounds="10.015016,53.524331,10.015016,53.524331" lon={10.015016} lat={53.524331} dir="forward" ref={@ref}>existierende Unterführung</.v> an die <.a ref={Alltagsroute11}>Alltagsroute 11</.a> an.</p>
