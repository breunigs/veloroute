defmodule Data.Article.Static.Hochbordradweg do
  use Article.Static
  ...
  def text(assigns) do
    ~H"""
    <p><a bounds="9.984455,53.559813,9.997723,53.562886" route="3" lon="9.990708" lat="53.5610386" dir="forward">Hochbordradwege</a> werden auf dem gleichen Niveau wie die Fußwege geführt. Sie sind in Hamburg meist gepflastert und bei neuer Bauweise mit Noppenplatten vom Fußweg abgetrennt.</p>
