defmodule Data.Article.Static.Freizeitroute1 do
  ...
  def links(_assigns) do
    [
      {"Detailseite der Stadt",
       "https://web.archive.org/web/20240223174648/https://www.hamburg.de/radtour/6294566/radtour-city-alster-wohlsdorfer-wald-duvenstedter-brook/"},
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643594"},
  ...
  def text(assigns) do
    ...
    <h4>Befahrbarkeit</h4>
    <p>Der Belag ist meistens plattgedrückter Schotter („Grand“) und daher nur bedingt regenfest. Bis Winterhude folgt die Strecke der <.a ref={Radroute4}>Radroute <.icon_only ref={Radroute4}>4</.icon_only></.a> und sollte daher auch im Winter nutzbar sein. Zwischen der <.v lat={53.60584} lon={9.99573} dir="forward" ref={Freizeitroute1} bounds="9.993482,53.604168,10.000989,53.607457">Wilhelm-Metzger-Straße</.v> und der <.v lat={53.61166} lon={10.00866} dir="forward" ref={Freizeitroute1} bounds="10.002239,53.608553,10.017462,53.615228">Hindenburgstraße</.v> gibt es viel Hindernisse die Lastenrädern oder E-Bikes zu schaffen machen. In diesem Abschnitt ist ein Ausweichen über die <.icon>radroute-4</.icon> empfehlenswert.</p>
