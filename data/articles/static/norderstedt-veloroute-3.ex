defmodule Data.Article.Static.NorderstedtVeloroute3 do
  ...
  def text(assigns) do
    ...
    <h4>Meinung</h4>
    <p>Die Strecke ist brauchbar, sollte jedoch über Norderstedt Mitte in der <.m bounds="9.977338,53.705978,9.995351,53.709165" lon={9.986979} lat={53.707897} dir="backward" ref="norderstedt-3">Rathausallee</.m> verlängert werden. An der <.m bounds="9.996553,53.702561,10.003026,53.705237" lon={9.998764} lat={53.7042} dir="forward" ref="norderstedt-3">Tarpenbek</.m> sollte das kurze Waldstück noch asphaltiert werden. Zuletzt muss die Querung der <.m bounds="10.010571,53.699106,10.017326,53.701531" lon={10.01297} lat={53.700466} dir="forward" ref="norderstedt-3">Schleswig-Holstein-Straße</.m> verbessert werden – neben kürzeren Wartezeiten wäre eine automatische Erkennung sinnvoll, damit man den Taster nicht mehr von Hand betätigten muss.</p>
