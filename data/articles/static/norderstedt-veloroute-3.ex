defmodule Data.Article.Static.NorderstedtVeloroute3 do
  ...
  def links(_assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643627"}
    ]
  end
  ...
  def text(assigns) do
    ...
    <p>Die Route führt von <.v bounds="9.989592,53.704789,9.998013,53.710449" lon={9.992578} lat={53.707073} dir="forward" ref={NorderstedtVeloroute3}>Norderstedt-Mitte</.v>, über <.v bounds="9.999743,53.6999,10.014974,53.708598" lon={10.004641} lat={53.703276} dir="forward" ref={NorderstedtVeloroute3}>Harksheide</.v> nach <.v bounds="10.017243,53.686578,10.040955,53.699376" lon={10.034424} lat={53.694075} dir="forward" ref={NorderstedtVeloroute3}>Glashütte</.v>.</p>

    <h4>Auffindbarkeit</h4>
    <p>Die Route ist nur dort ausgeschildert, wo sich verschiedene Radrouten treffen. Die Wegweiser sind klein und häufig außerhalb des Blickfelds angebracht, z.B. in Fahrtrichtung hinter dem Pfosten. Es muss daher an jeglichen Rad-Wegweisern genau geschaut werden. Dazwischen muss man sich auf Intuition oder allgemeine Richtungsweise (🚲 →) verlassen. Ausnahme: am <.v bounds="10.021715,53.696934,10.0243,53.698707" lon={10.022583} lat={53.698046} dir="forward" ref={NorderstedtVeloroute3}>Achtern Born</.v> sind die allgemeinen Wegweise für eine andere Route und leiten daher von der Veloroute weg.</p>
    ...
    <h4>Meinung</h4>
    <p>Die Strecke ist brauchbar, sollte jedoch über Norderstedt Mitte in der <.v bounds="9.977338,53.705978,9.995351,53.709165" lon={9.986979} lat={53.707897} dir="backward" ref={NorderstedtVeloroute3}>Rathausallee</.v> verlängert werden. An der <.v bounds="9.996553,53.702561,10.003026,53.705237" lon={9.998764} lat={53.7042} dir="forward" ref={NorderstedtVeloroute3}>Tarpenbek</.v> sollte das kurze Waldstück noch asphaltiert werden. Zuletzt muss die Querung der <.v bounds="10.010571,53.699106,10.017326,53.701531" lon={10.01297} lat={53.700466} dir="forward" ref={NorderstedtVeloroute3}>Schleswig-Holstein-Straße</.v> verbessert werden – neben kürzeren Wartezeiten wäre eine automatische Erkennung sinnvoll, damit man den Taster nicht mehr von Hand betätigten muss.</p>
