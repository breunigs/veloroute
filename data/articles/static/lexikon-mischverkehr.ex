defmodule Data.Article.Static.LexikonMischverkehr do
  ...
  def text(assigns) do
    ...
    <img src="/images/mischverkehr.svg" class="roaddiagram" alt="Eine Straßenansicht von oben (Vogelperspektive) die die Fahrtweise von KFZ und Fahrrad im Mischverkehr darstellt."/>
