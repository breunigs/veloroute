defmodule Data.Article.Static.LexikonBenutzungspflicht do
  ...
  def text(assigns) do
    ...
    <ul style="list-style-type: none; padding-left: 0">
      ...
      <li><img src="/images/bnp.svg"/> (VZ 237). Dies ist die klassische Benutzungspflicht, die aber nur angeordnet werden darf, wenn die Fahrt auf den KFZ-Spuren für den Radverkehr besonders gefährlich wäre. Hier ein <.m bounds="10.082451,53.632066,10.098984,53.637355" lon="10.0923" lat="53.6361" dir="backward" ref="5">Beispiel an der Bramfelder Chaussee</.m>. Das Schild muss an jeder Kreuzung wiederholt werden und es gelten zahlreiche Ausnahmen: zum <.ref>direkten Abbiegen</.ref>, ein verstellter (Falschparker, Mülltonnen) oder anderweiter unbenutzbarer Radweg (Scherben), oder wenn das Lastenrad breiter als der Radweg ist. <.a href="http://bernd.sluka.de/Radfahren/rechtlich.html">Genauere Erklärung</.a>.</li>
    </ul>
    """
  end
end
