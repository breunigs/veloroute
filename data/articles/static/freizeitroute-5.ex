defmodule Data.Article.Static.Freizeitroute5 do
  ...
  def text(assigns) do
    ...
    <p>Einige Tipps:</p>
    <ul>
      <li>bis zum Entenweder Park ist die <.a name="alltagsroute-9">Alltagsroute <.icon link="no">9</.icon></.a> die bessere Wahl. Die <.m lat="53.5449" lon="10.0172" bounds="9.995601,53.536759,10.048165,53.552678" dir="forward">Amsinckstraße</.m> hat den Charakter einer innerstädtischen Autotrasse und bietet sonst wenig.</li>
