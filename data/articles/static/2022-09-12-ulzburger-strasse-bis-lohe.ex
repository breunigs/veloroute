defmodule Data.Article.Blog.UlzburgerStrasseBisLohe do
  ...
  def text(assigns) do
    ...
    <p>Man entschied sich den Radverkehr auf den Fußwegen mittels <.ref>Fahrrad frei</.ref> zu führen und diese wo nötig zu verbreitern. An Kreuzungen soll der Radverkehr dagegen im Sichtfeld des Autoverkehrs fahren und wird durch Behelfsrampen auf meist rund 2,0m breite <.ref>Radfahrstreifen</.ref> abgeleitet. Nach der Kreuzung gibt es wieder eine Rampe um auf den Fußweg zu gelangen. Aufstellflächen zum Linksabbiegen werden nicht markiert, es obliegt dem Radfahrenden sich geeignet aufzustellen.</p>
