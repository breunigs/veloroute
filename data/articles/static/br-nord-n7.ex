defmodule Data.Article.Static.BrNordN7 do
  ...
  def links(assigns) do
    [
      {"Ride With GPS Routenplaner", "https://ridewithgps.com/routes/52643577"},
  ...
  def text(assigns) do
    ...
    <p>Die Route knickt im <.v bounds="9.957186,53.589594,9.978431,53.597399" lon={9.961403} lat={53.592559} dir="forward" ref={BrNordN7}>Behrkampsweg</.v> von dort <.a ref={Alltagsroute3}>Radroute 3</.a> nach Osten ab. Nahe des <.v bounds="9.97988,53.589542,9.996609,53.598114" lon={9.987429} lat={53.594482} dir="forward" ref={BrNordN7}>Eppendorfer Marktplatz</.v> macht sie einen Schlenker über die <.v bounds="9.981651,53.592606,10.011017,53.602731" lon={9.990716} lat={53.598479} dir="forward" ref={BrNordN7}>Meenkwiese</.v>. Von der führt sie <.v bounds="9.99155,53.593524,10.045536,53.605728" lon={10.01766} lat={53.600198} dir="forward" ref={BrNordN7} highlight="Jahnring">nördlich des Stadtparks</.v> bis zur <.a ref={Alltagsroute5}>Radroute 5</.a> an der <.v bounds="10.038354,53.59737,10.045286,53.60094" lon={10.041504} lat={53.598576} dir="forward" ref={BrNordN7}>Fuhlsbüttler Straße</.v>.</p>

    <h4>Speziell für diese Route</h4>
    <p>Im Westen werden meist Fahrradstraßen vorgeschlagen. Zusätzlich soll am <.v bounds="9.985602,53.593236,9.992631,53.596901" lon={9.987641} lat={53.594438} dir="forward" ref={BrNordN7}>Lokstedter Weg</.v> die Querung verbessert werden und Höhe des <.v bounds="9.982945,53.594932,9.996036,53.601892" lon={9.989253} lat={53.597594} dir="forward" ref={BrNordN7}>Salomon-Heine-Weg</.v> die Durchfahrt für private KFZ gesperrt werden.</p>

    <p>Auf dem <.v bounds="10.005087,53.596049,10.045167,53.602488" lon={10.019202} lat={53.600238} dir="forward" ref={BrNordN7} highlight="Jahnring,Jahnbrücke,Lauensteinstraße">Ring 2</.v> werden <.ref>Protected-Bike-Lanes</.ref> oder ggf. ein Zweirichtungsradweg auf der Stadtparkseite vorgeschlagen. <.v bounds="10.038122,53.597445,10.04388,53.600467" lon={10.040366} lat={53.599099} dir="forward" ref={BrNordN7}>Neben der Autobrücke</.v> sind wieder Fahrradstraßen vorgesehen, wobei diese fahrradfreundlich an die Radroute 5 angeschlossen werden sollen.</p>
