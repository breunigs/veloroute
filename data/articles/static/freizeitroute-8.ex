defmodule Data.Article.Static.Freizeitroute8 do
  ...
  def links(_assigns) do
    [
      {"Detailseite der Stadt",
       "https://web.archive.org/web/20230923153908/https://www.hamburg.de/radtour/6294580/radtour-city-elbufer-wittenbergen/"},
  ...
  def text(assigns) do
    ...
    <p>Die Tour beginnt an den <.v bounds="9.96592,53.545013,9.971934,53.54705" lon={9.969011} lat={53.546104} dir="forward" ref={Freizeitroute8}>Landungsbrücken</.v> und führt entlang der Elbe und ihren <.v bounds="9.781972,53.55639,9.804119,53.561605" lon={9.788352} lat={53.560075} dir="forward" ref={Freizeitroute8}>Stränden</.v> bis <.v bounds="9.696244,53.564169,9.738179,53.583198" lon={9.735015} lat={53.5655} dir="forward" ref={Freizeitroute8}>Wedel</.v>. Von dort kann entlang der Deiche weiter elbabwärts gefahren werden.</p>
    ...
    <h4>Befahrbarkeit</h4>
    <p>Die Route ist größtenteils asphaltiert oder gepflastert, es gibt aber immer wieder fein geschotterte Abschnitte. Am <.v bounds="9.897939,53.543927,9.914757,53.545029" lon={9.907512} lat={53.54472} dir="forward" ref={Freizeitroute8}>Flaschenhals Övelgönne</.v> muss immer geschoben werden, auf anderen Stücken bei schönem Wetter ebenfalls. Nur am frühen Morgen oder späten Abend ist eine unterbrechungsfreie Fahrt möglich. Zu allen anderen Zeiten: steige ab, bevor es eng wird und sei exzellent zu Anderen!</p>

    <h4>Meinung</h4>
    <p>Wer es gemütlich mag oder neu in Hamburg ist, kann sich die Tour genauer ansehen. Wer vor allem Rad fahren möchte, sollte die Route frühestens ab <.v bounds="9.859689,53.54551,9.870871,53.549437" lon={9.863218} lat={53.547249} dir="forward" ref={Freizeitroute8}>Teufelsbrück</.v> benutzen. Von Altona bietet sich die <.m bounds="9.923566,53.547241,9.936934,53.54851">Holländische Reihe</.m>, <.m bounds="9.87914,53.547219,9.92627,53.550039">Bernadottestraße</.m>, <.m bounds="9.861326,53.546057,9.881644,53.548536">Elbchaussee</.m> als alternative Führung an. Für Rennräder ist die Tour völlig ungeeignet.</p>
