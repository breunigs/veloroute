defmodule Data.Article.Static.LexikonProtectedBikeLane do
  ...
  def text(assigns) do
    ~H"""
    <p><.v lat={53.45947} lon={9.99094} dir="backward" ref="11" bounds="9.986734,53.458457,9.997266,53.465207">Videobeispiel einer Protected Bike Lane auf Veloroute 11</.v></p>
