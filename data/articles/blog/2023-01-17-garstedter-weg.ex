defmodule Data.Article.Blog.GarstedterWeg do
  ...
  def text(assigns) do
    ...
    <h4>Alter Zustand</h4>
    <p>Stellenweise sind schmale <.ref>Hochbordradwege</.ref> vorhanden, die jedoch unvermittelt aufhören und zu reinen Gehwegen werden. Aus dem <.v bounds="9.971391,53.642904,9.976052,53.64581" lon={9.972351} lat={53.643417} dir="forward" ref={Radroute19}>Moorrand</.v> ist das Linksabbiegen häufig schwierig. In der Gegenrichtung ist die Weiterfahrt <.v bounds="9.971391,53.642904,9.976052,53.64581" lon={9.975374} lat={53.645562} dir="backward" ref={Radroute19}>vom Zweirichtungsradweg</.v> unklar und benötigt Ortskenntnisse.</p>

    <.h4_planning ref={@ref} checked={@show_map_image}/>
    <p>Der <.v bounds="9.973331,53.6437,9.978224,53.646511" lon={9.975557} lat={53.645643} dir="backward" ref={Radroute19}>vom Flughafentunnel kommende Zweirichtungsradweg</.v> wird bis zum <.v bounds="9.971391,53.642904,9.976052,53.64581" lon={9.973854} lat={53.64472} dir="backward" ref={Radroute19}>Vierenkamp</.v> verlängert. Nach der Einmündung soll an der Ampel die Straßenseite gewechselt werden um dort auf einer 2,35m breiten <.ref>Protected-Bike-Lane</.ref> Richtung Niendorf zu kommen.</p>

    <p>Weil die <.v bounds="9.971354,53.642528,9.974672,53.644132" lon={9.972748} lat={53.643552} dir="backward" ref={Radroute19} highlight="Moorrand">Einmündung Moorrand</.v> zu einem Kreisverkehr umgebaut wird, geht der Radweg vorher in den <.ref>Mischverkehr</.ref> mit den KFZ über. Er behält dabei bis zum Reißverschlussverfahren die gleiche Breite.</p>

    <p>In Richtung Flughafen erfolgt die <.m bounds="9.969894,53.641631,9.974204,53.644366" highlight="Garstedter Weg">Ableitung im Garstedter Weg</.m> vom Hochbordradweg in den Mischverkehr nach dem gleichen Prinzip. Vorm <.v bounds="9.971828,53.643239,9.976538,53.645589" lon={9.973826} lat={53.644353} dir="forward" ref={Radroute19}>Vierenkamp</.v> schließt eine Protected-Bike-Lane an, die an der Ampel auf den Zweirichtungsradweg führt.</p>
