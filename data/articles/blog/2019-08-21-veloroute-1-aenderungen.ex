defmodule Data.Article.Blog.Veloroute1Aenderungen do
  ...
  def text(assigns) do
    ...
    <p><strong><.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.557889, lon: 9.858056, zoom: 16})} ref="1">Jürgensallee:</.m></strong> Offenbar hat der <.a name="2018-09-28-1-juergensallee">geplante Umbau</.a> begonnen – damit wird ein großer Teil des Kopfsteinpflasters durch Asphalt ersetzt.</p>
    <p><strong><.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.580707, lon: 9.769023, zoom: 16})} ref="1">Alte Sülldorfer Landstraße:</.m></strong> Auch hier wurde offenbar mit der <.a name="2018-09-28-1-alte-suelldorfer-landstrasse">Umsetzung der geplanten Verkehrsberuhigung</.a> begonnen.</p>
