defmodule Data.Article.Blog.TilsiterStrasseBeimAltenTeichweg do
  ...
  def text(assigns) do
    ~H"""
    <p>Ein Teilstück der Planung „W16“ soll bereits umgesetzt werden. Für eine Beschreibung, siehe bitte <.a ref={TilsiterStrasseEckerkoppelW16}>Eckerkoppel und Tilsiter Straße</.a>. </p> <h4>Quelle</h4>
