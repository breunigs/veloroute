defmodule Data.Article.Blog.WellingsbuettelerLandstrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Bestand</h4> <p>In der <.m bounds="10.031161,53.625658,10.057393,53.636639">Wellingsbütteler Landstraße</.m> selbst gibt es im Stadtteil <.m bounds="10.033141,53.628026,10.049216,53.6317">Klein Borstel</.m> keine eigenen Radwege. Es stehen die Optionen offen auf der Fahrbahn mit den KFZ zu fahren oder auf den Fußwegen (<ref>Fahrrad frei</ref>). Die Höchstgeschwindigkeit beträgt 50 km/h. Im <.m bounds="10.029983,53.62536,10.032621,53.626527">Kreuzungsbereich mit der Fuhlsbütteler Landstraße</.m> gibt es schmale <ref>Hochbordradwege</ref>, die mit engen Kuren durch die Kreuzung führen.</p>
    ...
    <h4>Quellen</h4> <ul>
    <li><.a href="https://lsbg.hamburg.de/wellingsbuetteler-landstrasse/14247548/wellingsbuetteler-landstrasse/">Informationsseite der Stadt</.a></li>
    <li><.a href="https://lsbg.hamburg.de/contentblob/15137380/3b55516f4cce539646078a61cbb4db44/data/wellingsbuetteler-landstrasse-abstimmungsunterlage-2-verschickung)-bericht.pdf">Erläuterungsbericht</.a> (2. Entwurf)</li>
    <li><.a href="https://lsbg.hamburg.de/contentblob/15137384/6074c525bf53e8f5a18cc6319de7b110/data/wellingsbuetteler-landstrasse-abstimmungsunterlage-2-verschickung)-plan.pdf">Lagepläne</.a> (2. Entwurf)</li>
    <li><.a href="https://sitzungsdienst-hamburg-nord.hamburg.de/bi/vo020.asp?VOLFDNR=1010724">Präsentation zum 2. Entwurf</.a> (enthält auch Abschätzungen zur Bauzeit)</li>
    </ul>
    """
  end
end
