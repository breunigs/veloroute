defmodule Data.Article.Blog.Wagnerstrasse do
  ...
  def text(assigns) do
    ...
    <h4>Meinung</h4>
    <p>Besser als vorher. Es ist wenig ersichtlich, warum der Schutz vorm KFZ Verkehr nur an einer Stelle gebaut werden soll – die Kurve an der <.v bounds="10.043194,53.566911,10.046493,53.569114" lon={10.04424} lat={53.567916} dir="forward" ref={Alltagsroute13}>Ritterstraße</.v> ist auch nicht viel weiter. Das Planungsbüro sollte <.ref>Kopenhagener Radwege</.ref> als Alternative untersuchen und die Bushaltestellen wie an der <.v bounds="9.991559,53.581655,9.999255,53.585285" lon={9.995531} lat={53.583769} dir="backward" ref={BrEimsbuettelIsebek}>Streekbrücke</.v> gestalten.</p>
