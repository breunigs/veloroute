defmodule Data.Article.Blog.Steintorbruecke do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Am <.v bounds="10.00498,53.551304,10.009721,53.553296" lon={10.007915} lat={53.552148} dir="backward" ref={Radroute7}>Bahnhofsgebäude</.v> wird der Radverkehr auf einem  1,63m breiten <.ref>Hochbordradweg</.ref> geführt. Sowohl der Radweg als auch der angrenzende Gehweg unterschreiten Mindestmaße und sind überlastet.</p>

    <p>Auf der <.v bounds="10.00494,53.551034,10.009658,53.552736" lon={10.006934} lat={53.551771} dir="forward" ref={Radroute7}>Südseite der Brücke</.v> wurde vor einigen Jahren eine Bushaltestelle eingerichtet. Der Radweg verläuft dabei zwischen dem Gehweg und der Wartefläche für Fahrgäste. Er ist auf beiden Seiten mit verkleideten Geländern abgetrennt. An zwei Stellen befinden sich Durchlässe, damit vom Gehweg zur Bushaltestelle gewechselt werden kann.</p>

    <p>In Richtung <.v bounds="10.004041,53.549441,10.007591,53.552738" lon={10.006286} lat={53.551879} dir="backward" ref={Radroute7} highlight="Mönckebergstraße,Klosterwall">Mönckebergstraße bzw. Klosterwall</.v> quert man zunächst den KFZ-Rechtsabbieger, um eine Aufstelltasche („<.ref>ARAS</.ref>“) zu erreichen. Von dort kann geradeaus oder <.ref>direkt links abgebogen</.ref> werden.</p>

    <p>In der <.m bounds="10.007121,53.551518,10.010247,53.554821">Kirchenallee</.m> gibt es keine eigenen Radwege.</p>

    <.h4_planning ref={@ref} checked={@show_map_image}/>
    <p>Am <.v bounds="10.00498,53.551304,10.009721,53.553296" lon={10.007915} lat={53.552148} dir="backward" ref={Radroute7}>Bahnhofsgebäude</.v> soll eine Bushaltestelle ergänzt werden. Die Gestaltung wird dabei ähnlich wie auf der Südseite:</p>
    <ul>
    ...
    <p>Damit die Bushaltestelle zu Fuß ebenerdig erreicht werden kann, sind Rampen auf dem Radweg vorgesehen. Anders als auf der <.v bounds="10.00494,53.551034,10.009658,53.552736" lon={10.006934} lat={53.551771} dir="forward" ref={Radroute7}>Südseite</.v> werden zwei einzelne Rampen gebaut, statt einer langen, durchgängigen Rampe. Diese wurde auf der Südseite häufig als Gehweg missverstanden, was man so verhindern möchte.</p>

    <p>Privater KFZ-Verkehr darf die Steintorbrücke künftig nur noch in Fahrtrichtung Osten nutzen.</p>

    <p>Die <.v bounds="10.004041,53.549441,10.007591,53.552738" lon={10.006286} lat={53.551879} dir="backward" ref={Radroute7} highlight="Mönckebergstraße,Steintorwall,Steintordamm">westliche Kreuzung</.v> wird umgestaltet. Der ehemalige KFZ-Rechtsabbieger wird zum Gehweg. Der Radweg verschwenkt noch leicht, bleibt aber sonst immer rechts der Busse und Taxen. Zum <.ref>indirekten Linksabbiegen</.ref> wird ein Aufstellbereich auf der <.v bounds="10.004427,53.550924,10.00749,53.552663" lon={10.005482} lat={53.551927} dir="forward" ref={Radroute2}>anderen Straßenseite</.v> vorgesehen. Der <.v bounds="10.003929,53.550596,10.008349,53.553732" lon={10.005958} lat={53.552012} dir="backward" ref={Radroute2}>Radweg in Richtung Alster</.v> bleibt so wie heute.</p>
