defmodule Data.Article.Blog.Alsterufer do
  ...
  def text(assigns) do
    ...
    <p>An der <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.559231, lon: 9.995508, zoom: 16.4})} ref="4">Alsterterrasse</.m> endet die Fahrradstraße, wobei der Radverkehr hier trotzdem Vorfahrt eingeräumt bekommen soll. Im Anschluss wird provisorisch an die vorhandenen Radwege angeschlossen – der Vollumbau soll während der <.a name="2019-04-10-4-kreuzung-neuer-jungfernstieg">Umgestaltung der Kreuzung</.a> erfolgen. Auf <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.558453, lon: 9.99479, zoom: 16.31})} ref="4">Höhe der Kurve</.m> wird durch eine Querungshilfe und kurzes Radweg-Verbindungsstück die Weiterfahrt über die Kennedybrücke ermöglicht.</p>
