defmodule Data.Article.Blog.Alsterufer do
  ...
  def text(assigns) do
    ...
    <p><.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.56365, lon: 9.998439, zoom: 16.31})} ref="4">Von Norden kommend</.m> wird die Fahrradstraße bis zur <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.56365, lon: 9.998439, zoom: 16.31})} ref="4">Absperrung am Konsulat</.m> im Wesentlichen genauso fortgesetzt. Das heißt 5,5m breit und freie Sicht auf die Alster. Parkplätze gibt es nur zur Gebäudeseite hin. Schikanen, Poller und andere Hindernisse sind hier nicht geplant.</p>
    ...
    <p>An der <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.559231, lon: 9.995508, zoom: 16.4})} ref="4">Alsterterrasse</.m> endet die Fahrradstraße, wobei der Radverkehr hier trotzdem Vorfahrt eingeräumt bekommen soll. Im Anschluss wird provisorisch an die vorhandenen Radwege angeschlossen – der Vollumbau soll während der <.a href="/article/2019-04-10-4-kreuzung-neuer-jungfernstieg">Umgestaltung der Kreuzung</.a> erfolgen. Auf <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.558453, lon: 9.99479, zoom: 16.31})} ref="4">Höhe der Kurve</.m> wird durch eine Querungshilfe und kurzes Radweg-Verbindungsstück die Weiterfahrt über die Kennedybrücke ermöglicht.</p>
