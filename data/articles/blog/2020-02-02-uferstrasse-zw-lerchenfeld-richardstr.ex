defmodule Data.Article.Blog.UferstrasseZwLerchenfeldRichardstr do
  ...
  def text(assigns) do
    ...
    <h4>Alter Zustand</h4>
    <p>Die Uferstraße wird im Abschnitt vom Rad- und Fußverkehr dominiert. Lediglich auf einem <.v bounds="10.029847,53.566372,10.038941,53.570645" lon={10.033246} lat={53.567736} dir="forward" ref={Alltagsroute6}>Teilstück</.v> sind KFZ sind zugelassen, die dort nur die anliegenden Gebäude bzw. Parkplätze erreichen können – eine Durchfahrt ist nicht möglich. Im gesamten Planungsgebiet teilen sich alle Verkehrsarten den verfügbaren Platz. Das Pflaster im gesamten Abschnitt ist eher uneben.</p>

    <h4>Planung</h4>
    <p>Bis zur Einmündung <.v bounds="10.031237,53.567264,10.035161,53.569063" lon={10.033542} lat={53.567906} dir="forward" ref={Alltagsroute6}>Finkenau</.v> soll eine gut 4,5m breite, asphaltierte Fahrradstraße entstehen. Die KFZ-Parkplätze werden längs ausgerichtet, um Gefährdungen beim Ausparken zu verringern. Die Fahrradstraße erhält gegenüber der Finkenau Vorfahrt.</p>

    <p>Im Anschluss schließt ein 4,0m breiter, gepflasteter Radweg an. Zum Baumerhalt <.v bounds="10.033556,53.568121,10.037134,53.569893" lon={10.035243} lat={53.568833} dir="forward" ref={Alltagsroute6}>verbleibt eine Engstelle</.v> mit 3,0m. Der Fußweg wird 2,5m bis 3,0m breit. Ursprünglich war eine durchgehende Asphaltierung angedacht, die aber wegen der stärkeren Versiegelung, den höheren Kosten bei Wurzelaufbrüchen und optischen Gründen („platzartigen Charakter … der stadträumlichen Gestaltung beibehalten“) abgelehnt wurde.</p>

    <p>Vor der <.v bounds="10.035655,53.568957,10.038308,53.570958" lon={10.037142} lat={53.569783} dir="forward" ref={Alltagsroute6}>Richardstraße</.v> endet der Radweg. Zur Fahrt entlang der Veloroute muss damit allem querenden Verkehr Vorrang gewährt werden, inklusive dem Fußverkehr. Die Poller werden in Richtung des <.ref>Radfahrstreifens</.ref> auf der Richardstraße verschoben.</p>
