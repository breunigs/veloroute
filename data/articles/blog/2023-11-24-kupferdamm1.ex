defmodule Data.Article.Blog.Kupferdamm1 do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>In Richtung Süden gibt es einen heruntergekommen <.ref>Hochbordradweg</.ref>. In der Gegenrichtung ist nur <.ref>Mischverkehr</.ref> möglich, der Straßenbelag aber genauso schlecht.</p>
    ...
    <p>Umwerfend ist die Planung aber nicht, denn dazu müsste sie den privaten KFZ-Verkehr stärker herausnehmen. Auch ist das Linksabbiegen am Pulverhofsweg unklar. Für <.ref>indirektes Linksabbiegen</.ref> fehlen die Aufstellflächen, und zum direkten Abbiegen darf man nicht auf den Radfahrstreifen wechseln. Das erschließt sich ohne Ortskenntnis aber nicht.</p>
