defmodule Data.Article.Blog.SbahnPulverhof do
  ...
  def name(), do: "#{created_at()}-sbahn-pulverhof"
  ...
  def text(assigns) do
    ~H"""
    <h4>Bestand</h4> <p>Der Radverkehr teilt sich die Fahrbahn mit den Autos. Am beschrankten Bahnübergang entstehen mitunter längere Wartezeiten.</p>
    ...
    <h4>Meinung</h4> <p>Die Rampen und Unterführung werden zwar großzügig angelegt, bedeuten aber immer noch sechs Kehrtwenden und zwei 90° Winkel um der Veloroute zu folgen. Einerseits ist dies gut, da die niedrige Geschwindigkeit brenzligen Situationen vorbeugt, die durch die gemischte Fuß- und Radführung hervorgerufen werden. Andererseits ist eine geradlinige und zügige Fahrt für eine Veloroute unabdingbar.</p> <p>Die gesamte Straße zu unterführen wurde zwar untersucht, aber wegen des Platzbedarfs abgelehnt. Auch wäre hier eine weitere Zufahrt für die anliegenden Grundstücke notwendig gewesen. Es ist schade, das keine geradlinige Unterführung nur für den Fuß- und Radverkehr untersucht wurde, da diese deutlich schmaler ausfiele und daher ggf. passen könnte.</p>
    <h4>Quelle</h4> <ul>
    <li>
    <.a href="https://www.hamburg.de/bwi/np-aktuelle-planfeststellungsverfahren/13609674/s4/">Planfeststellungsverfahren 2 S-Bahn Linie 4 Hamburg</.a> (Stadt Hamburg).<br>
    ...
    <li><.a href="https://sitzungsdienst-wandsbek.hamburg.de/bi/vo020.asp?VOLFDNR=1013886">Stellungnahme der Behörden zur Planung</.a></li>
    </ul>
    """
  end
end
