defmodule Data.Article.Blog.FernbahnhofDiebsteich do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Die Freizeitroute führte über eine <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.934788} lat={53.569005} dir="forward" ref={Freizeitroute9}>schmale Fußgängerbrücke</.v> bzw. die <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.934633} lat={53.568042} dir="forward" ref={Freizeitroute9}>Zuwegung zum S-Bahn-Halt</.v> Diebsteich. Der gesamte Abschnitt war ein Fußweg, es musste also geschoben werden.</p>

    <p>In der <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.933245} lat={53.567507} dir="forward" ref={Freizeitroute9}>Schleswiger Straße</.v> durfte auf dem bahnseitigen Gehweg gefahren werden. Für mehr als Schrittgeschwindigkeit musste unebenes Kopfsteinpflaster benutzt werden.</p>

    <p>Am <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.933209} lat={53.567011} dir="backward" ref={Freizeitroute9}>Zebrastreifen auf der Westseite der Unterführung</.v> kam es häufig zu Unfällen.</p>

    <h4>Planung</h4>
    <h5>Ostseite</h5>
    <p>Auf Seite des neuen Fernbahnhofs beginnt ab etwa Höhe <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.93555} lat={53.568752} dir="forward" ref={Freizeitroute9}>Waidmannstraße</.v> ein 3,0m breiter Zweirichtungsradweg nach Süden. Er verläuft neben einer neuen, zweispurigen Fahrbahn. Die <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.935772} lat={53.568342} dir="forward" ref={Freizeitroute9}>Isebekstraße</.v> wird als wartepflichtige Gehwegüberfahrt an die Fahrbahn angebunden, allerdings nicht an den Radweg.</p>
    ...
    <p>Die <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.935419} lat={53.568815} dir="forward" ref={Freizeitroute9}>Waidmannstraße</.v>, die <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.934895} lat={53.569163} dir="forward" ref={Freizeitroute9}>Große Bahnstraße</.v> und der Bahnhofsvorplatz sollen nur für KFZ-Anlieger, ÖPNV, Rad- und Fußverkehr freigegeben werden. Allgemeiner KFZ-Verkehr ist von Süden nur bis zum Vorplatz zugelassen und kann dort über einen Wendekreis umkehren. KFZ-Parken ist hauptsächlich in einer Tiefgarage vorgesehen.</p>

    <h5>Südseite / Unterführung</h5>
    <p>Der Zweirichtungsradweg endet in <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.934047} lat={53.566843} dir="forward" ref={Freizeitroute9}>der Unterführung</.v>. Der Radverkehr in Richtung Westen muss sich dort in den <.ref>Mischverkehr</.ref> einordnen. Für die Gegenrichtung steht eine langgezogene, rund 3m breite Aufstellfläche bereit um ihn gut erreichen zu können. Die Benutzung der Fahrbahn soll in der Unterführung verboten werden.</p>

    <p>In der <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.934763} lat={53.567016} dir="forward" ref={Freizeitroute9}>Plöner Straße</.v> in Richtung Süden wird der Zweirichtungsradweg auf der Häuserseite weitergeführt. Er wird hier an einer Engstelle nur 2,25m breit, sonst 2,85m. Die Querung erfolgt mittels Ampel, wobei jeweils eigene Abbiegespuren vorgesehen sind.</p>

    <h5>Westseite</h5>
    <p>Die <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.933245} lat={53.567507} dir="forward" ref={Freizeitroute9}>Schleswiger Straße</.v> wird über einen Kreisel angebunden. Ab hier wird dann ausschließlich im <.ref>Mischverkehr</.ref> bei Tempo 50 gefahren. <.v bounds="9.926438,53.565059,9.939544,53.570201" lon={9.933061} lat={53.568664} dir="forward" ref={Freizeitroute9}>In der Kurve</.v> wird eine StadtRAD Station errichtet.</p>
