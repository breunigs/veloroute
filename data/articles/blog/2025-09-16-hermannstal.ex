defmodule Data.Article.Blog.Hermannstal do
  ...
  def text(assigns) do
    ...
    <p>In <.v bounds="10.084578,53.553401,10.090665,53.555302" lon={10.089105} lat={53.554501} dir="backward" ref={Radroute1}>Richtung Innenstadt</.v> soll ein asphaltierter <.ref>Kopenhagener Radweg</.ref> mit rund 1,85m Breite entstehen. Auf <.v bounds="10.084578,53.553401,10.090665,53.555302" lon={10.088199} lat={53.554809} dir="backward" ref={Radroute1}>Höhe des Parkhauses</.v> weitet sich der Radweg auf 2,0m auf und wird zu einem gepflasterten Hochbordradweg. Auf dieser Seite entfällt die Ampel für den Radverkehr. An der <.v bounds="10.081802,53.55411,10.085936,53.555883" lon={10.084548} lat={53.55493} dir="backward" ref={Radroute1} highlight="Rennbahnstraße">Kreuzung mit der Rennbahnstraße</.v> wird die Querungsfurt geradliniger.</p>

    <p>In <.v bounds="10.084004,53.554221,10.087181,53.555481" lon={10.084997} lat={53.55467} dir="forward" ref={Radroute1}>Richtung Billstedt</.v> wird der vorhandene <.ref>Radfahrstreifen</.ref> an der Bushaltestelle weitergeführt. Er soll 1,60m breit werden und zwischen KFZ-Fahrbahn und KFZ-Parkplätzen liegen. Nach der <.v bounds="10.08682,53.553527,10.090865,53.55536" lon={10.087824} lat={53.5548} dir="forward" ref={Radroute1}>Zufahrt zum Parkhaus</.v> wird auf einen 2,0m breiten Hochbordradweg geleitet.</p>
