defmodule Data.Article.Blog.MaxBrauerAlleeNord do
  ...
  def text(assigns) do
    ...
    <p>Der <.v bounds="9.95435,53.560863,9.968778,53.566964" lon={9.960515} lat={53.564046} dir="backward" ref={Radroute14}>nördliche Hochbordradweg</.v> bleibt erhalten und wird auf meist 2,5m verbreitert. Nur an den Anschlüssen (von Altonaer Straße bzw. Richtung Sternbrücke) bleibt es bei den alten Maßen mit rund 1,6m. Auch der <.v bounds="9.95435,53.560863,9.968778,53.566964" lon={9.959661} lat={53.56371} dir="backward" ref={Radroute14}>Gehweg vor der Gastro</.v> wird breiter.</p>

    <p>Auf der <.v bounds="9.95435,53.560863,9.968778,53.566964" lon={9.956142} lat={53.56183} dir="forward" ref={Radroute14}>Südseite</.v> wird ein rund 2,4m breiter <.ref>Kopenhagener Radweg</.ref> vorgeschlagen. An Einfahrten wird dieser etwas schmaler, um einen abgesenkten Bordstein unterbringen zu können. <.v bounds="9.956509,53.562078,9.964197,53.564985" lon={9.959469} lat={53.563467} dir="forward" ref={Radroute14}>Kurz vorm Schulterblatt</.v> wechselt die Führung zu einem Hochbordradweg, der hinter der Bushaltestelle vorbeiführt. Dadurch kann der Radweg auch <.v bounds="9.956509,53.562078,9.964197,53.564985" lon={9.960829} lat={53.563873} dir="forward" ref={Radroute14}>vorm Supermarkt</.v> 2,5m breit bleiben.</p>

    <p>An den Kreuzungen sind jeweils Rampen geplant, um auf die Höhe der Fahrbahn zu kommen. Von den Radwegen kommend ist immer nur <.ref>indirektes Linksabbiegen</.ref> vorgesehen. An <.v bounds="9.953774,53.561031,9.960769,53.565069" lon={9.957516} lat={53.562498} dir="forward" ref={Radroute14} highlight="Langenfelder Straße,Lippmannstraße">Langenfelder- und Lippmannstraße</.v> werden Trittbretter installiert, sodass man bei roter Ampel nicht unbedingt absteigen muss.</p>
    ...
    <p>Zumindest an <.v bounds="9.953774,53.561031,9.960769,53.565069" lon={9.957516} lat={53.562498} dir="forward" ref={Radroute14} highlight="Langenfelder Straße,Lippmannstraße">Langenfelder- und Lippmannstraße</.v> wäre durch KFZ-Einbahnstraßen eine ampelfreie Lösung denkbar. Mit einer Mittelinsel in der Max-Brauer-Allee bleibt auch das Queren zu Fuß und auf dem Rad einfach.</p>
