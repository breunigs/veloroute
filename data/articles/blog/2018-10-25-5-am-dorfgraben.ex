defmodule Data.Article.Blog.AmDorfgraben do
  ...
  def text(assigns) do
    ...
    <p>Der Fußweg soll je nach Fortschritt <.a ref={LeeschenblickUndFabriciusstrasse}>des Kreisels mit der Fabriciusstraße</.a> ab Sommer 2020 angelegt werden. Wann der eigentliche Radweg kommen soll ist noch nicht bekannt.</p>
