defmodule Data.Article.Blog.NeugrabenGleisstieg do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4> <p>Der Gleisstieg ist ein asphaltierter, geteilter Fuß- und Radweg mit rund drei Metern Breite. Der Zustand des Weges ist gut.</p>
    <h4>Baustelle</h4> <p>Ab Januar 2021 wird der Abschnitt zu einem 3,0m breiten Zweirichtungsradweg ausgebaut. Der direkt anliegende Gehweg erhält je nach Bäumen unterschiedliche Breiten, mindestens aber 1,75m. Die <.v bounds="9.854198,53.472941,9.859655,53.475449" lon={9.8567359} lat={53.4741625} dir="backward" ref={@ref}> Brücke über den Süderelbebogen</.v> wird nicht verbreitert, ebenso wird ein Stück im Bereich des S-Bahnhofs erst mit einer anderen Maßnahme umgebaut. Dort werden auch neue Fahrradstellplätze gebaut. Der Umbau erfolgt unter Vollsperrung.</p>
