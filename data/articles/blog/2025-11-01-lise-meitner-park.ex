defmodule Data.Article.Blog.LiseMeitnerPark do
  ...
  def text(assigns) do
    ...
    <p>Es gibt keinen befahrbaren Anschluss an den <.v bounds="9.868549,53.57661,9.871781,53.578515" lon={9.869647} lat={53.577284} dir="forward" ref="radroute-7">Stiefmütterchenweg</.v>. Wegen hohem Randstein und geparkten KFZ ist eine durchgehende Fahrt nur selten möglich.</p>
    ...
    <p>Warum man die <.v bounds="9.871355,53.576497,9.875283,53.580177" lon={9.87294} lat={53.577888} dir="forward" ref="FR11">Radroute 18</.v> nicht auch ertüchtigt bleibt offen. Zumindest am Abzweig hätte ein zukunftssicherer Übergang hergestellt werden können. Stattdessen bleibt es dort beim Matschweg.</p>

    <p>Dass das Parkverbot am Stiefmütterchenweg beachtet wird, darf bezweifelt werden. Eine <.ref name="Gehwegnase">Wegvorstreckung</.ref> würde zumindest die Befahrbarkeit sicherstellen.</p>
