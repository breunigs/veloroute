defmodule Data.Article.Blog.Millerntordamm do
  ...
  def text(assigns) do
    ...
    <p>Die Gehwege in Richtung <.m bounds="9.96691,53.550419,9.974874,53.556968">Heiligengeistfeld</.m> sind  auch heute schon oft überfüllt – egal ob DOM ist oder nicht. Auch die Weiterfahrt in Richtung <.v bounds="9.966433,53.549508,9.971978,53.551773" lon={9.970389} lat={53.550798} dir="backward" ref={@ref}>Reeperbahn</.v> bleibt umständlich.</p>
