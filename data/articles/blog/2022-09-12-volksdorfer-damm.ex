defmodule Data.Article.Blog.VolksdorferDamm do
  ...
  def text(assigns) do
    ...
    <p>Vom <.v bounds="10.155666,53.656414,10.160258,53.6611" lon={10.159768} lat={53.656732} dir="forward" ref={@ref}>Rögenweg</.v> bis vor die <.v bounds="10.155666,53.656414,10.160258,53.6611" lon={10.156093} lat={53.660939} dir="forward" ref={@ref}>Bushaltestelle Frankring</.v> soll der Schutzstreifen auf der Ostseite verlaufen. Über die Gehwegüberfahrt der Nebenfahrbahn kann auf den Fußweg gewechselt werden.</p>

    <p>Der Schutzstreifen verläuft nun auf der Westseite. Auch hier sind die Randsteine abgesenkt um einen Wechsel auf den Gehweg zu erlauben. Der westliche Schutzstreifen setzt sich bis zur Einmündung <.v bounds="10.148117,53.662394,10.152173,53.664332" lon={10.149507} lat={53.663367} dir="forward" ref={@ref}>Streekweg</.v> fort. Linksabbiegen in den Streekweg selbst ist nur von der Fahrbahn aus möglich. Auch das Queren zu Fuß wird nicht gestattet.</p>

    <p>Ab dem <.v bounds="10.146985,53.663101,10.149563,53.668224" lon={10.149087} lat={53.663505} dir="forward" ref={@ref}>Streekweg</.v> bis etwa <.v bounds="10.146985,53.663101,10.149563,53.668224" lon={10.147302} lat={53.667953} dir="forward" ref={@ref}>Höhe Hausnummer 137</.v> wird kein Schutzstreifen aufgemalt. Beide Seiten behalten die „Fahrrad frei“ Beschilderung.</p>

    <p>Danach beginnt wieder auf der Westseite der Schutzstreifen, welcher sich bis zur Kreuzung mit dem <.v bounds="10.144642,53.668474,10.145848,53.669323" lon={10.145376} lat={53.668972} dir="forward" ref={@ref}>Volksdorfer Grenzweg</.v> fortsetzt. Auf der Ost- bzw. Nordseite wird der Radverkehr etwa auf <.v bounds="10.145734,53.668508,10.14694,53.669356" lon={10.146472} lat={53.668821} dir="forward" ref={@ref}>Höhe Hausnummer 158</.v> auf die Fahrbahn geleitet, wo ebenfalls ein Schutzstreifen aufgemalt ist.</p>

    <p>Die Kreuzung mit dem <.v bounds="10.144642,53.668474,10.145848,53.669323" lon={10.145376} lat={53.668972} dir="forward" ref={@ref}>Volksdorfer Grenzweg</.v> wird zu einem Kreisverkehr umgebaut. Alle Knotenarme erhalten Zebrastreifen. Im Kreisel selbst fährt man im <.ref>Mischverkehr</.ref>.</p>
