defmodule Data.Article.Blog.Hegarstrasse do
  ...
  def text(assigns) do
    ...
    <p>Der Gehweg auf der Bahnseite wird gepflastert. Zum Schutz der Baumwurzeln erfolgt dies mit einem Metallgitter, in das kleine Pflastersteine gelegt werden („TTE-System“. Siehe z.B. <.v bounds="10.013608,53.565017,10.018834,53.568994" lon={10.016452} lat={53.566264} dir="forward" ref={Freizeitroute2}>Radweg am Schwanenwik</.v>). Außerhalb der Baumstämme soll der Gehweg 3,55m breit werden. </p>
