defmodule Data.Article.Blog.CranzerUndNeuenfelderHauptdeich do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Vom <.v bounds="9.805543,53.52548,9.813905,53.531605" lon={9.810967} lat={53.528207} dir="forward" ref="e">Airbus-Werk</.v> bis zur <.v bounds="9.785382,53.532437,9.795122,53.538911" lon={9.791439} lat={53.534895} dir="forward" ref="e">Este-Einmündung</.v> ist ein 1,5m breiter Gehweg vorhanden, der mittels „<.ref>Fahrrad frei</.ref>“ auch vom Radverkehr benutzt werden darf. Zusätzlich gibt es noch einen wasserseitigen Geh- und Radweg, der intuitiv kaum zu finden ist.</p>

    <p>Auch nach der <.v bounds="9.776768,53.533241,9.792778,53.540842" lon={9.790188} lat={53.53532} dir="forward" ref="e">Este-Einmündung</.v> stehen zunächst beide Wege zur Wahl. Der straßenseitige Weg endet Höhe <.m bounds="9.772087,53.539707,9.776794,53.542368">Cranzer Elbdeich</.m>. Dort muss man entweder in den <.ref>Mischverkehr</.ref> mit den KFZ wechseln oder über eine Treppe auf dem wasserseitigen Weg weiterradeln.</p>
    ...
    <p>Der straßenseitige Geh- und Radweg wird zunächst auf rund 4,0m verbreitert. Im Bereich des <.v bounds="9.805417,53.528804,9.807615,53.530745" lon={9.807071} lat={53.529743} dir="forward" ref="e">Schöpfwerks</.v> und des <.v bounds="9.788432,53.533331,9.793059,53.536433" lon={9.791513} lat={53.534874} dir="forward" ref="e">Sperrwerks</.v> bleiben Engstellen mit rund 3,15m.</p>
