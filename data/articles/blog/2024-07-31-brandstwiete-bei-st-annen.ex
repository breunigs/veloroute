defmodule Data.Article.Blog.BrandstwieteBeiStAnnen do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Entlang der <.a ref={Alltagsroute10}>Radroute 10</.a> wird meist zusammen mit den KFZ im <.ref>Mischverkehr</.ref> bei Tempo 50 gefahren. Nur in der <.v bounds="9.995276,53.544341,9.999464,53.548604" lon={9.99728} lat={53.54671} dir="backward" ref={Alltagsroute10} highlight="Brandstwiete">Brandstwiete Richtung Rathaus</.v> steht ein 1,5m breiter <.ref>Hochbordradweg</.ref> bereit. Die Trennung zum Gehweg ist kaum sichtbar.</p>

    <.h4_planning ref={@ref} checked={@show_map_image}/>
    <p>Mit schnell umzusetzenden Maßnahmen soll die Situation für den Radverkehr verbessert werden.</p>

    <p>In <.v bounds="9.996619,53.543578,9.998529,53.547827" lon={9.996798} lat={53.547695} dir="forward" ref={Alltagsroute10}>Fahrtrichtung HafenCity</.v> soll ein <.ref>Radfahrstreifen</.ref> aufgemalt werden. An Stellen mit Kopfsteinpflaster werden dagegen silberne Markierungsnägel eingebaut, wie sie heute schon vor der <.v bounds="9.980623,53.542172,9.985666,53.545347" lon={9.98349} lat={53.543221} dir="forward" ref={Freizeitroute0}>Niederbaumbrücke</.v> Verwendung finden. An den Bushaltestellen wird der Radfahrstreifen jeweils unterbrochen. Man muss entweder hinter dem Bus warten, oder sich zum Vorbeifahren in den KFZ-Verkehr einordnen.</p>

    <p>In <.v bounds="9.996619,53.543578,9.998529,53.547827" lon={9.998074} lat={53.543818} dir="backward" ref={Alltagsroute10}>Fahrtrichtung Rathaus</.v> wird nur um die <.v bounds="9.996023,53.544216,9.999316,53.546632" lon={9.997352} lat={53.545065} dir="backward" ref={Alltagsroute10}>Wandbereiterbrücke</.v> herum ein Radfahrstreifen angelegt. Zusätzlich wird der vorhandene Hochbordradweg in der Brandstwiete auf 2,0m verbreitert und mit weißen Noppenplatten deutlicher von Gehweg und Bushaltestelle abgetrennt.</p>
