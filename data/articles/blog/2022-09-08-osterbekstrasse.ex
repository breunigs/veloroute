defmodule Data.Article.Blog.Osterbekstrasse do
  ...
  def text(assigns) do
    ...
    <h4>Planung</h4>
    <p>Es ist vorgesehen die Osterbekstraße dort zu einer asphaltierten Fahrradstraße zu machen, wo auch heute Autos erlaubt sind. Sie ist nur für Anlieger zugelassen. An Einmündungen und den Wendehammern soll die Fahrradstraße jeweils bevorrechtigt werden. Im <.v bounds="10.029367,53.583451,10.034209,53.585013" lon={10.030473} lat={53.583997} dir="forward" ref={Freizeitroute2}>östlichen Teil</.v> ist das Abstellen von KFZ nur noch in Parkbuchten erlaubt. Im  <.v bounds="10.018999,53.58067,10.02588,53.583537" lon={10.02042} lat={53.581521} dir="forward" ref={Freizeitroute2}>westlichen Teil</.v> sind auf der Häuserseite auch Parkbuchten vorgesehen, auf der Wasserseite dagegen Parken am Straßenrand mittels Markierungen. </p>

    <p>Der für Autos nicht zugängliche <.v bounds="10.023108,53.581925,10.030726,53.584378" lon={10.025687} lat={53.583315} dir="forward" ref={Freizeitroute2}>Abschnitt im Park</.v> wird in einer anderen Planung überarbeitet. Es ist aber angedeutet, dass dort ein 4,0m breiter Radweg neben einem 3,0m breiten Gehweg verlaufen könnte.</p>

    <p>Die Kreuzungen mit der <.v bounds="10.01895,53.580441,10.0227,53.582683" lon={10.019697} lat={53.581449} dir="forward" ref={Freizeitroute2}>Bachstraße</.v> bzw. <.v bounds="10.032445,53.583153,10.035777,53.585438" lon={10.033327} lat={53.584478} dir="forward" ref={Freizeitroute2}>Schleidenstraße</.v> sind nicht Teil dieser Planung.</p>
