defmodule Data.Article.Blog.Osterbekstrasse do
  ...
  def text(assigns) do
    ...
    <h4>Meinung</h4>
    <p>Die Planung wirkt gut. Es ist kurios wie viel Wert in der Planung darauf gelegt wird, möglichst viele KFZ-Parkplätze zu erhalten. Dabei hat das nahe Einkaufszentrum riesige Tiegaragen, die oberirdische Parkplätze bis auf Ausnahmen überflüssig machen. Auf diese geht der Erläuterungsbericht nicht ein.</p>
