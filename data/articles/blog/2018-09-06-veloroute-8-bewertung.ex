defmodule Data.Article.Blog.Veloroute8Bewertung do
  ...
  def name(), do: "#{created_at()}-veloroute-8-bewertung"
  ...
  def text(assigns) do
    ...
    <p><.a target="_blank" href="https://www.abendblatt.de/hamburg/article215496251/In-Billstedt-brauchen-Radler-gutes-Sitzfleisch.html" rel="nofollow">Zeitungsartikel/Review vom 06.10.2018</.a></p>
    """
  end
end
