defmodule Data.Article.Blog.KreiselKanalplatz do
  ...
  def links(_assigns) do
    [
      {"Bauvergabe", ~d[2025-05],
       "https://fbhh-evergabe.web.hamburg.de/evergabe.bieter/api/supplier/external/deeplink/subproject/18a60d0e-902a-4105-8b4c-a32fca7490ea"},
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Der Zweirichtungsradweg auf der Wasserseite <.v bounds="9.98178,53.465579,9.988075,53.467298" lon={9.984257} lat={53.466576} dir="forward" ref={Alltagsroute10} highlight="Kanalplatz,Veritaskai">entlang des Kanalplatzes / Veritaskais</.v> ist provisorisch mit Betonblöcken abgetrennt. Das Abbiegen <.v bounds="9.983329,53.465761,9.985526,53.467028" lon={9.984012} lat={53.466679} dir="forward" ref={Alltagsroute10}>in die Harburger Schloßstraße</.v> erfolgt zwischen ihnen hindurch auf einen <.ref>Hochbordradweg</.ref>. Auch die <.v bounds="9.983367,53.465801,9.984901,53.466977" lon={9.984027} lat={53.466406} dir="backward" ref={Alltagsroute10}>Gegenrichtung</.v> funktioniert so.</p>
    ...
    <p>Langfristig soll in der <.v bounds="9.982002,53.464187,9.984832,53.467173" lon={9.983843} lat={53.466055} dir="backward" ref={Alltagsroute10}>Harburger Schloßstraße</.v> der Radverkehr im <.ref>Mischverkehr</.ref> fahren. Vom Kreisel weg wird daher keine Aufleitung auf den vorhandenen Hochbordradweg gebaut. In der Gegenrichtung ist eine Ableitung vorm Kreisel geplant.</p>
