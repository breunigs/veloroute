defmodule Data.Article.Blog.BahnquerungHafenbahn do
  ...
  def text(assigns) do
    ...
    <h4>Vorhaben</h4>
    <p>Bereits seit einigen Jahren war angedacht eine weitere Bahnquerung zu schaffen. Dem Radverkehr könnte so eine direkte Verbindung zwischen <.m lon={9.979817} lat={53.465206} dir="forward" ref="10" bounds="9.979222,53.464637,9.982427,53.46752">Blohmstraße</.m> und <.m bounds="9.96703,53.467732,9.974075,53.470129" lon={9.967971} lat={53.469766} dir="backward" ref="10">Bostelbeker Hauptdeich</.m> angeboten werden.</p>
