defmodule Data.Article.Blog.BahnquerungHafenbahn do
  ...
  def text(assigns) do
    ...
    <h4>Alter Zustand</h4>
    <p>Die Hafenbahn kann nur an wenigen Stellen gequert werden. Befahrbar sind davon die Unterführungen zur <.v bounds="9.980128,53.463321,9.983372,53.464776" lon={9.981858} lat={53.464174} dir="forward" ref={Alltagsroute10}>Neuen Straße</.v> und an der <.m bounds="9.960181,53.471026,9.963274,53.473107">Moorburger Straße</.m>. Zu Fuß steht auch noch eine Treppenanlage an der <.m bounds="9.978346,53.464612,9.979791,53.465319">Seehafenbrücke</.m> zur Verfügung. Keine der genannten Möglichkeiten ist für den Radverkehr ausgelegt.</p>

    <h4>Ehemaliges Vorhaben</h4>
    <p>Bereits seit einigen Jahren war angedacht eine weitere Bahnquerung zu schaffen. Dem Radverkehr könnte so eine direkte Verbindung zwischen <.v lon={9.979817} lat={53.465206} dir="forward" ref={Alltagsroute10} bounds="9.979222,53.464637,9.982427,53.46752">Blohmstraße</.v> und <.v bounds="9.96703,53.467732,9.974075,53.470129" lon={9.967971} lat={53.469766} dir="backward" ref={Alltagsroute10}>Bostelbeker Hauptdeich</.v> angeboten werden.</p>
