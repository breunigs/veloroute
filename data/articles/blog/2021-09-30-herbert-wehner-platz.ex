defmodule Data.Article.Blog.HerbertWehnerPlatz do
  ...
  def text(assigns) do
    ...
    <p>Der Abschnitt ist Teil der <.a ref={InnenstadtHarburg}>Planungen zur Harburger Innenstadt</.a>. Da der Herbert-Wehner-Platz umgestaltet werden soll, entschied man sich den rund 160m langen Straßenabschnitt ebenfalls mit umzubauen. Die anderen Abschnitte kommen erst in den folgenden Jahren.</p>
