defmodule Data.Article.Blog.WiesendammWest do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p><.v bounds="10.011874,53.584906,10.047674,53.591509" lon={10.014014} lat={53.589934} dir="forward" ref={BrNordN6}>Richtung Bahnhof Barmbek</.v> gibt es anfangs keine eigenen Radwege – es wird im <.ref>Mischverkehr</.ref> geradelt. <.v bounds="10.011527,53.587427,10.026449,53.5915" lon={10.018371} lat={53.589547} dir="forward" ref={BrNordN6}>Etwas später</.v> beginnt ein <.ref>Hochbordradweg</.ref> ohne erkennbare Aufleitung, der auch teilweise in der <.ref>Dooring-Zone</.ref> verläuft. Nach der <.v bounds="10.017782,53.587138,10.032368,53.591234" lon={10.020781} lat={53.589243} dir="forward" ref={BrNordN6}>Brücke über den Goldbekkanal</.v> beginnt dann ein rund 1,5m breiter <.ref>Radfahrstreifen</.ref>. Kurz vor der <.v bounds="10.028178,53.586153,10.038572,53.590294" lon={10.031333} lat={53.587957} dir="forward" ref={BrNordN6} highlight="Saarlandstraße">Kreuzung mit der Saarlandstraße</.v> kann wahlweise im Mischverkehr oder auf einem Hochbordradweg weitergefahren werden.</p>

    <p><.v bounds="10.010602,53.586818,10.03583,53.591603" lon={10.032761} lat={53.588126} dir="backward" ref={BrNordN6}>Richtung Bahnhof Borgweg</.v> gibt es einen rund 1,0m breiten Hochbordradweg in der Dooring-Zone. Ab <.v bounds="10.011317,53.5883,10.021055,53.591582" lon={10.019416} lat={53.589539} dir="backward" ref={BrNordN6}>Wiesenstieg</.v> wird dieser auf einen 1,5m breiten Radfahrstreifen überführt, der <.v bounds="10.011317,53.5883,10.021055,53.591582" lon={10.019416} lat={53.589539} dir="backward" ref={BrNordN6}>kurz darauf</.v> wieder endet. Bis zum Barmbeker Weg ist dann wieder Mischverkehr, da der alte Hochbordradweg weder erreichbar noch wegen der darauf parkenden Autos nutzbar ist.</p>
