defmodule Data.Article.Blog.StBenedictstrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Im <.v bounds="9.988819,53.581511,9.993987,53.583465" lon={9.989747} lat={53.58205} dir="forward" ref={@ref}>westlichen Teil</.v> gibt es keine eigenen Radwege und man muss im <.ref>Mischverkehr</.ref> mit den Autos mitschwimmen. Ab der <.v bounds="9.993217,53.582736,9.995991,53.584201" lon={9.993882} lat={53.583199} dir="forward" ref={@ref}>Kreuzung mit der Heilwigstraße</.v> sind noch schmale <.ref>Hochbordradwege</.ref> vorhanden, die jedoch schlecht erreichbar sind und beim Umbau des Leinpfads auch gar nicht mehr angeschlossen wurden.</p>

    <h4>Planung</h4>
    <p>Es sollen meist <.ref>Schutzstreifen</.ref> mit rund 1,65m Breite aufgemalt werden. An den <.v bounds="9.993217,53.582736,9.995991,53.584201" lon={9.993882} lat={53.583199} dir="forward" ref={@ref}>Bushaltestellen</.v> ist in Fahrtrichtung Alster eine Vorbeifahrt an einem wartenden Bus möglich, wenn man in den KFZ-Verkehr ausweicht. In Richtung Westen wird der Radweg bogenförmig hinter der Wartefläche für Fahrgäste vorbeigeführt. Auf der <.v bounds="9.994388,53.583099,9.996719,53.584326" lon={9.995358} lat={53.583644} dir="forward" ref={@ref}>Streekbrücke</.v> und der <.m bounds="9.993502,53.582141,9.994504,53.58318">Heilwigstraße Richtung Süden</.m> sind kurze Abschnitte mit Radfahrstreifen geplant. Diese enden auf Höhe der nahen Straßeneinmündungen.</p>

    <p>Die <.v bounds="9.993017,53.58278,9.994599,53.583662" lon={9.993428} lat={53.583124} dir="forward" ref={@ref}>Kreuzung mit der Heilwigstraße</.v> wird zu einem kleinen Kreisverkehr umgebaut. Die Schutzstreifen enden jeweils vorher, sodass sich Rad- und KFZ-Verkehr bereits vor dem Kreisel sortieren müssen.</p>
