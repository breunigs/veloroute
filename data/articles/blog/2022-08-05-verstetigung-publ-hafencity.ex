defmodule Data.Article.Blog.VerstetigungPublHafencity do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Seit Frühjahr 2021 wurde entlang des Straßenzugs Sandtorkai/Brooktorkai ein Versuchsradweg (auch Pop-Up Bike Lane genannt) eingerichtet. In Richtung Westen wurde ab der <.v bounds="10.002357,53.545644,10.005226,53.547206" lon={10.00411} lat={53.546764} dir="forward" ref={Freizeitroute0}>Oberbaumbrücke</.v> eine KFZ-Spur zu einem <.ref>Radfahrstreifen</.ref> umdeklariert. Dieser endete auf der <.v bounds="9.980711,53.542714,9.984325,53.544812" lon={9.983275} lat={53.543716} dir="forward" ref={Freizeitroute0}>Niederbaumbrücke</.v>. In der Gegenrichtung ist schon Höhe <.v bounds="9.98522,53.542193,9.987988,53.543638" lon={9.986827} lat={53.542805} dir="backward" ref={Freizeitroute0}>Kehrwiedersteg</.v> Schluss. An vielen Stellen wird der Radfahrstreifen durch Bushaltestellen unterbrochen.</p>
    ...
    <ul>
      <li>Radfahrstreifen wird schon auf der <.v bounds="9.980547,53.543031,9.984079,53.544359" lon={9.982379} lat={53.543769} dir="backward" ref={Freizeitroute0}>Niederbaumbrücke</.v> breiter.</li>
      ...
      <li>An der Einmündung <.v bounds="9.98925,53.54262,9.99131,53.543778" lon={9.990316} lat={53.54318} dir="forward" ref={Freizeitroute0}>Auf dem Sande</.v> wird der Radfahrstreifen durchgängig; die KFZ-Rechtsabbiege-Spur entfällt.</li>
      <li>Radfurten an Einmündungen und Kreuzungen werden rot markiert. Ausnahme: <.v bounds="9.996705,53.543219,9.99926,53.545008" lon={9.997979} lat={53.544293} dir="forward" ref={Freizeitroute0}>Kreuzung mit St. Annen/Osakaallee</.v>, die erst später markiert werden soll. Dort werden auch Aufstelltaschen zum <.ref>indirekten Linksabbiegen</.ref> ergänzt.</li>
      <li>Auf kurzen Abschnitten werden Trennelemente zum KFZ-Verkehr angebracht: jeweils vor der Kreuzung St. Annen/Osakaallee in <.v bounds="9.996758,53.543458,9.999555,53.545212" lon={9.99807} lat={53.544335} dir="forward" ref={Freizeitroute0}>Fahrtrichtung West</.v> und <.v bounds="9.996758,53.543458,9.999555,53.545212" lon={9.997615} lat={53.544325} dir="forward" ref={Alltagsroute10}>Fahrtrichtung Süd</.v>. Auf der <.v bounds="9.982208,53.542403,9.984777,53.543891" lon={9.983811} lat={53.543004} dir="forward" ref={Freizeitroute0}>Wilhelminenbrücke</.v>, allerdings nur in Richtung Baumwall.</li>
    ...
    <p>Auch die gefährlichen Überleitungen an der <.v bounds="10.002357,53.545644,10.005226,53.547206" lon={10.00411} lat={53.546764} dir="forward" ref={Freizeitroute0}>Oberbaumbrücke</.v> und am <.v bounds="9.98522,53.542193,9.987988,53.543638" lon={9.986827} lat={53.542805} dir="backward" ref={Freizeitroute0}>Kehrwiedersteg</.v> bleiben. Die Probleme des <.v bounds="9.989819,53.542514,9.993633,53.543784" lon={9.991414} lat={53.543039} dir="backward" ref={Freizeitroute0}>unterdimensionierten Fußwegs</.v> ignoriert man ebenfalls.</p>
