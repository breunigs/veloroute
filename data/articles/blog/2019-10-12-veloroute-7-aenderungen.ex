defmodule Data.Article.Blog.Veloroute7Aenderungen do
  ...
  def text(assigns) do
    ~H"""
    <p>Auf der <.a ref={Alltagsroute7}>Veloroute 7</.a> hat sich vom Sommer 2018 bis Sommer 2019 nicht so viel getan – dafür gab es zum Aufnahmezeitpunkt im Juli 2019 etliche Baustellen, die die Veloroute verbessern.</p>
    ...
    <p>Als die Fotos gemacht wurden befanden sich die <.m bounds="10.095598,53.568702,10.10656,53.57523">Schimmelmannstraße</.m> (<.a ref={SchimmelmannstrasseW22}>Details</.a>) und die <.m bounds="10.144495,53.59279,10.155457,53.599318">Rahlsteder Straße</.m> (<.a ref={RahlstedterStrasse}>Details</.a>) im Umbau. Beide Maßnahmen verbessern die Situation für den Radverkehr und könnten mittlerweile abgeschlossen sein.</p>
    <p>Auf dem <.m bounds="10.01416,53.554096,10.019642,53.55736">Steindamm</.m> (<.a ref={Steindamm}>Details</.a>) soll dagegen ab dem 14. Oktober mit dem Umbau begonnen werden. Angesichts des Kopfsteinpflasters auswärts und des konfliktträchtigen Hochbordradwegs stadteinwärts ist dies sehr willkommen.</p>
