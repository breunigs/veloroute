defmodule Data.Article.Blog.Veloroute7Aenderungen do
  ...
  def text(assigns) do
    ...
    <p>Als die Fotos gemacht wurden befanden sich die <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.571966, lon: 10.101079, zoom: 16})} ref="7">Schimmelmannstraße</.m> (<.a name="2018-10-14-7-schimmelmannstrasse-w22">Details</.a>) und die <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.596054, lon: 10.149976, zoom: 16})} ref="7">Rahlsteder Straße</.m> (<.a name="2018-08-30-7-rahlstedter-strasse">Details</.a>) im Umbau. Beide Maßnahmen verbessern die Situation für den Radverkehr und könnten mittlerweile abgeschlossen sein.</p>
