defmodule Data.Article.Blog.BramfelderUndSaselerChaussee do
  ...
  def text(assigns) do
    ...
    <p>Die vorliegende Umplanung ist eine Sparvariante. Statt die Wege auf gesamter Länge dem Mindeststandard anzupassen, werden nur die schlimmsten Stellen verbessert. Somit ist das Überholen von Lastenrädern praktisch nur an Ampeln oder illegal über die Fußwege möglich.</p> <p>Konkret wird in Fahrtrichtung stadtauswärts die Engstelle zwischen <.m bounds={to_string(Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.623306, lon: 10.084142, zoom: 18}))}>Nüßlerkamp und der Königsberger Straße</.m> entschärft. Dort halten die Busse künftig direkt auf der Straße statt in einer Busbucht. Somit entsteht genug Platz um den Fahrradweg hinter dem Einstiegsbereich fortführen zu können.</p>
    <p>In der Saseler Chaussee, ebenfalls stadtauswärts, werden <.m bounds={to_string(Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.63846, lon: 10.094112, zoom: 17}))}>zwei weitere Engstellen</.m> entschärft. Man fällt (und ersetzt) hier einige Bäume bzw. entfernt einige Parkplätze um einen durchgehenden Radweg zu ermöglichen.</p>
    <p>Die vorliegende Planung verbessert in der Tat die Situation an den schlimmsten Engstellen. Im Umkehrschluss heißt dies aber auch, das etliche Engstellen verbleiben, die den Komfort sowohl für Rad- als auch für Fußverkehr erheblich einschränken. Hinzu kommt die zu geringe Breite auf fast gesamter Länge. Besonders fragwürdig ist etwa warum die <.m bounds={to_string(Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.623202, lon: 10.08389, zoom: 18}))}>Bushaltestelle Königsberger Straße</.m> nur stadtauswärts verbessert wird, wenn in Gegenrichtung exakt die gleiche Problematik herrscht. Sogar die Lösung, das der Bus auf der Straße statt in einer Busbucht hält würde hier Linderung verschaffen. Insgesamt kann ich aufgrund dieser homöopathischen Verbesserung nur den Kopf schütteln.</p>
