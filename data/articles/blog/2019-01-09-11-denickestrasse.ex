defmodule Data.Article.Blog.Denickestrasse do
  ...
  def text(assigns) do
    ~H"""
    <p><strong>Stand Herbst 2021:</strong> Die Denickestraße wurde zwischen <.v bounds="9.965637,53.459847,9.971527,53.462105" lon={9.968171} lat={53.460898} dir="forward" ref="11">Uni</.v> und der <.v bounds="9.954329,53.458338,9.95959,53.461127" lon={9.957227} lat={53.459496} dir="forward" ref="11">Ampel an der Weusthoffstraße</.v> bereits umgebaut. Die anderen Abschnitte sollen 2022 folgen.</p>
