defmodule Data.Article.Blog.NeuerJungfernstieg do
  ...
  def links(_assigns) do
    [
      ...
      {"Ausschreibung Umbau", "Mai 2024",
       "https://web.archive.org/web/20240519051034/https://fbhh-evergabe.web.hamburg.de/evergabe.bieter/api/external/deeplink/subproject/5042dadf-7efd-4ef9-981d-5127a1c12775"},
  ...
  def text(assigns) do
    ...
    <p>Die Fahrbahn wird auf 5,0m verkleinert und auf Tempo-25 limitiert. Sie wird größtenteils zu einer KFZ-Einbahnstraße <.v bounds="9.985722,53.552819,9.99446,53.557041" lon={9.991484} lat={53.555256} dir="backward" ref={Alltagsroute4} highlight="Gänsemarkt" >Richtung Gänsemarkt</.v>. Zwischen <.v bounds="9.989475,53.553895,9.994126,53.55735" lon={9.991088} lat={53.554506} dir="forward" ref={Alltagsroute4}>Colonnaden</.v> und <.v bounds="9.989475,53.553895,9.994126,53.55735" lon={9.992136} lat={53.555928} dir="forward" ref={Alltagsroute4} highlight="Große Theaterstraße">Großer Theaterstraße</.v> sieht man davon ab – eine Sonderlösung für das Hotel. Die Einfahrt vom <.v bounds="9.988859,53.552621,9.995434,53.556455" lon={9.991505} lat={53.554039} dir="forward" ref={Alltagsroute4}>Jungfernstieg</.v> ist für KFZ nicht möglich, sodass trotzdem mit wenig KFZ-Verkehr in Richtung Außenalster zu rechnen ist.</p>
