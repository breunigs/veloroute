defmodule Data.Article.Blog.GeorgWilhelmStrasse do
  ...
  def stop(), do: ~d[2026-10-20]
  def construction_site_id_hh(), do: [13785, 292_964, 303_875, 477_228, 967_714, 3_564_895]
  ...
  def text(assigns) do
    ...
    <p>Für geübte Alltagsradler ist der Umbau sicher vertretbar, für eine Freizeitroute aber völlig unangebracht. Es empfiehlt sich in diesem Bereich stattdessen weiter die <.a ref={Alltagsroute11}>Alltagsroute 11</.a> zu nutzen.</p>
