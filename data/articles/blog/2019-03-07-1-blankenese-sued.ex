defmodule Data.Article.Blog.BlankeneseSued do
  ...
  def text(assigns) do
    ...
    <p>Die Kreuzung <.m bounds="9.822446,53.559947,9.824702,53.561281" lon={9.824048} lat={53.560619} dir="forward" ref="1">Elbchaussee / Manteuffelstraße / Mühlenberg</.m> wurde mit einem anderen Konzept abermals neu geplant. Der Artikel wurde entsprechend angepasst.</p>
    ...
    <p>Die <.m bounds="9.833793,53.559164,9.835725,53.56012" lon={9.835165} lat={53.559551} dir="forward" ref="1">Kreuzung Manteuffelstraße / Eichendorffstraße / Humannstraße</.m> ist eine abknickende Vorfahrt, allerdings nicht entlang der Veloroute. Richtung Innenstadt ist die Sicht etwas schwierig, sodass man sich im Kurvenbereich vorsichtig vortasten muss.</p>
    ...
    <p>Die <.m bounds="9.822446,53.559947,9.824702,53.561281" lon={9.824048} lat={53.560619} dir="forward" ref="1">Kreuzung mit der Elbchaussee</.m> erhält ein für Hamburg neues Konzept:</p>
    <ul>
