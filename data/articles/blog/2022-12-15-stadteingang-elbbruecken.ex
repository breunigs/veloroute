defmodule Data.Article.Blog.StadteingangElbbruecken do
  ...
  def links(_assigns) do
    [
      {"Visualisierungen des umgebauten Gebiets", "https://public.skyfish.com/p/fhh/1982080"},
