defmodule Data.Article.Blog.FuhlsbuettelerStrasseNord do
  ...
  def text(assigns) do
    ...
    <p>Der überarbeitete zweite Entwurf wurde veröffentlicht, der den bisherigen Planungsansatz beibehält. Weil die Bäume <.v bounds="10.029264,53.623964,10.033373,53.626827" lon={10.031659} lat={53.625762} dir="backward" ref={RSWBadBramstedt}>in Kreuzungsmitte</.v> bei einer anderen Maßnahme doch nicht gefällt werden, wurden die Radwege angepasst. Dadurch wird die Grünphase entlang der Radroute Plus etwas kürzer.</p>

    <h4>Alter Zustand</h4>
    <p>Es sind beidseitig <.ref>Hochbordradwege</.ref> mit 0,9m bis 1,6m Breite vorhanden. Sie dürfen nur in die jeweilige Fahrtrichtung benutzt werden. Da es aus <.v bounds="10.031278,53.622745,10.033678,53.624605" lon={10.032132} lat={53.624146} dir="backward" ref={BrNordN3}>Im Grünen Grunde</.v> keine Querungsmöglichkeit gibt, sind weite Umwege notwendig um von dort die <.v bounds="10.027526,53.624366,10.034867,53.628629" lon={10.031664} lat={53.625934} dir="forward" ref={BrNordN8}>Wellingsbütteler Landstraße</.v> zu erreichen. Ohne Ortskenntnis sind diese nicht auffindbar.</p>

    <p>Die <.v bounds="10.029213,53.625077,10.032514,53.626844" lon={10.031201} lat={53.626111} dir="backward" ref={BrNordN8}>Ampeln an der Einmündung Wellingsbütteler Landstraße</.v> sind nicht auf den Radverkehr abgestimmt. Es entstehen lange Wartezeiten, was wegen der fehlenden Aufstellflächen zu Rückstau auf die Gehwege führt.</p>

    <.h4_planning ref={@ref} checked={@show_map_image}/>
    <p>Auf der <.v bounds="10.030825,53.623483,10.032536,53.626098" lon={10.0318} lat={53.625235} dir="backward" ref={BrNordN8} highlight="Fuhlsbüttler Straße">Westseite der Fuhlsbüttler Straße</.v> soll ein Zweirichtungsradweg entstehen. Er verbindet <.v bounds="10.030825,53.623483,10.032536,53.626098" lon={10.031909} lat={53.623691} dir="backward" ref={BrNordN8}>Im Grünen Grunde</.v> mit dem <.a ref={WellingsbuettelerLandstrasse}>geplanten Zweirichtungsradweg in der Wellingsbütteler Landstraße</.a>. Er wird 3,25m bis 4,10m breit.</p>
    ...
    <p>Die <.v bounds="10.02919,53.624783,10.033154,53.627263" lon={10.031696} lat={53.625842} dir="forward" ref={BrNordN8} highlight="Wellingsbütteler Landstraße">Einmündung Wellingsbütteler Landstraße</.v> wird komplett umgestaltet, um die beiden Zweirichtungsradwege verbinden zu können. Die <.v bounds="10.029806,53.625097,10.032701,53.626927" lon={10.03116} lat={53.626109} dir="backward" ref={BrNordN8}>Furt im nördlichen Teil</.v> wird dafür 4,0m breit und erlaubt das Queren ohne auf der Mittelinsel anzuhalten. Die Radfurt hat eine eigene Ampelphase, sodass unaufmerksame Rechtsabbieger aus der Wellingsbütteler Landstraße keine Gefahr darstellen.</p>

    <p>Da der Radwegstummel auf der <.v bounds="10.03039,53.625142,10.032839,53.627114" lon={10.031661} lat={53.6259} dir="forward" ref={BrNordN8} highlight="Wellingsbütteler Landstraße">Südseite der Wellingsbütteler Landstraße</.v> entfällt, wird auf der Südseite der Kreuzung auch keine Querungsmöglichkeit für den Radverkehr mehr vorgesehen.</p>

    <p>Die <.v bounds="10.030502,53.623319,10.032979,53.62663" lon={10.032134} lat={53.625297} dir="forward" ref={BrNordN3} highlight="Fuhlsbüttler Straße">Ostseite der Fuhlsbüttler Straße</.v> wird nicht umgestaltet.</p>
