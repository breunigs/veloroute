defmodule Data.Article.Blog.KreuzungNeuerJungfernstieg do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Der „Doppelknoten“ besteht <.v bounds="9.992341,53.556692,9.994695,53.558311" lon={9.992984} lat={53.557079} dir="forward" ref={Alltagsroute4}>im Süden</.v> aus der Kreuzung Neuer Jungerfernstieg, Esplanade, Lombardsbrücke und <.v bounds="9.992815,53.557739,9.995264,53.559274" lon={9.993889} lat={53.558475} dir="forward" ref={Alltagsroute4}>im Norden</.v> aus der Kreuzung Alsterglacis, Warburgstraße, Alsterufer, Kennedybrücke.</p>

    <p>Der Radverkehr findet meist auf <.ref>Hochbordradwegen</.ref> statt. Ausnahmen sind in Fahrtrichtung Jungfernstieg <.v bounds="9.992815,53.557739,9.995264,53.559274" lon={9.994798} lat={53.559064} dir="backward" ref={Alltagsroute4}>Alsterufer</.v> und <.v bounds="9.992341,53.556692,9.994695,53.558311" lon={9.99298} lat={53.55735} dir="backward" ref={Alltagsroute4}>Neuer Jungfernstieg</.v>, wo im <.ref>Mischverkehr</.ref> gefahren werden muss.</p>

    <h4>Veraltete Pläne von 2019</h4>
    <p>Bereits 2019 wurden Pläne für einen Gesamtumbau der Kreuzung vorgestellt. Diese sollten ursprünglich 2020-2022 umgesetzt werden, aber das Zeitfenster verstrich. Momentan wird die Bahnbrücke am <.v bounds="9.997788,53.554357,10.005164,53.557432" lon={10.000818} lat={53.555599} dir="forward" ref={Alltagsroute6}>Ferdinandstor</.v> erneuert. Um KFZ- und Busverkehr nicht zu stark zu beeinträchtigen, ist daher ist ein Vollumbau des Doppelknotes frühestens ab 2025 möglich.</p>
    ...
    <ul>
      ...
      <li><.v bounds="9.992815,53.557739,9.995264,53.559274" lon={9.994755} lat={53.559033} dir="backward" ref={Alltagsroute4}>Alsterufer</.v> → <.v bounds="9.992341,53.556692,9.994695,53.558311" lon={9.992956} lat={53.557327} dir="backward" ref={Alltagsroute4}>Neuer Jungfernstieg</.v>: sinngemäß wird eine der zwei KFZ-Spuren in eine Radspur umgewandelt. Teilweise sind Trennelemente zum KFZ-Verkehr vorgesehen. Unter der Brücke bleibt es jedoch beim alten Hochbordradweg, der künftig aber nur in Richtung Süden befahren werden darf. Entlang dieser Strecke gibt es nur noch zwei Ampeln: je eine vor der nördlichen und der südlichen Kreuzung.</li>
      <li><.v bounds="9.992341,53.556692,9.994695,53.558311" lon={9.992984} lat={53.557079} dir="forward" ref={Alltagsroute4}>Neuer Jungfernstieg</.v> → <.v bounds="9.992815,53.557739,9.995264,53.559274" lon={9.994767} lat={53.558858} dir="forward" ref={Alltagsroute4}>Alsterufer</.v>: diagonal über die Kreuzung erreicht man die freistehende Verkehrsinsel an der westlichen Röhre. Von hier quert man die KFZ-Linksabbieger Richtung HBF, fährt dann direkt links neben dem Brückenpfeiler weiter. Dazu wird auf der bisher ungenutzen Fläche ein <.ref>Hochbordradweg</.ref> angelegt. Die nördliche Kreuzung quert man wieder diagonal. Entlang dieser Strecke sind drei Ampeln zu beachten: vor der südlichen Kreuzung, dann auf der freistehenden Verkehrsinsel und nochmal eine vor der nördlichen Kreuzung.</li>
    </ul>
