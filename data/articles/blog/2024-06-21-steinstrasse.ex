defmodule Data.Article.Blog.Steinstrasse do
  ...
  def links(_assigns) do
    [
      {"Baustelleninfo", ~d[2026-08],
       "https://lsbg.hamburg.de/resource/blob/1210254/ceb8ef9e129a0d144db1b897452984e5/steinstrasse-baustelleninfo-augustu-2026-data.pdf"},
  ...
  def text(assigns) do
    ...
    <p>Vor einigen Jahren war die Steinstraße auch für private KFZ freigegeben. Dies wurde zusammen mit der <.a ref={Moenckebergstrasse}>Modernisierung der U-Bahn Haltestelle Mönckebergstraße</.a> provisorisch geändert.</p>
