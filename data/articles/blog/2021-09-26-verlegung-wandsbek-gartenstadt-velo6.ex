defmodule Data.Article.Blog.VerlegungWandsbekGartenstadtVelo6 do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alte Führung</h4> <p>Stadteinwärts verlief die Veloroute zunächst geradeaus über die <.m bounds="10.07543,53.591694,10.093202,53.595956">Pillauer Straße</.m>. Am Bahnhof Wandsbek-Gartenstadt knickte sie über die <.m bounds="10.073877,53.588152,10.0782,53.592414">Allensteiner Straße</.m> nach Süden ab um zum <.v bounds="10.071772,53.584335,10.077073,53.589563" lon={10.075085} lat={53.588433} dir="backward" ref={@ref}>Eulenkamp</.v> zu kommen.</p>
    <h4>Neue Führung</h4> <p>Der Verlauf stadteinwärts ist nun identisch mit der Strecke stadtauswärts. Man biegt in die Straße „<.v bounds="10.096419,53.593041,10.098877,53.597624" lon={10.097964} lat={53.596384} dir="backward" ref={@ref}>Am Stadtrand</.v>“ ein und nutzt den Kreisel um in die <.v bounds="10.075208,53.588707,10.098934,53.594298" lon={10.097089} lat={53.593375} dir="backward" ref={@ref}>Tilsiter Straße</.v> zu kommen. Dieser folgt man bis zum Eulenkamp. Stadtauswärts gab es entsprechend keine Veränderung.</p>
