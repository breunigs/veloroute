defmodule Data.Article.Blog.LudwigRosenbergRing do
  ...
  def text(assigns) do
    ...
    <h4>Planung</h4>
    <p>Ab dem Zebrastreifen an der <.v bounds="10.206869,53.491928,10.210407,53.494994" lon={10.208428} lat={53.494394} dir="forward" ref={Alltagsroute8}>Walter-Freitag-Straße</.v> sollen 2,25m breite <.ref>Kopenhagener Radwege</.ref> eingerichtet werden. Zur Fahrbahn mit 8cm Höhenunterschied, zum Gehweg mit 3cm. Die Radwege sollen asphaltiert werden. An der Einmündung <.v bounds="10.206869,53.491928,10.210407,53.494994" lon={10.208811} lat={53.4932} dir="forward" ref={Alltagsroute8}>Sander Markt</.v> werden sie auf die vorhandenen Radwege übergeleitet.</p>

    <p><.v bounds="10.206869,53.491928,10.210407,53.494994" lon={10.209081} lat={53.493983} dir="backward" ref={Alltagsroute8}>Höhe Hausnummer 5</.v> verbleibt der Radweg Richtung <.v bounds="10.206869,53.491928,10.210407,53.494994" lon={10.208941} lat={53.4942} dir="backward" ref={Alltagsroute8}>Lohbrügger Markt</.v> hinter den KFZ-Parkplätzen, wo 50cm Sicherheitsabstand gegen <.ref>Dooring</.ref> vorgesehen sind. Die Gehwege werden ebenfalls breiter.</p>

    <h4>Meinung</h4>
    <p>Schön, dass wenigstens auf einem Teilstück ordentliche Radwege geschaffen werden. Frech, dass man die untermaßigen Radwege <.v bounds="10.206869,53.491928,10.210407,53.494994" lon={10.208466} lat={53.492699} dir="forward" ref={Alltagsroute8}>im weiteren Verlauf der Straße</.v> ignoriert.</p>

    <p>Besonders dreist: die Behörden finden diese Engstelle sogar gut, da der Radverkehr verlangsamt würde und sich daher die Sicherheit an der <.v bounds="10.206869,53.491928,10.210407,53.494994" lon={10.208381} lat={53.492361} dir="backward" ref={Alltagsroute8}>Bushaltestelle Sander Markt</.v> verbessere. Auf die Idee den Bus auf der 3,25m breiten Fahrbahn halten zu lassen und Fahrgästen, Radfahrern und Fußgängern mehr als die Reste zu geben kommt man nicht.</p>
