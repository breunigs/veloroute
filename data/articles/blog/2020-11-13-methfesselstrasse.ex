defmodule Data.Article.Blog.Methfesselstrasse do
  ...
  def name(), do: "#{created_at()}-methfesselstrasse"
  ...
  def text(assigns) do
    ...
    <h4>Quelle</h4> <p><.a href="https://sitzungsdienst-eimsbuettel.hamburg.de/bi/vo020.asp?VOLFDNR=1006045">Erläuterungsbericht und Pläne</.a></p>
    """
  end
end
