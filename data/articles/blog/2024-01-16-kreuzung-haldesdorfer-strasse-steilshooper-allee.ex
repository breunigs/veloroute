defmodule Data.Article.Blog.KreuzungHaldesdorferStrasseSteilshooperAllee do
  ...
  def text(assigns) do
    ...
    <p>In der <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.090275} lat={53.607411} dir="forward" ref={BrWandsbekW5}>Steilshooper Allee</.v> sind 2,0m breite Hochbordradwege geplant, die nur in die jeweilige Fahrtrichtung befahren werden dürfen. Sie sollen wieder gepflastert werden. Ausnahme: von Steilshoop kommend soll der Radweg <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.088473} lat={53.60742}dir="backward" ref={BrWandsbekW5}>kurz vor der Kreuzung</.v> als 2,5m breiter <.ref>Kopenhagener Radweg</.ref> geführt werden.</p>

    <p>In der bereits umgebauten Haldesdorfer Straße soll <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.089276} lat={53.60736} dir="backward" ref={BrWandsbekW2} highlight="Haldesdorfer Straße">die Querungsfurt</.v> künftig direkt in den <.ref>Radfahrstreifen</.ref> übergehen. <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.089103} lat={53.606943} dir="forward" ref={BrWandsbekW2} highlight="Haldesdorfer Straße">Aus der Haldesdorfer Straße kommend</.v> wird man kurz vorher auf den Hochbordradweg aufgeleitet. Rechts abbiegen ist dann ohne an der Ampel zu warten möglich.</p>

    <p>Für die Fahrt entlang der <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.087721} lat={53.607743} dir="forward" ref={Freizeitroute11}>Freizeitroute 11 im Uhrzeigersinn</.v> ist <.ref>indirektes Linksabbiegen</.ref> an der Kreuzung vorgesehen. Man muss also entweder zwei Mal auf Grün warten, oder über die östliche Furt schieben. Da der nördliche Radweg ein Einrichtungsradweg bleibt, beginnt die Schiebestrecke bereits am <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.088165} lat={53.60763} dir="forward" ref={Freizeitroute11}>Ende der Grünfläche</.v>. Die Fahrt <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.089358} lat={53.607493} dir="backward" ref={Freizeitroute11}>gegen den Uhrzeigersinn</.v> ist dagegen ohne Absteigen möglich.</p>

    <p>Die Radwege verlaufen stets rechts der Wartefläche für Fahrgäste. Auf <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.089925} lat={53.607247} dir="backward" ref={BrWandsbekW5}>der Südseite</.v> verläuft er damit zwischen Wartefläche und Gehweg. Auf <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.090216} lat={53.607413} dir="forward" ref={BrWandsbekW5}>der Nordseite</.v> werden Rad- und Gehweg getauscht. Zu Fuß muss der Radweg damit zwei Mal gequert werden, wenn man nicht zum Bus will.</p>

    <p>Die vorgeschlagene <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.089283} lat={53.607183} dir="forward" ref={BrWandsbekW2}>Führung der Bezirksroute W2</.v> wurde erst nach Beginn dieser Planung festgelegt. Sie ist daher nicht berücksichtigt.</p>

    <p>Die Bushaltestellen werden vergrößert und barrierefrei. In Richtung Steilshoop ist dazu auch ein <.v bounds="10.085991,53.605429,10.096415,53.608972" lon={10.091209} lat={53.60729} dir="forward" ref={BrWandsbekW5}>kurzes Stück Busspur</.v> geplant.</p>
    ...
    <p>Die vorgeschlagene Führung der <.a ref={BrWandsbekW2}>Bezirksroute W2</.a> lässt sich mit diesem Umbau nicht mehr umsetzen. Sie muss wahrscheinlich verlegt werden.</p>
