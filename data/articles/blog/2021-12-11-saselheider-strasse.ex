defmodule Data.Article.Blog.SaselheiderStrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Sachverhalt</h4>
    <p>2021 wurde <.v bounds="10.135077,53.634305,10.137988,53.636035" lon={10.13611} lat={53.63489} dir="forward" ref={Alltagsroute6}>Beim Farenland</.v> eine Ampel eingerichtet, um die Querungsmöglichkeiten für Fuß- und Radverkehr zu verbessern (<.a ref={BeimFarenland}>Artikel</.a>). Seitdem berichten Ortsansässige von einer starken Zunahme des KFZ-Durchgangsverkehr, insbesondere auch von KFZ mit auswärtigem Kennzeichen. Sie bemängeln weiter, dass Viele sich nicht an die Verkehrsregeln halten und rasen oder Radfahrende abdrängen. Zudem befürchten die Betroffenen, dass ein geplanter Kreisverkehr am <.m bounds="10.134064,53.63707,10.135764,53.63814">Meiendorfer Mühlenweg</.m> die Situation verschlimmern könnte.</p>
