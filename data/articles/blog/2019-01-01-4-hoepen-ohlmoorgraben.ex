defmodule Data.Article.Blog.HoepenOhlmoorgraben do
  ...
  def text(assigns) do
    ...
    <p><.a href="https://sitzungsdienst-hamburg-nord.hamburg.de/bi/vo020.asp?VOLFDNR=1009931">Erläuterungsbericht und Pläne des finalen Entwurfs</.a> (unter Anlagen)</p>
    """
  end
end
