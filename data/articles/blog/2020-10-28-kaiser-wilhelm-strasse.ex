defmodule Data.Article.Blog.KaiserWilhelmStrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Bestand</h4> <p>Der Radverkehr wird an dieser Stelle im Mischverkehr mit den KFZ geführt. Richtung St. Pauli gibt es nach der Baustelle des Axel-Springer-Quartiers eine Möglichkeit auf den alten, schmalen Hochbordradweg aufzufahren.</p>
