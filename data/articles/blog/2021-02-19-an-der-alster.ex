defmodule Data.Article.Blog.AnDerAlster do
  ...
  def links(_assigns) do
    [
      ...
      {"Vorabmaßnahme – Plan", "Juli 2022",
       "https://lsbg.hamburg.de/resource/blob/782712/41985e3f6d7c4e0f685d483aa7493b83/alster-fahrradachsen-an-der-alster-vorwegmassnahme-abgestimmte-planung-plan-data.pdf"},
      {"Vorabmaßnahme – Erläuterungsbericht", "2022",
       "https://lsbg.hamburg.de/resource/blob/782710/52637c7403c1862cd977c70daa31452f/alster-fahrradachsen-an-der-alster-vorwegmassnahme-abgestimmte-planung-bericht-data.pdf"},
  ...
  def text(assigns) do
    ...
    <h4>Planung</h4>
    <p>Die <.v bounds="10.00243,53.556592,10.004928,53.557646" lon={10.003373} lat={53.556885} dir="forward" ref={Alltagsroute5}>Nebenfahrbahn auf der man heute fährt</.v> soll in einer Vorabmaßnahme zu einer Fahrradstraße umgestaltet werden. Dazu wird die Führung auf <.v bounds="10.004046,53.557173,10.005693,53.557921" lon={10.004996} lat={53.557563} dir="forward" ref={Alltagsroute5}>Höhe der Alstertwiete</.v> so angepasst, dass KFZ eher auf die Hauptfahrbahn gelenkt werden. Zudem wird die Fahrradstraße auf gesamter Länge rot eingefärbt – erstmalig in Hamburg durch farbigen Asphalt, statt mit aufgetragenem Plastik. Die <.ref>Dooring-Zone</.ref> soll dabei klassisch schwarz bleiben, um den Gefahrenbereich zu verdeutlichen.</p>

    <p>Nach der <.v bounds="10.010244,53.559391,10.01199,53.560316" lon={10.010903} lat={53.559896} dir="forward" ref={Alltagsroute5}>Schmilinskystraße</.v> wird eine KFZ-Spur in eine <.ref>Protected-Bike-Lane</.ref> umgewandelt. Diese geht nach der <.v bounds="10.012213,53.560333,10.014309,53.561839" lon={10.013308} lat={53.560923} dir="forward" ref={Alltagsroute5}>Lohmühlenstraße</.v> in die <.a ref={HohenfelderBucht}>Planung der Hohenfelder Bucht</.a> über.</p>

    <p>Die Einmündung der <.v bounds="10.012213,53.560333,10.014309,53.561839" lon={10.013308} lat={53.560923} dir="forward" ref={Alltagsroute5}>Lohmühlenstraße</.v> wird leicht angepasst. Auf der Alsterseite werden zu Lasten einer KFZ-Spur Aufstellflächen für den Fuß- und Radverkehr geschaffen, damit diese nicht mehr <em>auf</em> dem Radweg auf Grün warten müssen. Auf der Häuserseite wird die Führung in Richtung <.m bounds="10.014369,53.558068,10.01886,53.560157">Lohmühlenpark</.m> verdeutlicht, damit der Radverkehr nicht mehr unabsichtlich geisterradelt.</p>
