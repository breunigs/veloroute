defmodule Data.Article.Blog.AnDerAlster do
  ...
  def text(assigns) do
    ...
    <h4>Vorhaben</h4>
    <p>Der Bezirk hat beschlossen, das in der Nebenstraße eine Fahrradstraße geplant werden soll. Der Stadtteilbeirat St. Georg hatte dies bereits seit langer Zeit gefordert. Der <.abbr>LSBG</.abbr> soll nun die Umsetzung planen.</p>
