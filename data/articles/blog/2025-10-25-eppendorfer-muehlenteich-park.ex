defmodule Data.Article.Blog.EppendorferMuehlenteichPark do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Man kann den Park in <.v bounds="9.984816,53.60131,9.989626,53.603193" lon={9.986399} lat={53.602265} dir="backward" ref="br-nord-n2">Richtung Salomon-Heine-Weg</.v> nur schwierig verlassen, weil eine direkte Verbindung fehlt.</p>
    ...
    <h4>Meinung</h4>
    <p>Gerade für den Alltagsverkehr ist eine Überleitung vom Park auf die Straße hilfreich. Für den Freizeitverkehr muss der Salomon-Heine-Weg aufgewertet werden, wenn man Rad- und Fußverkehr wirklich trennen will. Der <.a name="2024-05-12-neuer-jungfernstieg">Umbau des Neuen Jungernstieg</.a> könnte dabei als Vorbild dienen.</p>
