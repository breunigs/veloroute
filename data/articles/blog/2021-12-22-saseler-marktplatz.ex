defmodule Data.Article.Blog.SaselerMarktplatz do
  ...
  def text(assigns) do
    ...
    <p>Die grobe Führung bleibt gleich. Die <.v bounds="10.111461,53.652959,10.112332,53.653438" lon={10.111883} lat={53.653131} dir="backward" ref={Alltagsroute14}>Sackgasse Richtung Osten</.v> wird aber offenbar gleichberechtigt, sodass hier Rechts-vor-Links gilt. Der <.v bounds="10.110138,53.653657,10.111424,53.65413" lon={10.110259} lat={53.653776} dir="backward" ref={Alltagsroute14}>schmale Radweg an der Hauptverkehrsstraße</.v> bleibt ebenfalls bestehen.</p>
