defmodule Data.Article.Blog.Bernadottestrasse1 do
  ...
  def text(assigns) do
    ...
    <p>Die Fahrbahn soll neu asphaltiert werden. Der Radfahrstreifen wird dabei auf 1,95m verbreitert. An der Kreuzung mit der Fischers Allee wird eine <.ref ref={LexikonARAS}>Aufstellfläche vorm KFZ-Verkehr aufgemalt</.ref>. KFZ-Parken auf dieser Seite wird verboten, sodass die <.ref>Dooring-Zone</.ref> entfällt.</p>

    <p>Der Hochbordradweg entfällt ohne Ersatz – künftig muss im <.ref>Mischverkehr</.ref> gefahren werden. Der alte Radweg wird zur Verbreiterung des Gehwegs benutzt. Vor der <.v bounds="9.915938,53.547528,9.920723,53.549664" lon={9.918138} lat={53.548531} dir="forward" ref={@ref}>Kreuzung mit dem Hohenzollernring</.v> gibt es einen kurzen Radfahrstreifen. Linksabbiegen bleibt <.ref ref={LexikonDirektesUndIndirektesAbbiegen}>direkt und indirekt</.ref> möglich.</p>
