defmodule Data.Article.Blog.KreuzungGrandwegGrelckstrasse do
  ...
  def text(assigns) do
    ...
    <ul>
      <li><.v bounds="9.957951,53.598645,9.959097,53.599204" lon={9.958601} lat={53.598715} dir="forward" ref={Alltagsroute3}>Grandweg</.v>: je 1,85m breite <.ref>Radfahrstreifen</.ref>.</li>
      <li><.v bounds="9.95781,53.599145,9.95919,53.599873" lon={9.958878} lat={53.599246} dir="forward" ref={Alltagsroute3}>Behrmannplatz</.v>: Beidseitig <.ref>Schutzstreifen</.ref> mit rund 1,65m Breite.</li>
    ...
    <p>Für Markttage soll eine Umleitung über <.m bounds="9.953348,53.597249,9.959495,53.598853">Erlenstraße</.m> und <.v bounds="9.951013,53.598543,9.953348,53.601698" lon={9.951843} lat={53.600166} dir="forward" ref={Freizeitroute10}>Oddernskamp</.v> ausgeschildert werden. Diese Abschnitte werden in dieser Maßnahme aber nicht umgebaut.</p>
