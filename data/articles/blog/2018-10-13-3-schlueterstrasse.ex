defmodule Data.Article.Blog.Schlueterstrasse do
  ...
  def text(assigns) do
    ...
    <p>Bis auf den Anschluss der <.v bounds="9.984367,53.565573,9.988528,53.568126" lon={9.986502} lat={53.566116} dir="forward" ref={Alltagsroute3}>Johnsallee</.v> ist der Umbau abgeschlossen. Wann das fehlende Stück nachgeholt wird ist mir nicht bekannt.</p>
    ...
    <p>Den Fahrradstraßen wird an vielen Stellen Vorfahrt gewährt, indem man den Gehweg fortführt. Die KFZ und Radfahrende die den Gehweg queren müssen entsprechend warten. Das ist etwa so an der <.v bounds="9.984367,53.565573,9.988528,53.568126" lon={9.986477} lat={53.56759} dir="forward" ref={Alltagsroute3}>Binderstraße</.v>, der <.v bounds="9.984367,53.565573,9.988528,53.568126" lon={9.986502} lat={53.566116} dir="forward" ref={Alltagsroute3}>Johnsallee</.v> und dem Ostteil der <.m bounds="9.984625,53.570123,9.988511,53.570325">Hartungstraße</.m> so geplant. An der <.m bounds="9.985703,53.563735,9.993431,53.564192">Moorweidenstraße</.m> endet die Fahrradstraße und es gilt wieder Rechts-vor-Links. Ebenso an der <.m bounds="9.984335,53.569425,9.986319,53.569708">Bieberstraße</.m>.</p>
