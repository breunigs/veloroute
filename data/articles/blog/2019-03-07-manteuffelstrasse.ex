defmodule Data.Article.Blog.Manteuffelstrasse do
  ...
  def text(assigns) do
    ...
    <h4>Alter Zustand</h4>
    <p>Die <.v bounds="9.833793,53.559164,9.835725,53.56012" lon={9.835165} lat={53.559551} dir="forward" ref={Alltagsroute1}>Kreuzung Manteuffelstraße / Eichendorffstraße / Humannstraße</.v> ist eine abknickende Vorfahrt, allerdings nicht entlang der Radroute. Richtung Innenstadt ist die Sicht etwas schwierig, sodass man sich im Kurvenbereich vorsichtig vortasten muss.</p>

    <p>Der Bereich um die <.v bounds="9.83056,53.559676,9.833336,53.560952" lon={9.833013} lat={53.560049} dir="forward" ref={Alltagsroute1}>Bushaltestellen Stauffenbergstraße</.v> ist für den Radverkehr nichts besonderes. Die Busbuchten erlauben auch ein Vorbeifahren bei wartenden Bussen.</p>

    <p>Selbiges gilt für die Kurve bzw. Bushaltestellen <.v bounds="9.826129,53.56068,9.829138,53.561733" lon={9.82849} lat={53.561308} dir="forward" ref={Alltagsroute1}>Domizil am Hirschpark</.v>.</p>

    <h4>Planung</h4>
    <p>Die Humannstraße und Manteuffelstraße sollen zu einer Fahrradstraße werden, die auch an der <.v bounds="9.833793,53.559164,9.835725,53.56012" lon={9.835165} lat={53.559551} dir="forward" ref={Alltagsroute1}>Kreuzung Manteuffelstraße / Eichendorffstraße / Humannstraße</.v> Vorfahrt erhält. Zusätzlich soll die <.v bounds="9.832976,53.558218,9.840328,53.560574" lon={9.835883} lat={53.559371} dir="forward" ref={Alltagsroute1}>Humannstraße</.v> im Abschnitt KFZ-Einbahnstraße Richtung Blankenese werden.</p>

    <p>Die Einmündungen anderer Straßen werden ebenfalls so umgebaut, dass die Fahrradstraße Vorrang erhält. Die Busbuchten der Haltestellen <.v bounds="9.83056,53.559676,9.833336,53.560952" lon={9.833013} lat={53.560049} dir="forward" ref={Alltagsroute1}>Stauffenbergstraße</.v> und <.v bounds="9.826129,53.56068,9.829138,53.561733" lon={9.82849} lat={53.561308} dir="forward" ref={Alltagsroute1}>Domizil am Hirschpark</.v> entfallen, sodass der Radverkehr an haltenden Bussen über die Gegenspur vorbeifahren kann bzw. muss.</p>
