defmodule Data.Article.Blog.Elbgaustrasse do
  ...
  def name(), do: "#{created_at()}-elbgaustrasse"
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Die Veloroute wird meist auf <.ref>Hochbordradwegen</.ref> geführt. Sie sind unterschiedlich breit und zwischen <.m bounds="9.86729,53.590468,9.889278,53.595495" lon="9.881915" lat="53.5924746" dir="forward">1,50m</.m> und <.m bounds="9.879594,53.600217,9.901582,53.605243" lon="9.8920342" lat="53.6029526" dir="forward">70 cm</.m> ist alles dabei. Die Radwege werden durch <.m bounds="9.879594,53.600217,9.901582,53.605243" lon="9.8927414" lat="53.6034238" dir="backward">Bushaltestellen geführt</.m>, vor Kreuzungen zu <.m bounds="9.871183,53.589339,9.893171,53.594367" lon="9.8823888" lat="53.59287" dir="forward">gemeinsamen Fuß- und Radwegen</.m> oder an <.m bounds="9.88384,53.602302,9.905828,53.607329" lon="9.895432" lat="53.604179" dir="forward">Engstellen zu einem „Fahrrad frei“</.m>. Altersbedingt sind die Radwege eher uneben und daher schlecht zu befahren.</p>

    <h4>Planung</h4>
    <p>Der erste Entwurf sieht von der <.m bounds="9.871325,53.587523,9.885014,53.590653" lon="9.8775202" lat="53.5894187" dir="forward">Elly-See-Straße</.m> bis <.m bounds="9.885822,53.600751,9.89364,53.602538" lon="9.8900402" lat="53.601743" dir="forward">kurz vor den Eisenbahnbrücken</.m> durchgehende, 2,0m breite <.ref>Hochbordradwege</.ref> vor (LSBG Lagepläne 1 bis 5).</p>
    ...
    <p><strong><.m bounds="9.875161,53.591657,9.889322,53.594896" lon="9.8828454" lat="53.5937188" dir="backward">Kreuzung Farnhornweg</.m>:</strong> Die Radwege verlaufen nun hinter den Bushaltestellen, sodass man beim Ein-/Aussteigen nicht sofort auf dem Radweg steht. Der <.m bounds="9.875161,53.591657,9.889322,53.594896" lon="9.8828463" lat="53.5932706" dir="forward">freie Rechtsabbieger</.m> aus dem Farnhornweg bleibt teilweise erhalten, wird aber mit einer Ampel gesichert. Für Radfahrende, die die Veloroute hier nur queren bedeutet dieser eine deutliche Schikane. Linksabbiegen ist meist <.ref>indirekt</.ref> möglich; Ausnahme bildet der Lüttkamp der auch <.ref>direktes</.ref> Abbiegen erlaubt. (LSBG Lageplan 2).</p>

    <p><strong><.m bounds="9.873897,53.596214,9.896794,53.601449" lon="9.8870968" lat="53.5988063" dir="forward">Kreuzung Langbargheide</.m>:</strong> Auch hier wird der Radweg hinter den Bushaltestellen geführt, die Querung der Nebenstraßen erfolgt geradlinig. Von der Veloroute weg steht indirektes Linksabbiegen zur Verfügung, aus den Nebenstraßen nur Direktes. (LSBG Lageplan 4).</p>

    <p><strong><.m bounds="9.886982,53.600127,9.892587,53.602508" lon="9.8899406" lat="53.6016387" dir="forward">Querung Radschnellweg</.m>:</strong> Als Vorleistung für den <.a href="/rsw-elmshorn">Radschnellweg Elmshorn</.a> verbreitern sich die Radwege teilweise auf 3,0m bis 4,0m und es werden zusätzliche Querungsmöglichkeiten der Elbgaustraße angeboten. Die genaue Führung ist noch nicht bekannt. (LSBG Lageplan 5).</p>

    <p><strong><.m bounds="9.889175,53.602158,9.899717,53.604568" lon="9.8926452" lat="53.6033872" dir="backward">Bushaltestellen S-Elbgaustraße</.m>:</strong> Anders als bisher wird der Radverkehr hier auf einem <.ref>Radfahrstreifen</.ref> links der Bushaltestelle geführt. (LSBG Lageplan 5).</p>
