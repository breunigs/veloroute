defmodule Data.Article.Blog.ZOBHarburg do
  ...
  def text(assigns) do
    ...
    <p>Dem Radverkehr machen die Ampelschaltungen zu schaffen. Die Fahrt entlang der <.a name="alltagsroute-11">Alltagsroute 11</.a> von der <.m bounds="9.986975,53.456788,9.988792,53.457455" lon={9.987975} lat={53.457055} dir="backward" ref="11">Moorstraße</.m> auf die <.m bounds="9.988803,53.457817,9.990229,53.458536" lon={9.989208} lat={53.457934} dir="backward" ref="11">Hannoversche Brücke</.m> dauert knapp zwei Minuten, für nur rund 150m. Die Radwege selbst sind <.ref>Hochbordradwege</.ref>, aber ein Großteil der Wege besteht aus den langen Querungsfurten.</p>
    <p>Am Busbahnhof wiederum fehlen Busstiege um die hohe Anzahl der hier haltenden Busse abfertigen zu können.</p>

    <p>In Richtung Schlachthofbrücke gibt es meist <.ref>Hochbordradwege</.ref>, die teils für beide Richtungen freigegeben sind. Ausnahme: <.m bounds="9.987512,53.454469,9.992079,53.457617" lon={9.990594} lat={53.455038} dir="backward" ref="rsw-tostedt">vor dem Busbahnhof und Zugbahnhof </.m> gibt es nur einen geteilten Rad- und Fußweg auf der Stadtseite. Der Radweg auf Bahnseite endet vor dem Bahnhof.</p>

    <h4>Planung</h4>
    <p>Die Planung ist bereits älter und soll vor allem die Situation für den Busverkehr verbessern. Sie wurde in zwei Abschnitte aufgeteilt: von der <.m bounds="9.99062,53.453352,9.992999,53.455082" lon={9.991602} lat={53.454027} dir="forward" ref="rsw-tostedt">Brücke über den Seevekanal</.m> bis einschließlich des <.m bounds="9.988104,53.455951,9.990621,53.457435" lon={9.988852} lat={53.457105} dir="forward" ref="rsw-tostedt">Busbahnhofs</.m> ist Abschnitt 1. Diese Planung wurde bereits abgeschlossen. Die <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.98893} lat={53.45813} dir="forward" ref="11">große Kreuzung</.m> („Doppelknoten“) ist Abschnitt 2 und liegt nur als Entwurf vor, könnte also noch angepasst werden.</p>
    ...
    <p>Entlang der Veloroute 11 Richtung Harburg quert man zunächst die <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.989262} lat={53.458262} dir="forward" ref="11">KFZ-Rechtsabbieger auf der Brücke</.m>, dann die Spuren der <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.988851} lat={53.458098} dir="forward" ref="11">Buxtehuder Straße</.m>. Auf der anderen Straßenseite angekommen, ordnet man sich auf einem <.ref>Schutzstreifen</.ref> gemeinsam mit den KFZ auf der Rechtsabbieger Spur ein. In der <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.988535} lat={53.457421} dir="forward" ref="11">Moorstraße</.m> schließt wieder ein Radfahrstreifen an. In die andere Richtung <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.988293} lat={53.4571} dir="backward" ref="11">startet</.m> man von einem <.ref>Radfahrstreifen in Mittellage</.ref> und biegt dann <.ref>direkt</.ref> in einem großen Bogen nach links ab. Dann nochmal <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.989118} lat={53.457689} dir="backward" ref="11">rechts abbiegen</.m> und man folgt wie heute der <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.98941} lat={53.458059} dir="backward" ref="11">Hannoverschen Straße</.m>.</p>

    <p>Entlang des künftigen Radschnellweg nach Tostedt quert man die <.m bounds="9.987878,53.456819,9.990353,53.458594" lon={9.988851} lat={53.458098} dir="forward" ref="11">Buxtehuder Straße</.m> genau wie im vorigen Absatz beschrieben. Statt rechts in die Moorstraße abzubiegen, fährt man gerade aus auf einem Radfahrstreifen in Mittellage weiter. In der Gegenrichtung bleibt der Radfahrstreifen rechts der KFZ-Spuren.</p>
    ...
    <p>Zwischen den <.m bounds="9.98858,53.457216,9.990344,53.458257" lon={9.989153} lat={53.457595} dir="backward" ref="11">beiden Brücken und Bahngleis</.m> soll ein Fahrradparkhaus entstehen. Eine Fußampel soll das ebenerdige Queren der <.m bounds="9.988797,53.456933,9.990562,53.457975" lon={9.98914} lat={53.4575} dir="forward" ref="rsw-lueneburg">Walter-Dudek-Brücke</.m> ermöglichen.</p>
    ...
    <p>Für den Radverkehr sind 1,60m bis 2,0m breite <.ref>Radfahrstreifen</.ref> vorgesehen. An einer Engstelle sogar nur 1,50m. Bis auf ein kurzes Stück nach der großen Kreuzung auf <.m bounds="9.985416,53.455697,9.990053,53.457591" lon={9.988877} lat={53.457046} dir="forward" ref="rsw-tostedt">der Seite des Phoenix Center</.m> ist keine Trennung vom KFZ-Verkehr vorgesehen. Der Radfahrstreifen nach Norden ist dabei durchgängig bis zur <.m bounds="9.987853,53.456458,9.992908,53.457892" lon={9.990521} lat={53.457543} dir="backward" ref="rsw-lueneburg">Walter-Dudek-Brücke</.m>.</p>

    <h5>Um die Schlachthofbrücke (Abschnitt 1, Planung abgeschlossen)</h5>
    <p>In Fahrtrichtung Tostedt wird man ab <.m bounds="9.987512,53.454469,9.992079,53.457617" lon={9.990055} lat={53.455359} dir="forward" ref="rsw-tostedt">Höhe Einfahrt Bahnhof</.m> auf den vorhandenen Hochbordradweg aufgeleitet. Linksabbiegen zum Bahnhof ist nur <.ref>direkt</.ref> möglich, wer sich das nicht traut muss absteigen und über die Fußampel schieben. In der Gegenrichtung wird man vor der <.m bounds="9.987688,53.45423,9.992254,53.457378" lon={9.991322} lat={53.45444} dir="backward" ref="rsw-tostedt">Schlachthofbrücke</.m> auf den Radfahrstreifen geleitet. Die Einfahrt zum Bahnhof ist als Radfahrstreifen in Mittellage geplant.</p>
