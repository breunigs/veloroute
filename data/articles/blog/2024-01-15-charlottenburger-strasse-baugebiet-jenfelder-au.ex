defmodule Data.Article.Blog.CharlottenburgerStrasseBaugebietJenfelderAu do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Auf der <.v bounds="10.13346,53.576503,10.141326,53.582205" lon={10.137238} lat={53.579716} dir="forward" ref={Alltagsroute14}>Seite des Baugebiets (Westseite)</.v> ist ein rund 1,60m breiter Hochbordradweg mit vielen Flickstellen vorhanden. Illegal abgestellte Autos beschneiden die sicher nutzbare Breite regelmäßig.</p>

    <h4>Planung</h4>
    <p>Der Hochbordradweg soll neu gepflastert und 2,0m breit werden. Er verläuft rechts einer Baumreihe mit 19 neuen Bäumen. Dazwischen werden KFZ-Parkbuchten gebaut. Es sind 1,0m Sicherheitsabstand gegen <.ref>Dooring</.ref> vorgesehen. In der Baumreihe befindet sich auch der Wartebereich für Busfahrgäste an der <.v bounds="10.13346,53.576503,10.141326,53.582205" lon={10.13754} lat={53.580171} dir="forward" ref={Alltagsroute14}>Bushaltestelle Liegnitzer Straße</.v>, sodass der Radweg auch hier rechts vorbei führt.</p>

    <p>An einmündenden Straßen <.v bounds="10.13346,53.576503,10.141326,53.582205" lon={10.138332} lat={53.581363} dir="forward" ref={Alltagsroute14}>Kurt-Oldenburg-Straße</.v>, <.v bounds="10.13346,53.576503,10.141326,53.582205" lon={10.137713} lat={53.580605} dir="forward" ref={Alltagsroute14}>Kaskadenpark</.v> und <.v bounds="10.13346,53.576503,10.141326,53.582205" lon={10.136593} lat={53.578362} dir="forward" ref={Alltagsroute14}>Zur Jenfelder Au</.v> wird der Radweg jeweils unterbrochen, hat aber trotzdem Vorfahrt.</p>
