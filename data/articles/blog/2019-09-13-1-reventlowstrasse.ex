defmodule Data.Article.Blog.Reventlowstrasse do
  ...
  def text(assigns) do
    ...
    <p>Im <.m bounds="9.889674,53.551792,9.891431,53.552459">Halbmondsweg</.m> schließt sich in Richtung Süden ein 1,5m breiter Schutzstreifen-Stummel an, der an der Bushaltestelle endet. In Gegenrichtung gibt es zur Ampel hin einen <.ref>Radfahrstreifen</.ref>. In Nord-Süd-Richtung sind Aufstelltaschen in der Kreuzung zum <.ref>indirekten Abbiegen</.ref> vorgesehen. Linksabbiegen ist in Ost-West-Richtung über Aufstellflächen vor den KFZ nur <.ref>direkt</.ref> möglich.</p>
