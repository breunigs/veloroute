defmodule Data.Article.Blog.Reventlowstrasse do
  ...
  def text(assigns) do
    ~H"""
    <p><strong>Stand August 2022:</strong> Die Planung wurde angepasst und soll angeblich jetzt Radwege mit „<.ref>Kopenhagener Lösung</.ref>“ verwenden. Auch soll die Führung an den Bushaltestellen angepasst worden sein. Pläne liegen leider nicht vor.</p>
