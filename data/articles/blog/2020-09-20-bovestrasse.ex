defmodule Data.Article.Blog.Bovestrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4> <p> Es gibt keine Radverkehrsführung in der Bovestraße. Wer mit dem Fahrrad unterwegs ist hat die Wahl zwischen der <.ref ref={LexikonFahrbahnUndNebenflaechen}>Fahrbahn</.ref> (viel und schneller motorisierter Verkehr) oder dem viel zu schmalen <.ref ref={LexikonFahrradFrei}>Fußweg</.ref>. Keine Variante ist attraktiv.</p>
