...
#     <h4>Meinung</h4>
#     <p>Durchgängige Radwege die man nicht suchen muss sind super. So wird die Fahrt zum Schulgarten aus Richtung Westen einfacher und man strandet nicht im Nirgendwo, wenn man sich nicht perfekt auskennt.</p>

#     <p>Leider ist der südliche Radweg nur an den Kreuzungen am Ende des Planungsgebiets erreichbar. Von der Häuserseite müssten also riesige Umwege gefahren werden, da der Radweg auf der Nordseite nicht mehr für beide Fahrtrichtungen freigegeben ist. Der Umbau verschlechtert die Situation für die Hausnummern 70 bis 86 dann sogar.</p>
