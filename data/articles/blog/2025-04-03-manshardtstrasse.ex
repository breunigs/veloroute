defmodule Data.Article.Blog.Manshardtstrasse do
  ...
  def text(assigns) do
    ...
    <p>Ab <.v bounds="10.093578,53.553437,10.103655,53.560129" lon={10.096903} lat={53.556466} dir="forward" ref={Radroute1}>Stoltenstraße</.v> bis <.v bounds="10.098199,53.554917,10.10763,53.560805" lon={10.101407} lat={53.557836} dir="forward" ref={Radroute1}>Rudolf-Roß-Allee</.v> ist ein 2,75m breiter Kopenhagener Radweg vorgesehen. Er wird ebenfalls asphaltiert, kann an den U-Bahn Eingängen aber etwas schmaler ausfallen. Mindestens stehen jedoch 2,4m zur Verfügung.</p>

    <p>Ausnahme ist die <.v bounds="10.097126,53.555831,10.101003,53.558461" lon={10.098721} lat={53.556961} dir="forward" ref={Radroute1}>Bushaltestelle Stoltenstraße</.v> auf südlicher Seite. Hier wird der Radweg unterbrochen und über die Haltefläche des Busses geführt. Wer an einem wartenden Bus vorbeifahren möchte, muss sich in den <.ref>Mischverkehr</.ref> mit den Autos begeben.</p>

    <p>An einmündenden Nebenstraßen ist der Radweg durchgängig und wird nicht abgesenkt. Ausnahme: der <.v bounds="10.100759,53.556947,10.110962,53.560661" lon={10.102253} lat={53.558096} dir="forward" ref={Radroute1}>Querkamp</.v> wird ebenerdig angebunden und daher eine Rampe auf dem Radweg notwendig.</p>

    <p>Die Kreuzungen mit <.v bounds="10.1044,53.557565,10.107462,53.559959" lon={10.105764} lat={53.558911} dir="forward" ref={Radroute1}>Legienstraße / Graßmannweg</.v> und <.v bounds="10.10541,53.55814,10.110962,53.560661" lon={10.108409} lat={53.559016} dir="forward" ref={Radroute1}>Dannerallee</.v> werden zu Kreisverkehren umgebaut. Dazwischen gibt es keine eigenen Radwege und es muss im <.ref>Mischverkehr</.ref> mit den KFZ gefahren werden. Erst danach gibt es auf der Südseite eine Rampe zum vorhandenen Hochbordradweg. In der Gegenrichtung soll dagegen ab Höhe <.v bounds="10.108491,53.555766,10.11763,53.561136" lon={10.112235} lat={53.558437} dir="backward" ref={Radroute1}>Silberberg</.v> ein Kopenhagener Radweg beginnen und hinter der Bushaltestelle vorbeiführen.</p>
