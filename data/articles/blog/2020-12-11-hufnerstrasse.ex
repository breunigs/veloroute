defmodule Data.Article.Blog.Hufnerstrasse do
  ...
  def text(assigns) do
    ...
    <ul>
      <li>Der Umbau der <.v bounds="10.042408,53.585327,10.045014,53.586763" lon={10.042758} lat={53.585529} dir="forward" ref={Alltagsroute5}>Poppenhusenstraße</.v> ist nicht mehr Teil des Umbaus. Grund: Die Behörde für Verkehr und Mobilitätswende (BVM) kann keine Zusage zur Finanzierung machen.</li>
      <li>In der <.v bounds="10.038239,53.586717,10.044288,53.588117" lon={10.041485} lat={53.5875256} dir="backward" ref={@ref}>Kreuzung mit dem Wiesendamm</.v> entfielen die trennenden Bordsteine zum KFZ-Verkehr.</li>
    </ul>

    <h4>Alter Zustand</h4>
    <p>Die Hufnerstraße ist für KFZ teils eine Einbahnstraße, jedoch ist die Fahrt für den Radverkehr in beide Richtungen möglich, da der rund 2,0m breite <.ref>Hochbordradweg</.ref> ein Zweirichtungsradweg ist. Dies ist aus dem Norden kommend nicht ersichtlich, sodass man durchaus vom Gegenverkehr überrascht wird.</p> <p>Die <.v bounds="10.037831,53.586299,10.044682,53.587885" lon={10.0412848} lat={53.5870787} dir="backward" ref={@ref}>Querung am Wiesendamm</.v> hat eine sehr schlecht abgestimmte Ampel: man muss hier praktisch immer zweimal warten.</p>
    ...
    <p>Vor der <.v bounds="10.038656,53.587428,10.044705,53.588828" lon={10.041858} lat={53.58848} dir="backward" ref={Alltagsroute5}>Eisenbahnbrücke</.v> wird der existierende Hochbordradweg auf einen 2,25m breiten Radfahrstreifen abgeleitet. Unter der Brücke wird dieser mittels der <.ref>Kopenhagener Lösung</.ref> umgesetzt. Vor der <.v bounds="10.038239,53.586717,10.044288,53.588117" lon={10.041485} lat={53.5875256} dir="backward" ref={@ref}>Kreuzung mit dem Wiesendamm</.v> hört der trennende Bordstein jedoch auf und man fährt auf einem Radfahrstreifen – auch im Kreuzungsbereich. Dennoch ist <.ref ref={LexikonDirektesUndIndirektesAbbiegen}>direktes Linksabbiegen</.ref> für den Radverkehr nicht vorgesehen, dafür bleibt man immer rechts der KFZ-Spuren. Den Wiesendamm kann man künftig in einem Zug queren oder von einer Aufstelltasche aus links abbiegen.</p>

    <p>Nach dem Wiesendamm bleibt es bis zur <.v bounds="10.038373,53.585004,10.044422,53.586404" lon={10.042175} lat={53.585316} dir="backward" ref={@ref}>Brücke</.v> beim 2,25m breiten Radfahrstreifen. Auf der Brücke gibt es einen 2,0m breiten Hochbordradweg, der kurz vor der <.v bounds="10.038373,53.585004,10.044422,53.586404" lon={10.0421226} lat={53.5854815} dir="backward" ref={@ref}>Osterbekstraße</.v> wieder auf Asphaltniveau abgeleitet wird. Dort schließt sich die <.a ref={HufnerstrasseReesestrasse}>Planung zur Hufner- und Reesestraße</.a> an.</p>
    ...
    <p><.v bounds="10.040023,53.583853,10.043741,53.58848" lon={10.042025} lat={53.584727} dir="forward" ref={Alltagsroute5}>Kurz vor der Brücke</.v> endet der Radfahrstreifen und KFZ- und Radverkehr teilen sich eine Spur. Über einen kleinen Kreisel kann der Radverkehr alle Richtungen erreichen. Die Poppenhusenstraße bleibt wie heute; man sortiert die KFZ-Parkplätze jedoch um.</p>
    ...
    <p>Das man dem Radverkehr an der <.v bounds="10.038373,53.585004,10.044422,53.586404" lon={10.0421226} lat={53.5854815} dir="backward" ref={@ref}>Poppenhusenstraße</.v> über einen Kreisel ermöglicht alle Richtungen zu erreichen ist sinnvoll. Ein Bypass in Fahrtrichtung Innenstadt ermöglicht dies sogar ohne sich in den KFZ-Verkehr einsortieren zu müssen.</p>
