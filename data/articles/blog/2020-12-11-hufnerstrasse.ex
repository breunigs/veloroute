defmodule Data.Article.Blog.Hufnerstrasse do
  ...
  def name(), do: "#{created_at()}-hufnerstrasse"
  def created_at(), do: ~D[2020-12-11]
  def updated(), do: ~D[2021-09-10]
  ...
  def text(assigns) do
    ...
    <h4>Quelle</h4> <p><.a href="https://sitzungsdienst-hamburg-nord.hamburg.de/bi/vo020.asp?VOLFDNR=1010972">Unterlagen des 2. Entwurfs</.a></p>
    """
  end
end
