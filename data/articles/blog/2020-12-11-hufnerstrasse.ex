defmodule Data.Article.Blog.Hufnerstrasse do
  ...
  def text(assigns) do
    ...
    <ul>
      <li>Der Umbau der <.v bounds="10.042408,53.585327,10.045014,53.586763" lon={10.042758} lat={53.585529} dir="forward" ref="5">Poppenhusenstraße</.v> ist nicht mehr Teil des Umbaus. Grund: Die Behörde für Verkehr und Mobilitätswende (BVM) kann keine Zusage zur Finanzierung machen.</li>
    ...
    <p><.v bounds="10.040023,53.583853,10.043741,53.58848" lon={10.042025} lat={53.584727} dir="forward" ref="5">Kurz vor der Brücke</.v> endet der Radfahrstreifen und KFZ- und Radverkehr teilen sich eine Spur. Über einen kleinen Kreisel kann der Radverkehr alle Richtungen erreichen. Die Poppenhusenstraße bleibt wie heute; man sortiert die KFZ-Parkplätze jedoch um.</p>
