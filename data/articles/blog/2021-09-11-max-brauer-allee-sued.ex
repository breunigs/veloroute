defmodule Data.Article.Blog.MaxBrauerAlleeSued do
  ...
  def text(assigns) do
    ...
    <p>Auf der <.v bounds="9.934501,53.550048,9.936544,53.550443" lon={9.934789} lat={53.550271} dir="forward" ref={Alltagsroute1}>Ottenser Seite</.v> gibt's zunächst Radfahrstreifen, die in Richtung Kreuzung jedoch zu Protected-Bike-Lanes werden. In der <.m bounds="9.936164,53.54978,9.94126,53.550453">Ehrenbergstraße</.m> wird dies nur auf der Nordseite (Fahrtrichtung Ottensen) umgesetzt, da die Südseite (Fahrtrichtung Innenstadt) zu viele KFZ-Parkplätze und Einfahrten besitzt. Stattdessen wird der Radweg hier mit 3,0m aber deutlich breiter. Abweichend zu anderen Abschnitten bleibt der Hochbordradweg auf der Nordseite zwischen <.m bounds="9.937894,53.549903,9.941129,53.550496">Altonaer Poststraße bis Schillerstraße</.m> erhalten. Auch er wird 2,0m breit.</p>
