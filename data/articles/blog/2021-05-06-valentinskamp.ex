defmodule Data.Article.Blog.Valentinskamp do
  ...
  def text(assigns) do
    ...
    <p>Am <.m bounds="9.978669,53.554734,9.982303,53.55605">Johannes-Brahms-Platz</.m> müssen Radfahrende über die KFZ-Spur links abbiegen. Geradeaus und <.ref ref={LexikonDirektesUndIndirektesAbbiegen}>indirektes Linksabbiegen</.ref> sind nicht vorgesehen.</p>
    <p>Die <.m bounds="9.982849,53.55528,9.985371,53.556091">Kreuzung mit der Caffamacherreihe</.m> wird leicht angepasst um die Fahrt Richtung Innenstadt entgegen der KFZ-Einbahnstraße zu verbessern. Zum Linksabbiegen sind teilweise breite Aufstellflächen vor den KFZ vorgesehen (<.ref>ARAS</.ref>). Wer hier bei grün ankommt muss sich hinter den Autos einordnen und erst nach ihnen abbiegen. In Richtung bergauf gibt es einen <.ref>Radfahrstreifen in Mittellage</.ref> und in der Kreuzung eine Aufstelltasche zum <.ref ref={LexikonDirektesUndIndirektesAbbiegen}>indirekten Linksabbiegen</.ref>. Der südliche Teil der Caffamacherreihe bleibt wie heute und wird nicht nochmal umgebaut.</p>
