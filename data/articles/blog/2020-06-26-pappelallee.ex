defmodule Data.Article.Blog.Pappelallee do
  ...
  def text(assigns) do
    ...
    <p>Die Führung des Radverkehrs erfolgt auf Radfahrstreifen, die mit 1,85m nur mäßig breit sind. Dafür gibt es sie beidseitig. Die <.v bounds="10.057179,53.567816,10.061663,53.568854" lon={10.0599108} lat={53.5676212} dir="forward" ref={@ref}>Querungshilfe an der Menckesallee</.v> bleibt erhalten. Um den notwendigen Platz dafür zu gewinnen werden die Fußwege schmaler und der Radfahrstreifen wird zu einem deutlich engeren Schutzstreifen. Auch die KFZ-Spuren werden um je einen halben Meter schmäler.</p>
