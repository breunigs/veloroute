defmodule Data.Article.Blog.NeubergerwegHoheLiedt do
  ...
  def text(assigns) do
    ...
    <p>Im Zuge der <.a ref={RswBadBramstedtHoheLiedtBisLangenhornerChaussee}>Planung zum Radschnellweg Bad Bramstedt</.a> soll der Neubergerweg umgebaut werden. Bitte siehe dort für Details.</p>
