defmodule Data.Article.Blog.MundsburgHartwicusstrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Der <.ref>benutzungspflichtige</.ref> <.ref>Hochbordradweg</.ref> im <.v bounds="10.019968,53.565585,10.022406,53.567002" lon={10.021025} lat={53.566328} dir="forward" ref={Alltagsroute5}>Mundsburger Damm</.v> ist 1,5m breit.</p>

    <h4>Planung</h4>
    <p>Vor dem neuen Gebäude wird der Hochbordradweg 2,5m breit. Links neben dem Radweg werden Ladezonen gebaut. Die (KFZ-) Zufahrt zur <.v bounds="10.019968,53.565585,10.022406,53.567002" lon={10.021171} lat={53.566045} dir="backward" ref={Alltagsroute6}>Hartwicusstraße</.v> wird etwas schmäler. Die Gehwege werden in beiden Straßen breiter. Hinzu kommen neue Bäume und  Fahrradbügel.</p>
