defmodule Data.Article.Blog.SaarlandstrasseNord do
  ...
  def text(assigns) do
    ...
    <p>Auf der Seite des Stadtparks fährt der Radverkehr ebenfalls meist über Hochbordradwege. Ausnahme ist ein <.a ref={FreilichtbuehneSaarlandstrasse}>bereits sanierter Abschnitt im Norden</.a>. Dort wird man auch teilweise durch den KFZ-Parkplatz im <.ref>Mischverkehr</.ref> geführt.</p>


    <.h4_planning ref={@ref} checked={@show_map_image}/>
    <h5> Ostseite</h5>
    <p>Ab der <.v bounds="10.031917,53.58829,10.034429,53.5915" lon={10.033382} lat={53.588995} dir="forward" ref={Alltagsroute5}>Bahnbrücke</.v> soll ein 2,0m breiter <.ref>Hochbordradweg</.ref> entstehen. Der Platz kommt von den KFZ-Fahrspuren und den Fußwegen, die jeweils etwas schmaler werden. Der Grünstreifen verschiebt sich dadurch leicht in Richtung Stadtpark. Nur vor der <.v bounds="10.031917,53.58829,10.034429,53.5915" lon={10.033033} lat={53.590672} dir="forward" ref={Alltagsroute5}>Hellbrookstraße</.v> ist ein kurzes Stück <.ref>Protected-Bike-Lane</.ref> vorgesehen.</p>
