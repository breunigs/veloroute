defmodule Data.Article.Blog.BarmbekerMarkt do
  ...
  def text(assigns) do
    ...
    <p>Die Fahrt entlang <.v bounds="10.037557,53.578181,10.043482,53.581993" lon={10.040184} lat={53.579431} dir="forward" ref={Radroute5}>Radroute 5 nach Norden</.v> ist sehr umständlich. In <.v bounds="10.037127,53.577426,10.04214,53.580695" lon={10.039146} lat={53.578907} dir="backward" ref={Radroute5}>Richtung Süden</.v> führt der Radweg über einen KFZ-Parkplatz. Weder der Übergang zum <.ref>Radfahrstreifen</.ref> mittendrin noch die Ausfahrt aus dem Parkplatz sind eine geradlinige Radführung.</p>
    ...
    <ul>
      <li><.v bounds="10.035832,53.579753,10.040135,53.580833" lon={10.036511} lat={53.580212} dir="forward" ref={BrNordN4}>Weidestraße</.v>: beidseitige <.ref>Radfahrstreifen</.ref> (1,75m bis 3,0m breit). Kurze Abschnitte als <.ref>Protected-Bike-Lane</.ref>. Etwas breitere Gehwege und mehr Grünflächen.</li>
      <li><.m bounds="10.040521,53.579482,10.045212,53.582593">Barmbeker Markt</.m> nach Norden: 2,75m breiter Radfahrstreifen</li>
      <li><.v bounds="10.040447,53.578404,10.045659,53.580584" lon={10.044909} lat={53.579195} dir="backward" ref={BrNordN4}>Dehnhaide</.v> nach Westen: breiterer Hochbordradweg ab ca. Bushaltestelle</li>
      <li><.v bounds="10.038475,53.578693,10.041245,53.580802" lon={10.03992} lat={53.579223} dir="forward" ref={Radroute5} highlight="Hamburger Straße">Hamburger Straße nach Norden</.v>: Der <.ref>Hochbordradweg</.ref> wird vor der Kurve auf eine Protected-Bike-Lane abgeleitet</li>
      <li><.v bounds="10.037614,53.577851,10.041334,53.580106" lon={10.039969} lat={53.579931} dir="backward" ref={Radroute5} highlight="Hamburger Straße">Hamburger Straße nach Süden</.v>: Der alte Radfahrstreifen wird zur Grünfläche umgestaltet. Die Nebenfahrbahn wird zur Fahrradstraße, die in beide Richtungen befahren werden darf. Diese neue Verbindung wird als Zweirichtungs-Radweg bis in die <.v bounds="10.03762,53.579638,10.042492,53.58193" lon={10.040469} lat={53.580603} dir="forward" ref={Radroute5}>Reesestraße</.v> fortgeführt.</li>
      <li>
        <.v bounds="10.039043,53.578945,10.043034,53.58134" lon={10.041246} lat={53.579926} dir="backward" ref={BrNordN4}>In der Kreuzung</.v>:
        <ul>
          ...
          <li>Durch den westlichen Zweirichtungsradweg ist die Fahrt von <.m bounds="10.035818,53.577512,10.040375,53.579154">Berthastraße</.m> bis <.v bounds="10.03762,53.579638,10.042492,53.58193" lon={10.040469} lat={53.580603} dir="forward" ref={Radroute5}>Reesestraße</.v> nun ohne Umwege möglich.</li>
        </ul>
      </li>
    </ul>
    ...
    <p>Leider verlaufen die geplanten Radfahrstreifen häufig zwischen KFZ-Spur (links) und KFZ-Parkplätzen (rechts). Im <.v bounds="10.008117,53.55014,10.030998,53.559879" lon={10.01602} lat={53.555491} dir="backward" ref={Radroute7}>Steindamm</.v> funktioniert dieses Konzept schlecht – hier könnte es ähnlich problematisch werden. Weitere Schwachstellen der Maßnahmen sind Slalomführung um die Einmündungen <.m bounds="10.042315,53.581083,10.045566,53.582633">Stückenstraße und Haferkamp</.m>. Zumindest im <.v bounds="10.042024,53.578863,10.04384,53.579619" lon={10.043329} lat={53.579162} dir="backward" ref={BrNordN4}>Kurvenbereich Dehnhaide</.v> sollten Trennelemente ergänzt werden, um das Schneiden der Kurve durch KFZ zu verhindern.</p>

    <p>Trotz aller Kritik: es wird besser als vorher. Auch <.v bounds="10.00184,53.556333,10.013899,53.56121" lon={10.00463} lat={53.557383} dir="forward" ref={Radroute6}>An der Alster</.v> wurde die Infrastruktur Stück für Stück verbessert – vielleicht gelingt das auch hier.</p>
