defmodule Data.Article.Blog.EppendorferWeg do
  ...
  def text(assigns) do
    ...
    <h4>Vorabmaßnahme</h4>
    <p>In einer einfach umzusetzenden Maßnahme werden <.ref>Mittelinseln</.ref> gebaut. Dabei sollen auch Sitzbänke und Radanlehnbügel aufgestellt werden. Die Fahrradfurten bzw. <.ref ref={LexikonARAS}>Aufstellflächen vor den KFZ</.ref> sollen rot eingefärbt werden. Gebaut werden soll Ende 2024/Anfang 2025.</p>
