defmodule Data.Article.Blog.EppendorferWeg do
  ...
  def text(assigns) do
    ...
    <h4>Vorhaben</h4>
    <p>Der LSBG möchte die Bevölkerung mit in Planung einbeziehen und lädt daher zu mehreren Beteiligungsveranstaltungen. Fertig geplant sein soll bis Ende 2025; wann gebaut wird ist noch offen.</p>
