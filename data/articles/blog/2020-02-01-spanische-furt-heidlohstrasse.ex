defmodule Data.Article.Blog.SpanischeFurtHeidlohstrasse do
  ...
  def links(_assigns) do
    [
      {"Baustelleninfo", ~d[2025-05],
       "https://web.archive.org/web/20250623060916/https://lsbg.hamburg.de/resource/blob/1023246/7690dcebaaf7d597e9e792e01ed40492/spanische-furt-holsteiner-chaussee-anliegerinformation-februar-2025-data.pdf"},
  ...
  def text(assigns) do
    ...
    <p>Für das Teilstück zwischen <.v bounds="9.909562,53.622821,9.916382,53.625442" lon={9.91073} lat={53.62327} dir="forward" ref={Alltagsroute14}>Lerchenkamp</.v> und <.v bounds="9.91073,53.62293,9.91884,53.626086" lon={9.917075} lat={53.625086} dir="forward" ref={Alltagsroute14}>Vörn Brook</.v> wurde der Umbau ausgeschrieben. Er ist von Oktober 2022 bis März 2023 angesetzt. Anders als im ersten Entwurf soll die <.v bounds="9.912951,53.622777,9.919445,53.625168" lon={9.91495} lat={53.623563} dir="forward" ref={Alltagsroute14}>Querungshilfe an der Kita</.v> erhalten bleiben, allerdings ohne Zebrastreifen.</p>
