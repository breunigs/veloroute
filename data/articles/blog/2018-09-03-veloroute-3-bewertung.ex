defmodule Data.Article.Blog.Veloroute3Bewertung do
  ...
  def name(), do: "#{created_at()}-veloroute-3-bewertung"
  ...
  def text(assigns) do
    ...
    <p><.a target="_blank" href="https://www.abendblatt.de/hamburg/article215364183/Durchs-Univiertel-bis-Niendorf-noch-Luft-nach-oben.html" rel="nofollow">Zeitungsartikel/Review vom 19.09.2018</.a></p>
    """
  end
end
