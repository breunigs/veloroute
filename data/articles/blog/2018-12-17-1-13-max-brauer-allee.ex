defmodule Data.Article.Blog.MaxBrauerAllee do
  ...
  def text(assigns) do
    ...
    <h4>Alter Zustand</h4>
    <p>Nur in kurzen Abschnitten der Max-Brauer-Allee gibt es <.ref>Hochbordradwege</.ref>. Diese sind <.v bounds="9.937635,53.552885,9.939369,53.553728" lon={9.938654} lat={53.553506} dir="forward" ref="1">schmal und von Baumwurzeln unterbrochen</.v>. Ansonsten kann die Busspur mitbenutzt werden, die zeitweise auch für den privaten KFZ-Verkehr freigegeben ist.</p>

    <p>Die Führung zu bestimmten Fahrtzielen ist unklar. Etwa wie man zur <.m bounds="9.930961,53.551805,9.934104,53.552473">Ottenser Hauptstraße</.m> kommt oder wie <.v bounds="9.941509,53.554527,9.943611,53.555664" lon={9.942527} lat={53.555225} dir="forward" ref="1">links aus der Chemnitzstraße</.v> abgebogen werden soll.</p>

    <h4>Planung – Fahrtrichtung Süden / Elbe</h4>
    <p>Ab der <.m bounds="9.946863,53.557516,9.94874,53.558536">Eggerstedtstraße</.m> fährt der Radverkehr auf der Busspur. Sie ist mit 4,75m breiter als heute und nicht mehr für den KFZ-Verkehr freigegeben. Kurz vor der <.v bounds="9.940695,53.554543,9.943797,53.556118" lon={9.942264} lat={53.555422} dir="forward" ref="1">Gerichtstraße</.v> beginnt ein <.ref>geschützter Radfahrstreifen</.ref> der über die Kreuzung hilft. Danach gibt es wieder ein Stück auf der Busspur.</p>

    <p>An der <.v bounds="9.937696,53.552713,9.941115,53.554734" lon={9.939397} lat={53.553902} dir="forward" ref="1">Goetheallee</.v> beginnt ein <.ref>Radfahrstreifen</.ref> – diesmal ohne Trennelement zum KFZ-Verkehr. Nach der Einmündung geht dieser in einen <.ref>Kopenhagener Radweg</.ref> über. Am <.v bounds="9.93588,53.551282,9.937785,53.552628" lon={9.93717} lat={53.552531} dir="forward" ref="1">Paul-Nevermann-Platz</.v> wechseln sich Radfahrstreifen und Busspur ab. Danach geht der Radfahrstreifen in die Planung „<.a name="2021-09-11-max-brauer-allee-sued">Max Brauer Allee Süd</.a>“ über.</p>

    <h4>Planung – Fahrtrichtung Norden / Sternschanze</h4>
    <p>Bis zum <.v bounds="9.935302,53.551104,9.937535,53.552623" lon={9.936491} lat={53.551354} dir="backward" ref="1">Paul-Nevermann-Platz</.v> fährt man auf einem Hochbordradweg. Ab dort auf einem teilweise <.ref>geschützten Radfahrstreifen</.ref>, der nach der Einmündung <.v bounds="9.936656,53.55218,9.938966,53.553628" lon={9.9372} lat={53.55239} dir="backward" ref="1">Große Bergstraße</.v> auf einen Hochbordradweg aufgeleitet wird.</p>
    ...
    <p>Ein Zweirichtungsradweg verbindet die <.v bounds="9.940868,53.554848,9.943894,53.556132" lon={9.942647} lat={53.55523} dir="forward" ref="1">Chemnitzstraße</.v> mit der <.v bounds="9.940868,53.554848,9.943894,53.556132" lon={9.941988} lat={53.555664} dir="forward" ref="13">Gerichtstraße</.v>. Über diesen Weg wird auch links abgebogen um der Veloroute 1 zu folgen. Die Ampel wird so angepasst, dass sie für den Radverkehr gut einsehbar ist.</p>
    ...
    <p>Die geteilte Busspur Richtung Elbe ist mit der in der <.v bounds="9.969503,53.556473,9.973821,53.557444" lon={9.971835} lat={53.557097} dir="backward" ref="1">Feldstraße</.v> vergleichbar. Super, zumindest bis ein Bus kommt. Auch bei 4,75m Spurbreite ist ein mit 50 km/h vorbeirauschender Bus unangenehm.</p>
