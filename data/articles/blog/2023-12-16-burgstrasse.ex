defmodule Data.Article.Blog.Burgstrasse do
  ...
  def title(), do: "Burgstraße (Radroute 17)"
  ...
  def links(_assigns) do
    [
      {"Baustelleninfo", ~d[2024-08],
       "https://web.archive.org/web/20240913023917/https://lsbg.hamburg.de/resource/blob/943756/38f3624dd254950492ebf5da8f1e8863/burgstrasse-anliegerinformation-august-2024-data.pdf"},
      ...
      {"Pressemitteilung zum Umbau", "März 2024",
       "https://web.archive.org/web/20240403050150/https://www.hamburg.de/bvm/medien/18385964/2024-03-18-bvm-burgstrasse/"},
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>In <.v bounds="10.038178,53.555074,10.041867,53.559624" lon={10.039422} lat={53.557504} dir="forward" ref={Alltagsroute13}>Richtung Süden</.v> steht ein <.ref>Hochbordradweg</.ref> zur Verfügung. In <.v bounds="10.038178,53.555074,10.041867,53.559624" lon={10.040254} lat={53.556187} dir="backward" ref={Alltagsroute13}>Richtung Norden</.v> gibt es im Bereich der <.a ref={Alltagsroute13}>Radroute 13</.a> einen <.ref>Radfahrstreifen</.ref>. Dieser wird kurz vor der Kreuzung mit der <.v bounds="10.038178,53.555074,10.041867,53.559624" lon={10.039669} lat={53.557566} dir="backward" ref={Alltagsroute13}>Bethesdastraße</.v> auf einen Hochbordradweg aufgeleitet.</p>

    <h4>Planung</h4>
    <p>Im Bereich der Radroute wird der Asphalt erneuert und der Radfahrstreifen auf 2,0m verbreitert. Die Kreuzung mit der <.v bounds="10.038178,53.555074,10.041867,53.559624" lon={10.039669} lat={53.557566} dir="backward" ref={Alltagsroute13}>Bethesdastraße</.v> erhält eine vollständige Ampel, was das Linksabbiegen vereinfacht.</p>
