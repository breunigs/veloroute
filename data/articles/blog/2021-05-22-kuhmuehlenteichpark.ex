defmodule Data.Article.Blog.Kuhmuehlenteichpark do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4> <p>Der Radverkehr wird zwischen der <.v bounds="10.020132,53.565604,10.024992,53.566952" lon={10.0220022} lat={53.5660667} dir="forward" ref={@ref}>Hartwicusstraße</.v> und dem <.v bounds="10.025646,53.566341,10.030505,53.567689" lon={10.0274425} lat={53.5670232} dir="forward" ref={@ref}>Immenhof</.v> durch einen Park geleitet. Die Auffahrten sind als Ortsfremder leicht zu übersehen. Die wechselnden Oberflächen sind in die Jahre gekommen und daher uneben.</p>
    ...
    <h4>Planung</h4> <p>Die Veloroute soll nach dem ersten Entwurf in ihrer heutigen Führung <.v bounds="10.02191,53.565489,10.028873,53.567082" lon={10.0264374} lat={53.5666511} dir="backward" ref={@ref}>durch den Park</.v> ausgebaut werden. Prinzipiell ist ein asphaltierter, 3,0m breiter Zweirichtungsradweg vorgesehen. Der Fußweg daneben soll weiterhin in Grand befestigt werden. <.v bounds="10.021304,53.565242,10.028268,53.566836" lon={10.0247564} lat={53.565926} dir="backward" ref={@ref}>Unter der Kuhmühlenbrücke</.v> wird der Radweg auf 2,0m verengt – dies entspricht der Radwegbreite im <.v bounds="10.049971,53.574303,10.058596,53.576277" lon={10.0549479} lat={53.5751804} dir="backward" ref={@ref}>Friedrichsberger Park</.v>.</p>
    <p>Die Aufführung in die <.v bounds="10.021304,53.565242,10.028268,53.566836" lon={10.0237762} lat={53.566034} dir="backward" ref={@ref}>Hartwicusstraße</.v> wird nach Fahrtrichtungen getrennt und je 1,5m breit. Diese werden gepflastert, sodass die Veloroute Richtung Innenstadt immer Vorfahrt gewähren muss. Die Trennung wurde gemacht um die Bäume erhalten zu können.</p>
    <p>Zum <.v bounds="10.024066,53.566253,10.029806,53.567567" lon={10.0267086} lat={53.5668131} dir="forward" ref={@ref}>Immenhof</.v> werden die Fahrtrichtungen über eine gemeinsame, gepflasterte Auffahrt geführt. Hier ist die Veloroute dann in beide Richtungen vorfahrtspflichtig gegenüber dem Verkehr auf dem Immenhof.</p>
