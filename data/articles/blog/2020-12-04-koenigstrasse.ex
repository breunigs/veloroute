defmodule Data.Article.Blog.Koenigstrasse do
  ...
  def links(_assigns) do
    [
      {"Baustelleninfo", "Februar 2024",
       "https://web.archive.org/web/20241006015608/https://lsbg.hamburg.de/resource/blob/784476/98f07a0b558b4377095c22c676963775/koenigstrasse-anliegerinformation-2-ba-februar-2024-data.pdf"},
      {"Auftragsvergabe Abschnitt 2, Mörkenstraße bis Reeperbahn", "August 2023",
       "https://web.archive.org/web/20230826085458/https://fbhh-evergabe.web.hamburg.de/evergabe.bieter/api/external/deeplink/subproject/db27136a-ff71-428c-bc2f-7919703f2c37"},
  ...
  def text(assigns) do
    ...
    <ul>
      <li>Beidseitig Radfahrstreifen in der <.v bounds="9.946251,53.548112,9.951837,53.550342" lon={9.947273} lat={53.549343} dir="backward" ref={Alltagsroute12}>Mörkenstraße</.v> (statt Bushaltestelle in Richtung Hafen und <.ref>Protected-Bike-Lane</.ref> in Gegenrichtung).</li>
      ...
      <li>Zwischen <.v bounds="9.937576,53.547442,9.940694,53.548256" lon={9.939898} lat={53.547884} dir="forward" ref={Alltagsroute12}>Biernatzkistraße</.v> und <.v bounds="9.937576,53.547442,9.940694,53.54825" lon={9.93805} lat={53.547827} dir="forward" ref={Alltagsroute12}>Schillerstraße</.v> wird der Radverkehr entlang der Veloroute über einen <.ref>Hochbordradweg</.ref> geführt (statt ungeschützer Radfahrstreifen um KFZ-Parkplätze erhalten zu können). Die neue Variante ermöglicht weitere Baumpflanzungen.</li>
      <li>Die <.v bounds="9.944258,53.547985,9.947441,53.549126" lon={9.945649} lat={53.548614} dir="forward" ref={Alltagsroute12}>Bushaltestelle S-Königstraße</.v> bleibt, beide Fahrtrichtungen halten östlich der Elmenhorststraße.</li>
    </ul>
    ...
    <h5>Sonstiges</h5>
    <p>An der <.v bounds="9.944258,53.547985,9.947441,53.549126" lon={9.945649} lat={53.548614} dir="forward" ref={Alltagsroute12}>Bushaltestelle S-Königstraße</.v> wird der Radverkehr durch die Wartefläche des Busses geführt und muss entweder hinter ihm warten, oder sich in den KFZ-Verkehr einordnen.</p>
    <p>Wo möglich wird <.ref ref={LexikonDirektesUndIndirektesAbbiegen}>indirektes Linksabbiegen</.ref> ermöglicht. Bei vorhandenen Einbahnstraßen wird darauf geachtet, dass der Radverkehr gut in Gegenrichtung fahren kann.</p>
