defmodule Data.Article.Blog.FischtreppePopppenbuettelerSchleuse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Baustelle</h4>
    <p>An der Poppenbütteler Schleuse wird eine Fischtreppe gebaut, wobei die Brücke dort aus Sicherheitsgründen voll gesperrt wird. Die Freizeitroute wird daher über den Saseler Damm, entlang der <.a ref={Alltagsroute14}>Alltagsroute 14</.a>, umgeleitet.</p>
