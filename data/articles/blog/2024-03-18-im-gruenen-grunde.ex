defmodule Data.Article.Blog.ImGruenenGrunde do
  ...
  def text(assigns) do
    ...
    <p>Der überarbeitete zweite Entwurf wurde veröffentlicht, der den bisherigen Planungsansatz beibehält. Hauptsächlich wurde die Gestaltung der Auf- bzw. Abfahrt auf den Zweirichtungsradweg am nördlichen Ende der Straße überarbeitet.</p>

    <p>Leider war es nicht möglich den KFZ-Verkehr zum <.v bounds="10.029095,53.618193,10.045529,53.626645" lon={10.033887} lat={53.620266} dir="forward" ref={Freizeitroute11}>Friedhof Ohlsdorf</.v> direkt von der <.v bounds="10.029095,53.618193,10.045529,53.626645" lon={10.033292} lat={53.62074} dir="forward" ref={Freizeitroute11}>Fuhlsbütteler Straße</.v> links abbiegen lassen kann. Dieser wird auch weiterhin über die Radroute Plus fahren.</p>

    <h4>Alter Zustand</h4>
    <p>Im Abschnitt wird meist im <.ref>Mischverkehr</.ref> gefahren, bei zugelassenem Tempo-50. Lediglich von der <.v bounds="10.030109,53.621421,10.034116,53.625154" lon={10.031568} lat={53.623465} dir="backward" ref={BrNordN8} highlight="Fuhlsbütteler Straße">Fuhlsbütteler Straße kommend</.v> ist ein schmaler, unebener <.ref>Hochbordradweg</.ref> vorhanden, der sich nach <.v bounds="10.030109,53.621421,10.034116,53.625154" lon={10.031119} lat={53.622593} dir="backward" ref={BrNordN8}>Am Hasenberge</.v> in Luft auflöst.</p>

    <.h4_planning ref={@ref} checked={@show_map_image}/>
    <p>Die Straße soll zu einer Fahrradstraße umgestaltet werden. Der alte Hochbordradweg wird zum Fußweg bzw. Fahrradparken genutzt.</p>

    <p>Im südlichen Teil bis <.v bounds="10.029527,53.619386,10.032181,53.622709" lon={10.031217} lat={53.622232} dir="forward" ref={Freizeitroute1}>Am Hasenberge</.v> soll ein niederländisches Design probiert werden: in Straßenmitte wird ein Stück gepflastert statt asphaltiert. Das soll dazu führen, dass beim Überholen ein vollständiger Spurwechsel gemacht wird.</p>

    <p><.v bounds="10.028681,53.621782,10.03409,53.623295" lon={10.030889} lat={53.622503} dir="backward" ref={Freizeitroute1}>Am Hasenberge</.v> wird wartepflichtig, was durch „Haifischzähne“ (▲▲▲▲▲) hervorgehoben wird. Man verzichtet wegen dem Busverkehr auf die sonst übliche Gehwegüberfahrt.</p>

    <p>Im <.v bounds="10.03026,53.622167,10.032912,53.624215" lon={10.031479} lat={53.62293} dir="forward" ref={BrNordN8}>nördlichen Teil</.v> werden die Schrägparkplätze durch seitliches Parken ersetzt. Man plant mit 75cm Sicherheitsabstand gegen <.ref>Dooring</.ref>. Am Ende der Straße wird eine Auffahrt zum <.a ref={FuhlsbuettelerStrasseNord}>neuen Zweirichtungsradweg in der Fuhlsbütteler Straße</.a> geschaffen. Der verwirrende Umweg über den <.v bounds="10.028198,53.62297,10.03518,53.627202" lon={10.030048} lat={53.625757} dir="forward" ref={BrNordN8}>Justus-Strandes-Weg</.v> entfällt.</p>
