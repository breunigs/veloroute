defmodule Data.Article.Blog.Kloevensteenweg do
  ...
  def text(assigns) do
    ~H"""
    <h4>Stand August 2020:</h4> <p>Die Planungen zum Kreisverkehr und die Tempo-30-Zone in der <.m bounds="9.763843,53.46337,10.088009,53.590145">Alten Sülldorfer Landstraße</.m> sind abgeschlossen. Der Artikel wurde an die Detailänderungen angepasst.</p>
    <h4>Alter Zustand</h4> <p>Die Kreuzung ist mit einer Ampel versehen. Radwege gibt es nur im  <.m bounds="9.763089,53.581203,9.766407,53.609231">Klövensteenweg</.m>, die aber schwer zu erkennen sind und deren Aufleitungen nicht hervorgehoben sind.</p>
