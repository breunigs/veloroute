defmodule Data.Article.Blog.EisenbahnbrueckeBovestrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Bestand</h4> <p>Der Radverkehr hat hier die Möglichkeit in Schrittgeschwindigkeit auf den 1,5m bis 2,0m breiten Fußwegen mitzufahren oder sich unter den Autoverkehr zu mischen. Keine der Möglichkeiten ist attraktiv.</p>
