defmodule Data.Article.Blog.Veloroute2Aenderungen do
  ...
  def text(assigns) do
    ~H"""
    <p>Die <.a ref={Alltagsroute2}>Veloroute 2</.a> war auch vor einem Jahr brauchbar, hat gerade im Innenstadtbereich aber nochmals erheblich zugelegt. Die Anpassungen sind alle sinnvoll, eine Verschlimmbesserung oder gar Verschlechterung gibt es dabei nicht. Allerdings bleiben die Maßnahmen teils unter den Erwartungen, etwa wenn Kopfsteinpflaster durch geringfügig besseres Kopfsteinpflaster ersetzt wird.</p>
    ...
    <p>Zu guter letzt: es sind noch <.a ref={Bau}>weitere Umbauten geplant</.a>, d.h. in einem weiteren Jahr sollte Veloroute 2 nochmal besser zu befahren sein. Wenn ich etwas vergessen habe, <.mailto>schreib mir</.mailto> bitte.</p>
    """
  end
end
