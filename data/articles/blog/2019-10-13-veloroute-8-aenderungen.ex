defmodule Data.Article.Blog.Veloroute8Aenderungen do
  ...
  def text(assigns) do
    ~H"""
    <p>Die einzige größere Änderung auf der <.a href="/8">Veloroute 8</.a> zwischen Sommer 2018 und 2019 die mir aufgefallen ist, ist die Fertigstellung der Fahrradstraße im <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.554868, lon: 10.078777, zoom: 16})} ref="8">Horner Weg</.m>. Vor einem Jahr wurde stadtauswärts ab dem Rhiemsweg gerade der Umbau begonnen, jetzt rollt es sich auf der gesamten Straße wunderbar.</p>
