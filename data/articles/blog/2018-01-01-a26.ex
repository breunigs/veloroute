defmodule Data.Article.Blog.A26 do
  ...
  def text(assigns) do
    ~H"""
    <h4>Baustelle</h4> <p>Bedingt durch den Bau der A26 durch das Alte Land sind die <.a ref={Freizeitroute13}>Freizeitroute 13</.a> und der <.a ref={Freizeitroute11}>2. Grüne Ring</.a> durchschnitten.</p>
