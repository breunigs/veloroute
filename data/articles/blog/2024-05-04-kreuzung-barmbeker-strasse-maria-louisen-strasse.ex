defmodule Data.Article.Blog.KreuzungBarmbekerStrasseMariaLouisenStrasse do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Entlang der Barmbeker Straße sind rund 1,25m bis 1,5m breite <.ref>Hochbordradwege</.ref> vorhanden. <.v bounds="10.005231,53.590353,10.00919,53.592162" lon={10.007815} lat={53.591393} dir="backward" ref={BrNordN6}>Falschparker</.v> reduzieren die nutzbare Breite weiter.</p>
    ...
    <p>Anmerkung: Die <.ref>Fahrbahn</.ref> wird von der <.v bounds="9.998992,53.590986,10.006602,53.594558" lon={10.000166} lat={53.593603} dir="forward" ref={BrNordN6}>Buchenstraße</.v> bis zur <.m bounds="10.013138,53.586091,10.019013,53.590773">Barmbeker Straßenbrücke</.m> durchgängig saniert. Wegen der <.ref>Benutzungspflicht</.ref> ist dies für den Radverkehr jedoch zweitrangig.</p>
