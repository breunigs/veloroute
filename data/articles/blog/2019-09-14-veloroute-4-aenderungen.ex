defmodule Data.Article.Blog.Veloroute4Aenderungen do
  ...
  def text(assigns) do
    ~H"""
    <p>Die <.a name="alltagsroute-4">Veloroute 4</.a> war 2018 schon gut befahrbar, hat aber an einigen Stellen noch Potenzial für mehr. Zur Zeit wird etwa die <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.579818, lon: 9.998244, zoom: 17})} ref="4">Krugkoppelbrücke</.m> umgebaut und man erkennt schon die künftigen Radfahrstreifen (<.a name="2018-09-01-4-krugkoppel">Details</.a>). Ebenso wird zur Zeit an der <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.593627, lon: 9.99478, zoom: 17})} ref="4">Hudtwalckerstraße</.m> die Radführung verbessert (<.a name="2019-02-01-4-knoten-hudtwalckerstrasse">Details</.a>), auch wenn man hier auf den Fotos noch nicht so viel erkennt. Bei der Kreuzung <.m bounds={Geo.CheapRuler.center_zoom_to_bounds(%{lat: 53.617005, lon: 10.01556, zoom: 17})} ref="4">Maienweg / Sengelmannstraße</.m> ist die Situation ähnlich (<.a name="2018-12-30-4-kreuzung-maienweg-sengelmannstrasse">Details</.a>).</p>
