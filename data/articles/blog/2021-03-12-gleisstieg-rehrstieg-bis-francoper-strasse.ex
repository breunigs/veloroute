defmodule Data.Article.Blog.GleisstiegRehrstiegBisFrancoperStrasse do
  ...
  def text(assigns) do
    ...
    <p>Die Anschlüsse bzw. Übergänge zu den weiterführenden Straßen werden jeweils getrennt geplant und liegen noch nicht vor. Am <.m bounds="9.87178,53.473262,9.873973,53.473902">Rehrstieg</.m> ist vermutlich ein Zweirichtungsradweg auf Seite des Spielplatzes bis Höhe <.m bounds="9.872928,53.473807,9.875545,53.474704" lon="9.8738319" lat="53.4742024" dir="backward">Striepenweg</.m> angedacht. In der Planung ist nur ein kurzer Stummel eingezeichnet, der alleine für sich nutzlos ist.</p>
    <p>In Richtung <.m bounds="9.862788,53.473614,9.865375,53.474214" lon="9.8645124" lat="53.4738852" dir="forward">Francoper Straße</.m> wird der Radweg immer schmäler und hört dann ohne Überleitung auf. Auch hier ist davon auszugehen das der Radweg in der anliegenden Planung fortgeführt wird und ähnlich wie die <.m bounds="9.8816,53.472018,9.891557,53.47433" lon="9.8878776" lat="53.4730192" dir="forward">Altwiedenthaler Twiete</.m> verbessert wird.</p>
