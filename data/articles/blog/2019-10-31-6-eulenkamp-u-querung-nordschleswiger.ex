defmodule Data.Article.Blog.EulenkampUQuerungNordschleswiger do
  ...
  def text(assigns) do
    ...
    <p>Auf dem Teilstück des Eulenkamps zwischen <.v bounds="10.066666,53.580161,10.070243,53.581776" lon={10.0684529} lat={53.5807801} dir="forward" ref={@ref}>Nordschleswiger Straße</.v> und <.v bounds="10.066757,53.580654,10.074466,53.584134" lon={10.071166} lat={53.5828111} dir="forward" ref={@ref}>Straßburger Straße / Friedrich-Ebert-Damm</.v> sollen künftig jeweils
    ...
    <p>Der Kreuzungsbereich <.v bounds="10.066757,53.580654,10.074466,53.584134" lon={10.071166} lat={53.5828111} dir="forward" ref={@ref}>Straßburger
    Straße / Friedrich-Ebert-Damm / Eulenkamp</.v> soll nochmal ganzheitlich umgeplant
    ...
    <p><.v bounds="10.068792,53.583128,10.073973,53.584327" lon={10.0718666} lat={53.5835517} dir="backward" ref={@ref}>Nördlich der Kreuzung</.v> wird der Straßburger Stieg künftig für den
