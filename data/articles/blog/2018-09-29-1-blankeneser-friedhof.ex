defmodule Data.Article.Blog.BlankeneserFriedhof do
  ...
  def text(assigns) do
    ...
    <h4>Vorhaben</h4>
    <p>Laut einem Zeitungsartikel soll der Weg in diesem Abschnitt zu einem getrennten Rad- und Fußweg umgebaut werden. In einer Präsentation des Bezirks findet sich ein Querschnitt der einen 2,45m breiten Gehweg neben einem 3,0m breiten Zweirichtungsradweg vorsieht.</p>
