defmodule Data.Article.Blog.Rantzaustrasse do
  ...
  def text(assigns) do
    ...
    <h4>Planung</h4>
    <p>Die Einmündungen bzw. Kreuzungen mit der <.v bounds="10.064981,53.567797,10.067518,53.569207" lon={10.066139} lat={53.568576} dir="forward" ref={Alltagsroute7}>Freesenstraße</.v>, <.v bounds="10.06722,53.56826,10.0696,53.569643" lon={10.068002} lat={53.568734} dir="forward" ref={Alltagsroute7}>Claudiusstraße</.v> und dem <.v bounds="10.0694,53.568675,10.071547,53.570276" lon={10.070066} lat={53.569367} dir="forward" ref={Alltagsroute7}>Schloßgarten</.v> werden zu Gehwegüberfahrten umgebaut. Entlang der Rantzaustraße besteht dann künftig Vorfahrt.</p>

    <p><.v bounds="10.071397,53.569119,10.072878,53.570453" lon={10.071846} lat={53.56988} dir="forward" ref={Alltagsroute7}>Am Alten Posthaus</.v> wird die Kreuzung so angepasst, das man ohne Schlenker geradeaus fahren kann. Das Stop-Schild in Fahrtrichtung stadtauswärts bleibt aber erhalten.</p>
