defmodule Data.Article.Blog.BarrierearmerAlsterradweg do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Auf dem Alsterradweg zwischen <.m bounds="9.989571,53.597215,9.99717,53.601655" lon={9.99176} lat={53.599118} dir="forward" ref="FR1">Lattenkamp</.m> und <.m bounds="10.027771,53.618369,10.035399,53.622232" lon={10.030533} lat={53.620744} dir="forward" ref="FR1">Ohlsdorf</.m> finden sich zahlreiche Hindernisse; für den Radverkehr meist in Form von Treppen. Hinzu kommen <.m bounds="9.995081,53.605631,9.996207,53.606489" lon={9.995725} lat={53.60591} dir="forward" ref="FR1">enge Umlaufsperren</.m>, die für Lastenräder schwer zu umfahren sind und teils steile Anstiege.</p>
    ...
    <p>Hinzu kommen Sitzbänke in regelmäßigen Abständen. An der <.m bounds="9.994641,53.604648,9.996619,53.606663" lon={9.995744} lat={53.605707} dir="forward" ref="FR1">Wilhelm-Metzger-Straße</.m> soll eine neue Unterführung entstehen. Es sind weitere Zugänge geplant. An allen abschüssigen Zugängen sind Umlaufsperren vorgesehen, damit der Radverkehr die Erholungsfunktion der Grünfläche nicht stört. Die Umlaufsperren sollen auch mit Rollstühlen problemlos passierbar sein.</p>
