defmodule Data.Article.Blog.HohenfelderBucht do
  ...
  def text(assigns) do
    ...
    <p>Die bisherigen Fahrtmöglichkeiten bleiben erhalten. D.h. man wird auch weiterhin durch die Unterführung (Fußweg mit <.ref>Fahrrad frei</.ref>) und an der Oberfläche über die <.v bounds="10.010955,53.559175,10.019793,53.564957" lon={10.017353} lat={53.562411} dir="forward" ref={BrNordN1}>Barcastraße</.v> Richtung <.v bounds="10.013216,53.562013,10.019311,53.566995" lon={10.01811} lat={53.564418} dir="forward" ref={Alltagsroute5}>Mundsburger Damm</.v> fahren können. Neu hinzu kommt eine echte geradeaus Möglichkeit. Abgesehen von einer kleinen Verschwenkung an der Einmündung der <.v bounds="10.012316,53.560392,10.020485,53.56544" lon={10.015419} lat={53.562475} dir="forward" ref={BrNordN1}>Sechslingspforte</.v> fährt man zukünftig kerzengerade bis zum Altbestand im <.v bounds="10.013216,53.562013,10.019311,53.566995" lon={10.01811} lat={53.564418} dir="forward" ref={Alltagsroute5}>Mundsburger Damm</.v>.</p>

    <h5>Stadtauswärts, entlang der Alster:</h5>
    <p>Bislang ist es nicht leicht vom <.v bounds="10.012899,53.560451,10.02315,53.566472" lon={10.016171} lat={53.5637} dir="forward" ref={Freizeitroute3}>Radweg an der Alster</.v> Richtung <.v bounds="10.013216,53.562013,10.019311,53.566995" lon={10.01811} lat={53.564418} dir="forward" ref={Alltagsroute5}>Mundsburger Damm</.v> zu fahren. Die Planung sieht eine direktere Querungsmöglichkeit über die <.v bounds="10.012787,53.561928,10.023246,53.567522" lon={10.017832} lat={53.565199} dir="backward" ref={Alltagsroute5}>Armgartstraße</.v> vor. Die Ampel über den Mundsburger Damm bleibt, und die Baustellenampel am <.v bounds="10.012139,53.562077,10.022896,53.566994" lon={10.017168} lat={53.565184} dir="backward" ref={Alltagsroute5}>Schwanenwik</.v> wird ordentlich hergerichtet. Auch die Fahrt in die <.v bounds="10.010955,53.559175,10.019793,53.564957" lon={10.017577} lat={53.563142} dir="forward" ref={BrNordN1}>Buchtstraße</.v> ist möglich.</p>
    ...
    <h5>Breiten:</h5>
    <p>Der Radweg an der Alster soll mit 4,0m deutlich breiter werden als bisher, sodass 2,0m je Richtung zur Verfügung stehen. Protected-Bike-Lanes und Furten haben meist 2,25m. Lediglich in der <.v bounds="10.010955,53.559175,10.019793,53.564957" lon={10.017353} lat={53.562411} dir="forward" ref={BrNordN1}>Barcastraße</.v> gibt es nur <.ref>Schutzstreifen</.ref> mit 1,50m Breite.</p>
