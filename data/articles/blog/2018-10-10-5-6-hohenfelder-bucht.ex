defmodule Data.Article.Blog.HohenfelderBucht do
  ...
  def text(assigns) do
    ...
    <h5>Breiten:</h5>
    <p>Der Radweg an der Alster soll mit 4,0m deutlich breiter werden als bisher, sodass 2,0m je Richtung zur Verfügung stehen. Radfahrstreifen haben meist 2,25m, Einrichtungsradwege sind mit 2,0m ebenfalls deutlich breiter als aktuell. Lediglich in der <.m bounds="10.014756,53.560302,10.018078,53.562792">Barcastraße</.m> gibt es nur Schutzstreifen (gestrichelte Linie) mit 1,50m Breite – allerdings wird die Straße künftig auch deutlich schmaler ausgeführt und sollte den Verkehr hoffentlich etwas beruhigen.</p>

    <h5>Fazit:</h5>
    <p>Insgesamt wirkt die Planung gelungen: die Hohenfelder Bucht wird nicht nur grüner, sondern auch für den Radverkehr erheblich aufgewertet. Es ist zu wünschen, das auch der Rest der Veloroute so vorbildlich umgesetzt wird. Baubeginn soll 2020 sein (Angabe der Polizei, Stand Mai 2019).</p>
