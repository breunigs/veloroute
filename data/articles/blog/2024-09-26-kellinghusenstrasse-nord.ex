defmodule Data.Article.Blog.KellinghusenstrasseNord do
  ...
  def text(assigns) do
    ...
    <p>In der <.v bounds="9.990748,53.592267,9.99347,53.593414" lon={9.991575} lat={53.59275} dir="forward" ref={BrNordN6} highlight="Ludolfstraße">westlichen Ludolfstraße</.v> werden die Radfahrstreifen aus der <.a ref={EppendorferMarktplatz}>Planung zum Eppendorfer Marktplatz</.a> fortgesetzt. Sie werden mindestens 2,0m breit. Auf der <.v bounds="9.990883,53.592591,9.993989,53.593374" lon={9.993254} lat={53.593024} dir="backward" ref={BrNordN6}>Nordseite</.v> wird der Radwege durch einen Bordstein vom KFZ-Verkehr getrennt („<.ref>Protected-Bike-Lane</.ref>“). Auch hier werden die ehemaligen Radwege zu Gehwegen.</p>
    ...
    <p>Der Umbau soll im nach dem Umbau „<.a ref={EppendorferMarktplatz}>Eppendorfer Marktplatz – Abschnitt 1</.a>“ erfolgen. Vorher muss aber die Fernwärmeleitung in der Kellinghusenstraße verlegt werden. Verzögerungen bei der Fernwärme verschieben entsprechend den Straßenumbau.</p>
    """
  end
end
