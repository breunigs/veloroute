defmodule Data.Article.Blog.RadroutePlusBadBramstedtAbschnittN25 do
  ...
  def text(assigns) do
    ...
    <h4>Hintergrund</h4>
    <p>Das ehemalige Gütergleis entlang der U1 soll für die <.a ref={RSWBadBramstedt}>Radroute Plus nach Bad Bramstedt</.a> hergerichtet werden. Es handelt sich um eine neue Wegeverbindung, die bisher noch nicht existiert. Videoaufnahmen in diesem Abschnitt orientieren sich an vorhandenen, nahegelegenen Wegen. Diese werden <em>nicht</em> zur Radroute umgebaut.</p>
    ...
    <h4>Meinung</h4>
    <p>An diesem Abschnitt und den Zufahrten gibt es nichts auszusetzen. Es ist aber schade, dass der kreuzungsfreie Abschnitt bereits an der Hohen Liedt endet. Siehe dazu <.a ref={RswBadBramstedtHoheLiedtBisLangenhornerChaussee}>Artikel zum nachfolgenden Abschnitt</.a>.</p>
