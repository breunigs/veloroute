defmodule Data.Article.Blog.HammerLandstrasse do
  ...
  def name(), do: "#{created_at()}-hammer-landstrasse"
  ...
  def text(assigns) do
    ~H"""
    <h4>Bestand</h4> <p>Die Radwege werden neben den Fußwegen als <ref>Hochbordradweg</ref> geführt. Überholt werden kann nicht, denn dafür ist die Breite deutlich zu gering. Auch der Asphalt oder das Pflaster ist in die Jahre gekommen und stellenweise unangenehm zu befahren.</p>
    ...
    <p>Unterm Strich wird Radfahren hier deutlich angenehmer, bleibt aber weit hinter den Möglichkeiten zurück. Wer es lieber etwas ruhiger mag, findet mit der grob parallel verlaufenden <.a href="/8" bounds="10.038495,53.546434,10.094111,53.559319">Veloroute 8</.a> möglicherweise eine Alternative.</p>
    <h4>Quellen</h4> <ul>
