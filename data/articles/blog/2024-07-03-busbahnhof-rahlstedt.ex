defmodule Data.Article.Blog.BusbahnhofRahlstedt do
  ...
  def links(_assigns) do
    [
      {"Ausschreibung Umbau", ~d[2024-09],
       "https://web.archive.org/web/20241226193142/https://fbhh-evergabe.web.hamburg.de/evergabe.bieter/api/external/deeplink/subproject/6988d199-1e38-42e4-8b00-1cddf1697ac5"},
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Entlang der <.a ref={Alltagsroute7}>Radroute 7</.a> ist <.v bounds="10.151275,53.602296,10.15665,53.605364" lon={10.154615} lat={53.60286} dir="forward" ref={Alltagsroute7}>von Süden kommend</.v> eine <.ref ref={LexikonARAS}>Aufstellfläche vorm KFZ-Verkehr aufgemalt</.ref>, von der aus <.v bounds="10.151275,53.602296,10.15665,53.605364" lon={10.154797} lat={53.603446} dir="forward" ref={Alltagsroute7}>zur Fußgängerzone</.v> oder <.m bounds="10.150977,53.602945,10.154608,53.604786">Richtung Bahnunterführung</.m> gefahren werden kann. <.v bounds="10.152066,53.602435,10.156238,53.604747" lon={10.154644} lat={53.603334} dir="backward" ref={Alltagsroute7}>In der Gegenrichtung</.v> fährt man entweder vom Fahrbahnstummel direkt oder nutzt die geteilte Rad- und Fußfurt.</p>
