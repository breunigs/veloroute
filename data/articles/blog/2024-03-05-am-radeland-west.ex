defmodule Data.Article.Blog.AmRadelandWest do
  ...
  def links(_assigns) do
    [
      {"Infoseite der Stadt zum Umbau",
       "https://web.archive.org/web/20250316035536/https://www.hamburg.de/politik-und-verwaltung/bezirke/harburg/themen/verkehr/ausbau-veloroute-10-bostelbek-872180"},
      {"Pressemitteilung zum Umbau",
       "https://web.archive.org/web/20250216033349/https://www.hamburg.de/politik-und-verwaltung/bezirke/harburg/themen/verkehr/ausbau-veloroute-10-in-bostelbek-872178"},
  ...
  def text(assigns) do
    ...
    <h4>Planung</h4>
    <p>Es bleibt beim Mischverkehr. Die Fahrbahn wird saniert und 6,0m bis 6,5m breit – sofern KFZ-Parkplätze links bzw. rechts vorgesehen sind nur 4,5m. Die Tempo-30-Zone beginnt künftig bereits ab dem <.v bounds="9.931828,53.470403,9.940886,53.472962" lon={9.935474} lat={53.471703} dir="forward" ref={Alltagsroute10}>Bostelbeker Damm</.v>.</p>

    <p>Die Aufleitung zur <.v bounds="9.917219,53.470542,9.929704,53.473296" lon={9.921957} lat={53.47188} dir="forward" ref={Alltagsroute10} highlight="Moorstieg">Unterführung Moorstieg</.v> wird etwas deutlicher. Die <.v bounds="9.928784,53.470221,9.936683,53.47296" lon={9.933116} lat={53.471729} dir="forward" ref={Alltagsroute10} highlight="Zum Fürstenmoor">Unterführung zum Fürstenmoor</.v> bleibt unverändert.</p>
    ...
    <p>Das man sich die <.v bounds="9.928784,53.470221,9.936683,53.47296" lon={9.933116} lat={53.471729} dir="forward" ref={Alltagsroute10} highlight="Zum Fürstenmoor">Unterführung zum Fürstenmoor</.v> gar nicht angeschaut hat ist frech. Statt KFZ-Parkplätzen wäre auch eine befahrbare Rampe denkbar gewesen. Das löst zwar nicht das Treppenproblem <.v bounds="9.928784,53.470221,9.936683,53.47296" lon={9.932734} lat={53.471413} dir="forward" ref={Freizeitroute14}>auf der anderen Seite</.v>, halbiert aber schonmal den Aufwand.</p>
