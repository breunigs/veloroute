defmodule Data.Article.Blog.Hoegerdamm do
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4>
    <p>Im Recha-Lübke-Damm gibt es nur einen unebenen, rund 1m breiten <.ref>Hochbordradweg</.ref> in Richtung Elbbrücken. In die Gegenrichtung ist Radfahren nicht möglich.</p>

    <h4>Planung</h4>
    <p><.v bounds="10.006357,53.547231,10.011463,53.5484" ref={Freizeitroute6} dir="forward" lat={53.54766} lon={10.00847}>Nach der Eisenbahnbrücke</.v> soll der Radverkehr auf einem rund 2,75m breiten Radweg fahren, der mittels Bordsteinen von Fuß- und Autoverkehr getrennt (<.ref>Kopenhagener Lösung</.ref>) verläuft. Die <.v bounds="10.008964,53.547175,10.011425,53.547738" ref={Freizeitroute6} dir="forward" lat={53.54749} lon={10.00967}>vorhandene Ampel</.v> wird etwas verschoben, erlaubt aber weiterhin ein Linksabbiegen in die Nebenfahrbahn der Amsinckstraße. Anders als heute wird der Radweg hier getrenne Spuren für Links/Geradeaus erhalten.</p> <p>Im Recha-Lübke-Damm selbst ist vorgesehen eine der beiden KFZ-Spuren zu einem <.ref>Radfahrstreifen</.ref> umzuwidmen. Im <.v bounds="10.011855,53.545172,10.016961,53.54634" ref={Freizeitroute6} dir="forward" lat={53.54637} lon={10.01290}>östlichen Teil</.v> geht die Radspur durch eine Verschwenkung in einer gemeinsamen Bus- und Radspur auf. Im Rahmen der Busbeschleunigung sollen die Busse ab vorrausichtlich 2025 hier jedoch nicht mehr fahren, sodass auch dieser Teil zu einem reinen Radfahrstreifen wird.</p> <p>Es wurde geprüft, ob man mit dem Fahrrad auch Richtung Innenstadt fahren könnte. Man verwarf dies jedoch aus Platzmangel im Recha-Lübke-Damm selbst, aber auch im <.v bounds="10.003354,53.547179,10.010934,53.548915" lat={53.54637} lon={10.01290} ref={Freizeitroute6} dir="backward">weiteren Verlauf zum Deichtorplatz</.v>. Man überlegt stattdessen die Führung über <.m bounds="10.007108,53.544397,10.013826,53.546435">Banksstraße</.m>/<.m bounds="10.013826,53.544323,10.016729,53.545741">Lippeltstraße</.m> zu verbessern.</p>
