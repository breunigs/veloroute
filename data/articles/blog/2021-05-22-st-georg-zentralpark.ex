defmodule Data.Article.Blog.StGeorgZentralpark do
  ...
  def name(), do: "#{created_at()}-st-georg-zentralpark"
  ...
  def text(assigns) do
    ~H"""
    <h4>Alter Zustand</h4> <p>Die Querung des <.m bounds="10.013957,53.551932,10.017007,53.553045" lon="10.0156473" lat="53.5523843" dir="forward">Nagelswegs</.m> wird mit einer Ampel gesichert und ist nur für den Radverkehr Richtung Osten möglich. Die <.m bounds="10.016563,53.552054,10.019614,53.553167" lon="10.0180787" lat="53.552575" dir="forward">Adenauerallee</.m> wird ungesichert gequert und ist ebenfalls nur für den Radverkehr freigegeben. Dort werden Radfahrende häufig missachtet und (fast) umgefahren.</p>
    ...
    <h4>Quelle</h4> <ul>
    <li>
    <.a href="https://www.hamburg.de/mitte/strassenbau-und-verkehr/14892540/veloroute-08-ausbau/">Infoseite der Stadt zum Ausbau der Veloroute 8</.a> („Sichere Querungen an der Adenauerallee und dem Nagelsweg“)
    </li>
    <li><.a href="https://sitzungsdienst-hamburg-mitte.hamburg.de/bi/vo020.asp?VOLFDNR=1011801">Hinweise der Polizei zur Unfallhäufung</.a></li>
    <li><.a href="http://root.urbanista.de/deinegeest_blog/2021/01/21/bauarbeiten-am-zentralpark-beginnen/">Umbau des Zentralparks</.a></li>
    </ul>
    """
  end
end
