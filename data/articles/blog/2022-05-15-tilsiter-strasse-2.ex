defmodule Data.Article.Blog.TilsiterStrasse2 do
  ...
  def tags(), do: ["radroute-6", "6", "w16.3", "w16"]
  ...
  def text(assigns) do
    ...
    <h4>Meinung</h4>
    <p>Schutzstreifen sind keine brauchbare Führungsform für den Radverkehr, weil sie knappes Überholen fördern. Durch die breitere Fahrbahn kann auch eher gerast werden. Man fällt also etliche Bäume für eine Maßnahme, die die Situation für den Radverkehr <em>nicht</em> verbessert. Eine KFZ-Einbahnstraße in Richtung Innenstadt oder eine <.ref ref={LexikonModalfilter}>KFZ-Durchfahrtssperre</.ref> zwischen <.v bounds="10.086088,53.589859,10.094587,53.593562" lon={10.088168} lat={53.591461} dir="forward" ref={Alltagsroute6}>Voßkulen</.v> und <.v bounds="10.086088,53.589859,10.094587,53.593562" lon={10.088168} lat={53.591461} dir="forward" ref={Alltagsroute6}>Angerburger Straße</.v> wäre günstiger und effektiver.</p>
