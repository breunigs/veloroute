defmodule Data.Article.Blog.WandsbekerBahnhofstrasse do
  ...
  def text(assigns) do
    ...
    <p>Verwirrenderweise wird von „bis zur <.v bounds="10.083609,53.569948,10.088526,53.57224" lon={10.085961} lat={53.571845} dir="backward" ref={Alltagsroute7}>Tratzigerstraße</.v>“ gesprochen, die ein ganzes Stück weit weg ist. Möglicherweise handelt es sich um Lückenschlüsse sobald der <.a ref={EisenbahnbrueckeBovestrasse}>Umbau für die S4</.a> abgeschlossen ist.</p>
