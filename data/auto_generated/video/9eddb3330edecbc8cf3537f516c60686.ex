defmodule(Data.AutoGenerated.Video.Rendered_9eddb3330edecbc8cf3537f516c60686) do
  @moduledoc "#{"Kreuzung Max-Brauer-Allee / Holstenstraße: Max-Brauer-Allee, Sternschanze → Altona (forward)"}
  
  AUTOGENERATED. To update this file, run mix velo.videos.generate.
  See Video.Rendered for functionality.
  "
  @behaviour Video.Rendered
  @external_resource "videos/rendered/9eddb3330edecbc8cf3537f516c60686/stream.m3u8"
  @impl Video.Rendered
  def(name()) do
    "Kreuzung Max-Brauer-Allee / Holstenstraße: Max-Brauer-Allee, Sternschanze → Altona (forward)"
  end
  ...
  @impl Video.Rendered
  def(sources()) do
    [{"2021-04-04-freizeitroute-12-speedup-5x/GX011181.MP4", "0:00:16.000", "0:00:25.000"}]
  end
