defmodule(Data.AutoGenerated.Video.Rendered_0f69b7f3c9ca253d8ce5ed5678923786) do
  @moduledoc "#{"single way article (forward): 2021-06-17-kreuzung-max-brauer-allee-holstenstrasse"}
  ...
  @external_resource "videos/rendered/0f69b7f3c9ca253d8ce5ed5678923786/stream.m3u8"
  @impl Video.Rendered
  def(name()) do
    "single way article (forward): 2021-06-17-kreuzung-max-brauer-allee-holstenstrasse"
  end

  @impl Video.Rendered
  def(hash()) do
    "0f69b7f3c9ca253d8ce5ed5678923786"
  end
  ...
  def(sources()) do
    [
      {"2021-04-04-freizeitroute-12-speedup-5x/GX011181.MP4.anonymized.mkv", "0:00:16.000",
       "0:00:25.000"}
    ]
  end
