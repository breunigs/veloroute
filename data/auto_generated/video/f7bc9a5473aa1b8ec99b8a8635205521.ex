defmodule Data.AutoGenerated.Video.Rendered_f7bc9a5473aa1b8ec99b8a8635205521 do
  @moduledoc "#{"alltagsroute-11: von Eißendorf zur Veddel"}
...
"
  ...
  @impl Video.Rendered
  def name() do
    "alltagsroute-11: von Eißendorf zur Veddel"
  end
  ...
  def bbox() do
    %Geo.BoundingBox{
      maxLat: 53.521885982035926,
      maxLon: 10.015304,
      minLat: 53.50013767065868,
      minLon: 9.997604
    }
  end
  ...
  @impl Video.Rendered
  def metadata() do
    [{0, "Juli 2021"}, {20491, "April 2021"}, {118_258, "Juli 2021"}]
  end
