defmodule(Data.AutoGenerated.Video.Rendered_f3e80ef8f3ded1dca0b0301105926867) do
  @moduledoc "#{"Versuchsradweg Hallerstraße: Hallerstraße Richtung Osten"}
  
  AUTOGENERATED. To update this file, run mix velo.videos.generate.
  See Video.Rendered for functionality.
  "
  @behaviour Video.Rendered
  @external_resource "videos/rendered/f3e80ef8f3ded1dca0b0301105926867/stream.m3u8"
  @impl Video.Rendered
  def(name()) do
    "Versuchsradweg Hallerstraße: Hallerstraße Richtung Osten"
  end
  ...
  @impl Video.Rendered
  def(sources()) do
    [{"2021-06-19-veloroute6/GX011842", "0:00:18.852", "0:00:38.305"}]
  end
