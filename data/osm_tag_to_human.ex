defmodule Data.OsmTagToHuman do
  ...
  def map(),
    do: %{
      ...
      "greenfield" => ~w[Wiese],
      "greengrocer" => ["Obst- und Gemüsehandel"],
      ...
      "hearing_aids" => ["Geschäft für Hörgeräte"],
      "heath" => ~w[Heideland],
      ...
      "interior_decoration" => ["Geschäft für Inneneinrichtung"],
      "intersection" => ~w[Kreuzung Einmündung],
      "island" => ~w[Insel],
