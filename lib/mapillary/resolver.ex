defmodule Mapillary.Resolver do
  require Logger
  ...
  import Mapillary.Types
  alias Mapillary.Types
  ...
  @spec close_to(Enumerable.t(), Types.img() | Types.ref()) :: any()
  ...
  @spec resolve(%{required(atom() | binary()) => Types.ref()}) :: [Types.img()]
  ...
  @spec resolve(Types.ref()) :: [Types.img()]
