defmodule Article.DecoratorsTest do
  ...
  test "HTML format" do
    assert String.trim("""
           ...
           <a class="ref" href="/lexikon/radfahrstreifen" data-phx-link-state="push" data-phx-link="patch" title="Radfahrstreifen sind asphaltierte Radwege direkt neben den KFZ-Spuren">Radfahrstreifen</a>
